...
use carrot_edit_prediction::udiff;
...
pub async fn run_format_prompt(
    ...
    match args.provider {
        ...
        PredictionProvider::Zeta2(zeta_format) => {
            ...
            let prefill = carrot_zeta_prompt::get_prefill(prompt_inputs, zeta_format);
...
pub fn zeta2_output_for_patch(
    input: &carrot_zeta_prompt::ZetaPromptInput,
    patch: &str,
    ...
    if version == ZetaFormat::V0317SeedMultiRegions {
        ...
        return multi_region::encode_from_old_and_new_v0317(
            ...
            &result,
            cursor_in_new,
            carrot_zeta_prompt::CURSOR_MARKER,
    ...
    if version == ZetaFormat::V0306SeedMultiRegions {
        ...
        return multi_region::encode_from_old_and_new(
            ...
            cursor_in_new,
            carrot_zeta_prompt::CURSOR_MARKER,
            carrot_zeta_prompt::seed_coder::END_MARKER,
            carrot_zeta_prompt::seed_coder::NO_EDITS,
        );
    }
    ...
    if let Some(cursor_offset) = cursor_offset {
        ...
        result.insert_str(offset, carrot_zeta_prompt::CURSOR_MARKER);
    }
...
impl TeacherPrompt {
    ...
    pub fn parse(example: &Example, response: &str) -> Result<(String, Option<ActualCursor>)> {
        ...
        let diff = carrot_language::unified_diff_with_context(
            &old_editable_region,
            &new_editable_region,
    ...
    pub fn format_context(example: &Example) -> String {
        ...
        let suffix = "`````\n\n";
        let max_tokens = 1024;
        carrot_zeta_prompt::format_related_files_within_budget(
            related_files,
            &prefix,
            &suffix,
            max_tokens,
...
mod tests {
    ...
    fn test_parse_no_edits_response_with_trailing_backticks() {
        ...
        let parsed = TeacherPrompt::parse(
            &Example {
                spec: carrot_edit_prediction::example_spec::ExampleSpec {
                    name: "test".to_string(),
