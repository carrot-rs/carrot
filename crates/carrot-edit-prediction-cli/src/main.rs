...
/// Minimum Carrot version required for Snowflake queries.
...
async fn load_examples(
    ...
    let mut rated_after_inputs: Vec<(
        String,
        Option<carrot_telemetry_events::EditPredictionRating>,
    )> = Vec::new();
...
fn spec_hash(spec: &carrot_edit_prediction::example_spec::ExampleSpec) -> u64 {
