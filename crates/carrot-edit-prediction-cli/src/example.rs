...
use carrot_edit_prediction::udiff::OpenedBuffers;
use carrot_http_client::Url;
use carrot_language::{Anchor, Buffer};
...
pub struct Example {
    ...
    /// The Carrot version used to generate this example.
    pub carrot_version: Option<String>,
