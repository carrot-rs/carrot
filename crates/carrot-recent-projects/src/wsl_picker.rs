...
use inazuma::{AppContext, DismissEvent, Entity, EventEmitter, Focusable, Subscription, Task};
...
impl WslOpenModal {
    ...
    fn confirm(
        ...
        let app_state = carrot_workspace::AppState::global(cx);
        ...
        let open_options = carrot_workspace::OpenOptions::default();
...
impl Render for WslOpenModal {
    fn render(&mut self, _: &mut Window, cx: &mut Context<Self>) -> impl carrot_ui::IntoElement {
        div()
