...
use carrot_dap::{StartDebuggingRequestArguments, adapters::DebugTaskDefinition};
use carrot_task::DebugRequest;
use inazuma::AsyncApp;
use inazuma_collections::HashMap;
use inazuma_util::{ResultExt, maybe, shell::ShellKind};
...
impl JsDebugAdapter {
    ...
    async fn get_installed_binary(
        ...
        let adapter_path = if let Some(user_installed_path) = user_installed_path {
            ...
            let adapter_path = carrot_paths::debug_adapters_dir().join(self.name().as_ref());

            let file_name_prefix = format!("{}_", self.name());

            inazuma_util::fs::find_file_name_in_dir(adapter_path.as_path(), |file_name| {
                        ...
                        },
                        {
                            ...
                            "properties": {
                                ...
                                "outFiles": {
                                    ...
                                    "default": ["${CARROT_WORKTREE_ROOT}/**/*.js", "!**/node_modules/**"]
                                },
                                "sourceMaps": {
                                    "type": "boolean",
