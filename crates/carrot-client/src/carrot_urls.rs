//! Contains helper functions for constructing URLs to various Carrot-related pages.
//!
...
/// Returns the URL to Carrot's edit prediction documentation.
...
/// Returns the URL to Carrot's ACP registry blog post.
...
pub fn shared_agent_thread_url(session_id: &str) -> String {
    format!("carrot://agent/shared/{}", session_id)
}
