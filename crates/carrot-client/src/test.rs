...
use carrot_cloud_llm_client::{CurrentUsage, UsageData, UsageLimit};
use carrot_http_client::{AsyncBody, Method, Request, http};
use carrot_rpc::{ConnectionId, Peer, Receipt, TypedEnvelope, proto};
use futures::{StreamExt, stream::BoxStream};
use inazuma::{AppContext as _, Entity, TestAppContext};
...
pub fn make_get_authenticated_user_response(
    ...
    GetAuthenticatedUserResponse {
        ...
        plan: PlanInfo {
            plan: KnownOrUnknown::Known(Plan::CarrotPro),
