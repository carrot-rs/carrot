...
pub use inazuma_settings_macros::RegisterSetting;
...
pub mod fallible_options {
    pub use ::inazuma_settings_content::{FallibleOption, parse_json, parse_toml};
}
...
pub use carrot_json_compat::parse_json_with_comments;
pub use content_into_inazuma::IntoInazuma;
...
pub use settings_store::{
    ...
    LocalSettingsKind, LocalSettingsPath, Settings, SettingsFile, SettingsJsonSchemaParams,
    SettingsKey, SettingsLocation, SettingsParseResult, SettingsStore,
};
...
impl UserSettingsContentExt for UserSettingsContent {
    ...
    fn for_release_channel(&self) -> Option<&SettingsContent> {
        self.release_channel_overrides
            .get_by_key(carrot_release_channel::RELEASE_CHANNEL.dev_name())
    }
...
pub const VIM_KEYMAP_PATH: &str = "keymaps/vim.toml";
...
pub fn initial_user_settings_content() -> Cow<'static, str> {
    asset_str::<SettingsAssets>("settings/initial_user_settings.toml")
}
...
pub fn initial_keymap_content() -> Cow<'static, str> {
    asset_str::<SettingsAssets>("keymaps/initial.toml")
}
