...
use carrot_project::{DiagnosticSummary, PathMatchCandidateSet, Project};
use carrot_ui::prelude::*;
use carrot_workspace::Workspace;
use inazuma::{App, Entity, Task, WeakEntity};
use inazuma_fuzzy::{PathMatch, StringMatchCandidate};
use inazuma_rope::Point;
use inazuma_util::paths::{PathMatcher, PathStyle};
        ...
        cx.background_spawn(async move {
            ...
            Ok(matches
                ...
                .map(|completion| ArgumentCompletion {
                    ...
                    new_text: completion,
                    after_completion: carrot_assistant_slash_command::AfterCompletion::Run,
...
fn collect_diagnostic(
    ...
    for (i, line) in buffer_text.lines().enumerate() {
        ...
        if line_number == diagnostic_row_number {
            ...
            let message = inazuma_util::truncate(&entry.diagnostic.message, MAX_MESSAGE_LENGTH)
                .replace('\n', format!("\n//{:padding$}", "").as_str());
