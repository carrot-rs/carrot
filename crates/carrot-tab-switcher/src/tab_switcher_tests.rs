...
use carrot_workspace::{ActivatePreviousItem, AppState, Workspace, item::test::TestItem};
use inazuma::{TestAppContext, VisualTestContext};
use inazuma_menu::SelectPrevious;
...
#[inazuma::test]
async fn test_open_with_last_tab_selected(cx: &mut inazuma::TestAppContext) {
    let app_state = init_test(cx);
...
#[inazuma::test]
async fn test_open_item_on_modifiers_release(cx: &mut inazuma::TestAppContext) {
    let app_state = init_test(cx);
...
#[inazuma::test]
async fn test_open_on_empty_pane(cx: &mut inazuma::TestAppContext) {
    let app_state = init_test(cx);
...
#[inazuma::test]
async fn test_open_with_single_item(cx: &mut inazuma::TestAppContext) {
    let app_state = init_test(cx);
    app_state
        .fs
        .as_fake()
...
#[inazuma::test]
async fn test_close_selected_item(cx: &mut inazuma::TestAppContext) {
    let app_state = init_test(cx);
    app_state
        .fs
        .as_fake()
...
#[inazuma::test]
async fn test_open_in_active_pane_deduplicates_files_by_path(cx: &mut inazuma::TestAppContext) {
    let app_state = init_test(cx);
    app_state
        .fs
        .as_fake()
...
#[inazuma::test]
async fn test_open_in_active_pane_clones_files_to_current_pane(cx: &mut inazuma::TestAppContext) {
    let app_state = init_test(cx);
    app_state
        .fs
        .as_fake()
...
#[inazuma::test]
async fn test_open_in_active_pane_moves_terminals_to_current_pane(
    cx: &mut inazuma::TestAppContext,
) {
    let app_state = init_test(cx);
...
#[inazuma::test]
async fn test_open_in_active_pane_closes_file_in_all_panes(cx: &mut inazuma::TestAppContext) {
    let app_state = init_test(cx);
    app_state
        .fs
        .as_fake()
