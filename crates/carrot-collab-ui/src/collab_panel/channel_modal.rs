...
use carrot_ui::{Avatar, Checkbox, ContextMenu, ListItem, ListItemSpacing, prelude::*};
use carrot_workspace::{ModalView, notifications::DetachAndPromptErr};
use inazuma::{
                        ...
                        h_flex()
                            ...
                            .child(
                                Checkbox::new("is-public")
                                    .toggle_state(if visibility == ChannelVisibility::Public {
                                        carrot_ui::ToggleState::Selected
                                    } else {
                                        carrot_ui::ToggleState::Unselected
                                    })
                                    .label("Public")
