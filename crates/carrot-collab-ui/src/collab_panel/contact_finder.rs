use carrot_client::{ContactRequestStatus, User, UserStore};
use carrot_ui::{Avatar, ListItem, ListItemSpacing, prelude::*};
use carrot_workspace::ModalView;
use inazuma::{
    App, Context, DismissEvent, Entity, EventEmitter, FocusHandle, Focusable, Render, Styled, Task,
    WeakEntity, Window,
};
use inazuma_picker::{Picker, PickerDelegate};
use inazuma_util::{ResultExt as _, TryFutureExt};
use std::sync::Arc;
