...
use carrot_client::{ChannelId, Client, Notification, User, UserStore};
use carrot_notifications::{NotificationEntry, NotificationEvent, NotificationStore};
...
pub struct NotificationPanel {
    ...
    subscriptions: Vec<inazuma::Subscription>,
...
pub struct NotificationPresenter {
    pub actor: Option<Arc<carrot_client::User>>,
    pub text: String,
    pub icon: &'static str,
...
impl NotificationPanel {
    ...
    fn render_notification(
        ...
        let absolute_timestamp = carrot_time_format::format_localized_timestamp(
            ...
            now,
            self.local_timezone,
            carrot_time_format::TimestampFormat::Absolute,
        );
                ...
                IconButton::new(close_id, close_icon)
                    .tooltip(move |_window, cx| {
                        if suppress {
                            Tooltip::for_action(
                                "Suppress.\nClose with click.",
                                &carrot_workspace::SuppressNotification,
                                cx,
                            )
                        } else {
                            Tooltip::for_action(
