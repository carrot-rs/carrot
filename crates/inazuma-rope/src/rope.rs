...
use inazuma_sum_tree::{Bias, Dimension, Dimensions, SumTree};
...
impl Rope {
    ...
    fn push_large(&mut self, mut text: &str) {
        ...
        #[cfg(not(all(test, not(rust_analyzer))))]
        const PARALLEL_THRESHOLD: usize = 84 * (2 * inazuma_sum_tree::TREE_BASE);
...
pub struct Cursor<'a> {
    rope: &'a Rope,
    chunks: inazuma_sum_tree::Cursor<'a, 'static, Chunk, usize>,
    offset: usize,
}
...
impl inazuma_sum_tree::Item for Chunk {
...
impl inazuma_sum_tree::ContextLessSummary for ChunkSummary {
    fn zero() -> Self {
        Default::default()
    }
...
impl inazuma_sum_tree::ContextLessSummary for TextSummary {
    fn zero() -> Self {
        Default::default()
    }
...
impl<'a> inazuma_sum_tree::Dimension<'a, ChunkSummary> for TextSummary {
    fn zero(_cx: ()) -> Self {
        Default::default()
    }
...
impl<'a> inazuma_sum_tree::Dimension<'a, ChunkSummary> for usize {
    fn zero(_cx: ()) -> Self {
        Default::default()
    }
...
impl<'a> inazuma_sum_tree::Dimension<'a, ChunkSummary> for OffsetUtf16 {
    fn zero(_cx: ()) -> Self {
        Default::default()
    }
...
impl<'a> inazuma_sum_tree::Dimension<'a, ChunkSummary> for Point {
    fn zero(_cx: ()) -> Self {
        Default::default()
    }
...
impl<'a> inazuma_sum_tree::Dimension<'a, ChunkSummary> for PointUtf16 {
    fn zero(_cx: ()) -> Self {
        Default::default()
    }
...
impl<'a, K, V, S> inazuma_sum_tree::Dimension<'a, S> for DimensionPair<K, V>
where
    S: inazuma_sum_tree::Summary,
    K: inazuma_sum_tree::Dimension<'a, S>,
    V: inazuma_sum_tree::Dimension<'a, S>,
{
