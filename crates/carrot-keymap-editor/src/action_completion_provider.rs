use carrot_command_palette;
use carrot_editor::{CompletionProvider, Editor};
use carrot_language::{self, ToOffset};
use carrot_project::{self, CompletionDisplayOptions};
use inazuma::{Context, Entity, SharedString, Window};
...
impl CompletionProvider for ActionCompletionProvider {
    fn completions(
        ...
        let normalized_query = carrot_command_palette::normalize_action_query(&query);
        ...
        executor.spawn(async move {
            ...
            let completions: Vec<carrot_project::Completion> = matches
                .iter()
                .take(50)
                .map(|m| {
                    ...
                    carrot_project::Completion {
                        ...
                        label: carrot_language::CodeLabel::plain(humanized.to_string(), None),
