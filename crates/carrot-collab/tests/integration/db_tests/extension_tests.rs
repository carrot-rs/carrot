...
use carrot_collab::db::ExtensionVersionConstraints;
use carrot_collab::db::{NewExtensionVersion, queries::extensions::convert_time_to_chrono};
...
async fn test_extensions_by_id(db: &Arc<Database>) {
    ...
    assert_eq!(
        ...
        &[ExtensionMetadata {
            id: "ext1".into(),
            manifest: carrot_cloud_api_types::ExtensionApiManifest {
                name: "Extension 1".into(),
                version: "0.0.2".into(),
                authors: vec!["max".into()],
