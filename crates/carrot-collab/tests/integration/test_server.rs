...
use carrot_channel::{ChannelBuffer, ChannelStore};
use carrot_client::test::{make_get_authenticated_user_response, parse_authorization_header};
use carrot_client::{
...
use carrot_collab::{
    ...
    executor::Executor,
    rpc::{CLEANUP_TIMEOUT, CarrotVersion, Principal, RECONNECT_TIMEOUT, Server},
};
use carrot_collab_ui::channel_view::ChannelView;
...
use carrot_http_client::{FakeHttpClient, Method};
use carrot_language::LanguageRegistry;
use carrot_node_runtime::NodeRuntime;
use carrot_notifications::NotificationStore;
...
use inazuma::{
    AppContext as _, BackgroundExecutor, Entity, Task, TestAppContext, VisualTestContext,
};
...
use carrot_livekit_client::test::TestServer as LivekitTestServer;
...
pub struct TestClient {
    pub username: String,
    pub app_state: Arc<carrot_workspace::AppState>,
...
struct TestClientState {
    ...
    buffers: HashMap<Entity<Project>, HashSet<Entity<carrot_language::Buffer>>>,
...
impl TestServer {
    pub async fn start(deterministic: BackgroundExecutor) -> Self {
        ...
        let epoch = app_state
            .db
            .create_server(&app_state.config.carrot_environment)
            .await
            .unwrap();
    ...
    pub async fn reset(&self) {
        ...
        let epoch = self
            .app_state
            .db
            .create_server(&self.app_state.config.carrot_environment)
            .await
            .unwrap();
    ...
    pub async fn create_client(&mut self, cx: &mut TestAppContext, name: &str) -> TestClient {
                ...
                async move {
                    match (req.method(), req.uri().path()) {
                        (&Method::GET, "/client/users/me") => {
                            ...
                            {
                                return Ok(carrot_http_client::Response::builder()
                                    .status(401)
                        ...
                        _ => Ok(carrot_http_client::Response::builder()
                            .status(404)
                            .body("Not Found".into())
                            .unwrap()),
                    }
                ...
                cx.spawn(async move |cx| {
                    if forbid_connections.load(SeqCst) {
                        ...
                        cx.background_spawn(server.handle_connection(
                            ...
                            client_name,
                            Principal::User(user),
                            CarrotVersion(semver::Version::new(1, 0, 0)),
                            Some("test".to_string()),
                            None,
                            None,
                            None,
        ...
        git_hosting_provider_registry.register_hosting_provider(Arc::new(
            carrot_git_hosting_providers::Github::public_instance(),
        ));

        let user_store = cx.new(|cx| UserStore::new(client.clone(), cx));
        let language_registry = Arc::new(LanguageRegistry::test(cx.executor()));
        let session = cx.new(|cx| AppSession::new(Session::test(), cx));
        let app_state = Arc::new(carrot_workspace::AppState {
            client: client.clone(),
        ...
        let os_keymap = "keymaps/default-macos.toml";
        ...
        cx.update(|cx| {
            ...
            carrot_call::init(client.clone(), user_store.clone(), cx);
            ...
            carrot_assistant_text_thread::init(client.clone(), cx);
        });
    ...
    pub async fn build_app_state(
        ...
        Arc::new(AppState {
            ...
            config: Config {
                ...
                rust_log: None,
                log_json: None,
                carrot_environment: "test".into(),
                blob_store_url: None,
                blob_store_region: None,
                blob_store_access_key: None,
                blob_store_secret_key: None,
                blob_store_bucket: None,
                carrot_client_checksum_seed: None,
                seed_path: None,
                kinesis_region: None,
                kinesis_stream: None,
...
impl TestClient {
    ...
    ) -> impl DerefMut<Target = HashSet<Entity<carrot_language::Buffer>>> + 'a {
        RefMut::map(self.state.borrow_mut(), |state| {
    ...
    pub fn buffers(
        &self,
    ) -> impl DerefMut<Target = HashMap<Entity<Project>, HashSet<Entity<carrot_language::Buffer>>>> + '_
    {
    ...
    pub async fn join_workspace<'a>(
        ...
        cx.update(|cx| {
            carrot_workspace::join_channel(channel_id, self.app_state.clone(), None, None, cx)
        })
        .await
        .unwrap();
        cx.run_until_parked();
