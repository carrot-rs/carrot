...
impl Database {
    ...
    pub async fn create_channel(
        ...
        self.transaction(move |tx| async move {
            ...
            let channel = channel::ActiveModel {
                ...
                requires_carrot_cla: ActiveValue::NotSet,
    ...
    #[cfg(feature = "test-support")]
    pub async fn set_channel_requires_carrot_cla(
        &self,
        channel_id: ChannelId,
        requires_carrot_cla: bool,
    ) -> Result<()> {
        self.transaction(move |tx| async move {
            let channel = self.get_channel_internal(channel_id, &tx).await?;
            let mut model = channel.into_active_model();
            model.requires_carrot_cla = ActiveValue::Set(requires_carrot_cla);
    ...
    pub async fn invite_channel_member(
        ...
        self.transaction(move |tx| async move {
            ...
            let notifications = self
                .create_notification(
                    invitee_id,
                    carrot_rpc::Notification::ChannelInvitation {
