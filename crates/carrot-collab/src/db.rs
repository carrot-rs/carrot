...
pub struct DatabaseTestOptions {
    pub executor: inazuma::BackgroundExecutor,
...
pub struct UpdatedChannelMessage {
    ...
    pub updated_mention_notifications: Vec<carrot_rpc::proto::Notification>,
}
...
fn db_status_to_proto(
    ...
    use carrot_rpc::proto::git_file_status::{Tracked, Unmerged, Variant};
