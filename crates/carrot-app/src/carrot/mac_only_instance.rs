...
fn address() -> SocketAddr {
    ...
    let port = match *carrot_release_channel::RELEASE_CHANNEL {
...
fn instance_handshake() -> &'static str {
    match *carrot_release_channel::RELEASE_CHANNEL {
        ReleaseChannel::Dev => "Carrot Dev Instance Running",
        ReleaseChannel::Nightly => "Carrot Nightly Instance Running",
        ReleaseChannel::Preview => "Carrot Preview Instance Running",
        ReleaseChannel::Stable => "Carrot Stable Instance Running",
    }
}
