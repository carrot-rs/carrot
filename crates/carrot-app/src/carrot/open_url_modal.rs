...
use inazuma::{AppContext as _, DismissEvent, Entity, EventEmitter, Focusable, Styled};

// DEFERRED: super::{OpenListener, RawOpenRequest} requires open_listener port
...
impl OpenUrlModal {
    pub fn new(window: &mut Window, cx: &mut Context<Self>) -> Self {
        let editor = cx.new(|cx| {
            ...
            editor.set_placeholder_text("carrot://...", window, cx);
            editor
        });
    ...
    fn confirm(&mut self, _: &inazuma_menu::Confirm, window: &mut Window, cx: &mut Context<Self>) {
        ...
        // DEFERRED: carrot:// URL routing requires open_listener port
        // if url.starts_with("carrot://") || url.starts_with("carrot-cli://") {
