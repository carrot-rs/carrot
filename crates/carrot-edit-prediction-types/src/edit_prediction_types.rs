...
use carrot_client::EditPredictionUsage;
use inazuma::{App, Context, Entity, SharedString};
...
use carrot_language::{Anchor, Buffer, OffsetRangeExt};
...
impl EditPredictionIconSet {
    pub fn new(base: IconName) -> Self {
        Self {
            base,
            disabled: IconName::CarrotPredictDisabled,
            up: IconName::CarrotPredictUp,
            down: IconName::CarrotPredictDown,
            error: IconName::CarrotPredictError,
        }
    }
...
pub struct PredictedCursorPosition {
    ...
    pub anchor: carrot_language::Anchor,
...
impl PredictedCursorPosition {
    pub fn new(anchor: carrot_language::Anchor, offset: usize) -> Self {
        Self { anchor, offset }
    }

    /// Creates a predicted cursor position at an exact anchor location (offset = 0).
    pub fn at_anchor(anchor: carrot_language::Anchor) -> Self {
