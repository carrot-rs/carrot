use carrot_auto_update::{AutoUpdater, release_notes_url};
use carrot_editor::{Editor, MultiBuffer};
use carrot_markdown_preview::markdown_preview_view::{MarkdownPreviewMode, MarkdownPreviewView};
use carrot_release_channel::{AppVersion, ReleaseChannel};
use carrot_ui::{AnnouncementToast, ListBulletItem, prelude::*};
...
use inazuma::{App, DismissEvent, Entity, EventEmitter, FocusHandle, Focusable, Window, actions};
...
fn view_release_notes_locally(
    ...
    let client = carrot_client::Client::global(cx).http_client();
...
fn announcement_for_version(version: &Version) -> Option<AnnouncementContent> {
    ...
    match (version.major, version.minor, version.patch) {
        ...
        //     heading: "What's new in Carrot 0.225".into(),
        ...
        //     primary_action_url: Some("https://carrot.dev/".into()),
        // }),
        _ => None,
    }
}
