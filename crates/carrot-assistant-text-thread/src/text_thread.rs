...
use carrot_agent_settings::{AgentSettings, SUMMARIZE_THREAD_PROMPT};
use carrot_assistant_slash_command::{
    SlashCommandContent, SlashCommandEvent, SlashCommandLine, SlashCommandOutputSection,
    SlashCommandResult, SlashCommandWorkingSet,
};
use carrot_client::{self, proto};
use carrot_fs::{Fs, RenameOptions};
use inazuma_clock::ReplicaId;
use inazuma_collections::{HashMap, HashSet};

use carrot_language::{
    AnchorRangeExt, Bias, Buffer, LanguageRegistry, OffsetRangeExt, Point, ToOffset,
};
...
use carrot_open_ai::Model as OpenAiModel;
use carrot_paths::text_threads_dir;
...
use inazuma_text::{BufferSnapshot, ToPoint};
use inazuma_util::{ResultExt, TryFutureExt, post_inc};
use uuid::Uuid;
...
pub enum TextThreadOperation {
    ...
    SlashCommandStarted {
        ...
        output_range: Range<carrot_language::Anchor>,
        name: String,
        version: inazuma_clock::Global,
    },
    ...
    SlashCommandOutputSectionAdded {
        timestamp: inazuma_clock::Lamport,
        section: SlashCommandOutputSection<carrot_language::Anchor>,
        version: inazuma_clock::Global,
    },
    ThoughtProcessOutputSectionAdded {
        timestamp: inazuma_clock::Lamport,
        section: ThoughtProcessOutputSection<carrot_language::Anchor>,
        version: inazuma_clock::Global,
    },
    BufferOperation(carrot_language::Operation),
}
    ...
    pub fn from_proto(op: proto::ContextOperation) -> Result<Self> {
        match op.variant.context("invalid variant")? {
            proto::context_operation::Variant::InsertMessage(insert) => {
                ...
                let id = MessageId(carrot_language::proto::deserialize_timestamp(
                    message.id.context("invalid id")?,
                ));
                Ok(Self::InsertMessage {
                    anchor: MessageAnchor {
                        id,
                        start: carrot_language::proto::deserialize_anchor(
                    ...
                    version: carrot_language::proto::deserialize_version(&insert.version),
                })
            }
            proto::context_operation::Variant::UpdateMessage(update) => Ok(Self::UpdateMessage {
                message_id: MessageId(carrot_language::proto::deserialize_timestamp(
                ...
                metadata: MessageMetadata {
                    ...
                    timestamp: carrot_language::proto::deserialize_timestamp(
                        update.timestamp.context("invalid timestamp")?,
                    ),
                    cache: None,
                },
                version: carrot_language::proto::deserialize_version(&update.version),
            }),
            ...
            proto::context_operation::Variant::SlashCommandStarted(message) => {
                Ok(Self::SlashCommandStarted {
                    id: InvokedSlashCommandId(carrot_language::proto::deserialize_timestamp(
                        message.id.context("invalid id")?,
                    )),
                    output_range: carrot_language::proto::deserialize_anchor_range(
                        message.output_range.context("invalid range")?,
                    )?,
                    name: message.name,
                    version: carrot_language::proto::deserialize_version(&message.version),
                })
            }
            proto::context_operation::Variant::SlashCommandOutputSectionAdded(message) => {
                ...
                Ok(Self::SlashCommandOutputSectionAdded {
                    ...
                    section: SlashCommandOutputSection {
                        range: carrot_language::proto::deserialize_anchor_range(
            ...
            proto::context_operation::Variant::BufferOperation(op) => Ok(Self::BufferOperation(
                carrot_language::proto::deserialize_operation(
                ...
                variant: Some(proto::context_operation::Variant::InsertMessage(
                    proto::context_operation::InsertMessage {
                        message: Some(proto::ContextMessage {
                            id: Some(carrot_language::proto::serialize_timestamp(anchor.id.0)),
                            start: Some(carrot_language::proto::serialize_anchor(&anchor.start)),
                            role: metadata.role.to_proto() as i32,
                            status: Some(metadata.status.to_proto()),
                        }),
                        version: carrot_language::proto::serialize_version(version),
                    },
                )),
            },
            Self::UpdateMessage {
                ...
                variant: Some(proto::context_operation::Variant::UpdateMessage(
                    proto::context_operation::UpdateMessage {
                        message_id: Some(carrot_language::proto::serialize_timestamp(message_id.0)),
                        role: metadata.role.to_proto() as i32,
                        status: Some(metadata.status.to_proto()),
                        timestamp: Some(carrot_language::proto::serialize_timestamp(
                            metadata.timestamp,
                        )),
                        version: carrot_language::proto::serialize_version(version),
                    },
            ...
            Self::SlashCommandStarted {
                ...
                variant: Some(proto::context_operation::Variant::SlashCommandStarted(
                    proto::context_operation::SlashCommandStarted {
                        id: Some(carrot_language::proto::serialize_timestamp(id.0)),
                        output_range: Some(carrot_language::proto::serialize_anchor_range(
                            output_range.clone(),
                        )),
                        name: name.clone(),
                        version: carrot_language::proto::serialize_version(version),
                        ...
                        proto::context_operation::SlashCommandOutputSectionAdded {
                            ...
                            section: Some({
                                ...
                                proto::SlashCommandOutputSection {
                                    range: Some(carrot_language::proto::serialize_anchor_range(
                                        section.range.clone(),
                                    )),
            ...
            Self::SlashCommandFinished {
                ...
                variant: Some(proto::context_operation::Variant::SlashCommandCompleted(
                    proto::context_operation::SlashCommandCompleted {
                        id: Some(carrot_language::proto::serialize_timestamp(id.0)),
                        timestamp: Some(carrot_language::proto::serialize_timestamp(*timestamp)),
            ...
            Self::BufferOperation(operation) => proto::ContextOperation {
                variant: Some(proto::context_operation::Variant::BufferOperation(
                    proto::context_operation::BufferOperation {
                        operation: Some(carrot_language::proto::serialize_operation(operation)),
                    },
                )),
            },
        }
...
pub enum TextThreadEvent {
    ...
    StreamedCompletion,
    StartedThoughtProcess(Range<carrot_language::Anchor>),
    EndedThoughtProcess(carrot_language::Anchor),
    InvokedSlashCommandChanged {
        command_id: InvokedSlashCommandId,
    },
    ParsedSlashCommandsUpdated {
        removed: Vec<Range<carrot_language::Anchor>>,
...
pub struct MessageAnchor {
    pub id: MessageId,
    pub start: carrot_language::Anchor,
}
...
impl ThoughtProcessOutputSection<carrot_language::Anchor> {
    pub fn is_valid(&self, buffer: &carrot_language::TextBuffer) -> bool {
...
pub struct Message {
    ...
    pub anchor_range: Range<carrot_language::Anchor>,
    pub id: MessageId,
    pub role: Role,
    pub status: MessageStatus,
    pub cache: Option<MessageCacheMetadata>,
...
impl Content {
    fn range(&self) -> Range<carrot_language::Anchor> {
        match self {
...
pub struct TextThread {
    ...
    edits_since_last_parse: carrot_language::Subscription<usize>,
    slash_commands: Arc<SlashCommandWorkingSet>,
    pub(crate) slash_command_output_sections:
        Vec<SlashCommandOutputSection<carrot_language::Anchor>>,
    thought_process_output_sections: Vec<ThoughtProcessOutputSection<carrot_language::Anchor>>,
...
impl TextThread {
    pub fn local(
        ...
        Self::new(
            TextThreadId::new(),
            ReplicaId::default(),
            carrot_language::Capability::ReadWrite,
            language_registry,
            prompt_builder,
            slash_commands,
            cx,
    ...
    pub fn new(
        ...
        capability: carrot_language::Capability,
        language_registry: Arc<LanguageRegistry>,
        prompt_builder: Arc<PromptBuilder>,
        slash_commands: Arc<SlashCommandWorkingSet>,
        cx: &mut Context<Self>,
        ...
        let buffer = cx.new(|_cx| {
            let buffer = Buffer::remote(
                carrot_language::BufferId::new(1).unwrap(),
                replica_id,
                capability,
                "",
            );
        ...
        let message = MessageAnchor {
            id: first_message_id,
            start: carrot_language::Anchor::min_for_buffer(this.buffer.read(cx).remote_id()),
        };
            ...
            slash_command_output_sections: self
                ...
                .filter_map(|section| {
                    if section.is_valid(buffer) {
                        ...
                        Some(carrot_assistant_slash_command::SlashCommandOutputSection {
                            range,
                            icon: section.icon,
    ...
    pub fn slash_command_output_sections(
        &self,
    ) -> &[SlashCommandOutputSection<carrot_language::Anchor>] {
        &self.slash_command_output_sections
    }

    pub fn thought_process_output_sections(
        &self,
    ) -> &[ThoughtProcessOutputSection<carrot_language::Anchor>] {
        &self.thought_process_output_sections
    }
    ...
    fn handle_buffer_event(
        ...
        match event {
            carrot_language::BufferEvent::Operation {
                operation,
                is_local: true,
    ...
    pub fn pending_command_for_position(
        &mut self,
        position: carrot_language::Anchor,
        cx: &mut Context<Self>,
    ...
    pub fn pending_commands_for_range(
        &self,
        range: Range<carrot_language::Anchor>,
        cx: &App,
    ) -> &[ParsedSlashCommand] {
    ...
    pub fn insert_command_output(
        &mut self,
        command_source_range: Range<carrot_language::Anchor>,
        name: &str,
                    ...
                    match content {
                        Content::Image { image, .. } => {
                            if let Some(image) = image.clone().now_or_never().flatten() {
                                request_message
                                    .content
                                    .push(carrot_language_model::MessageContent::Image(image));
                            }
                        }
                    }
    ...
    pub fn messages_from_iters<'a>(
        ...
        iter::from_fn(move || {
            if let Some((start_ix, message_anchor)) = messages.next() {
                ...
                let message_end_anchor = message_end
                    .unwrap_or(carrot_language::Anchor::max_for_buffer(buffer.remote_id()));
...
impl TextThreadVersion {
    pub fn from_proto(proto: &proto::ContextVersion) -> Self {
        Self {
            text_thread: carrot_language::proto::deserialize_version(&proto.context_version),
            buffer: carrot_language::proto::deserialize_version(&proto.buffer_version),
        }
    }
    ...
    pub fn to_proto(&self, context_id: TextThreadId) -> proto::ContextVersion {
        proto::ContextVersion {
            ...
            context_version: carrot_language::proto::serialize_version(&self.text_thread),
            buffer_version: carrot_language::proto::serialize_version(&self.buffer),
        }
    }
}
...
pub struct ParsedSlashCommand {
    ...
    pub source_range: Range<carrot_language::Anchor>,
}
...
pub struct InvokedSlashCommand {
    ...
    pub run_commands_in_ranges: Vec<Range<carrot_language::Anchor>>,
    pub status: InvokedSlashCommandStatus,
    pub transaction: Option<carrot_language::TransactionId>,
    timestamp: inazuma_clock::Lamport,
}
...
pub struct SavedTextThread {
    ...
    pub slash_command_output_sections:
        Vec<carrot_assistant_slash_command::SlashCommandOutputSection<usize>>,
    #[serde(default)]
