...
pub struct ChipContext {
    ...
    pub battery_info_provider:
        std::sync::Arc<dyn crate::providers::battery::BatteryInfoProvider + Send + Sync>,

    // Per-provider configs (resolved, non-Option)
    pub kubernetes_config: carrot_settings::KubernetesChipConfig,
    pub aws_config: carrot_settings::AwsChipConfig,
    pub directory_config: carrot_settings::DirectoryChipConfig,
    pub git_status_config: carrot_settings::GitStatusChipConfig,
    pub python_config: carrot_settings::PythonChipConfig,
    pub package_config: carrot_settings::PackageChipConfig,
}
