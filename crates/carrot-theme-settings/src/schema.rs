...
pub use inazuma_settings_content::{
    HighlightStyleContent, StatusColorsContent, ThemeColorsContent, ThemeStyleContent,
};
...
use carrot_theme::{
    EditorColorsRefinement, MinimapColorsRefinement, PaneColorsRefinement, PanelColorsRefinement,
    ScrollbarColorsRefinement, SearchColorsRefinement, StatusBarColorsRefinement,
    StatusColorsRefinement, StatusStyleRefinement, TabColorsRefinement,
    TerminalAnsiColorsRefinement, TerminalColorsRefinement, ThemeColorsRefinement,
...
pub struct ThemeContent {
    pub name: String,
    pub appearance: carrot_theme::AppearanceContent,
...
fn try_parse_color(color: &str) -> anyhow::Result<Oklch> {
    carrot_theme::parse_color(color)
}
...
pub fn status_colors_refinement(colors: &StatusColorsContent) -> StatusColorsRefinement {
    StatusColorsRefinement {
        conflict: parse_status_style(
            &colors.conflict,
            &colors.conflict_background,
            &colors.conflict_border,
        ),
        created: parse_status_style(
            &colors.created,
            &colors.created_background,
            &colors.created_border,
        ),
        deleted: parse_status_style(
            &colors.deleted,
            &colors.deleted_background,
            &colors.deleted_border,
        ),
        error: parse_status_style(
            &colors.error,
            &colors.error_background,
            &colors.error_border,
        ),
        hidden: parse_status_style(
            &colors.hidden,
            &colors.hidden_background,
            &colors.hidden_border,
        ),
        hint: parse_status_style(&colors.hint, &colors.hint_background, &colors.hint_border),
        ignored: parse_status_style(
            &colors.ignored,
            &colors.ignored_background,
            &colors.ignored_border,
        ),
        info: parse_status_style(&colors.info, &colors.info_background, &colors.info_border),
        modified: parse_status_style(
            &colors.modified,
            &colors.modified_background,
            &colors.modified_border,
        ),
        predictive: parse_status_style(
            &colors.predictive,
            &colors.predictive_background,
            &colors.predictive_border,
        ),
        renamed: parse_status_style(
            &colors.renamed,
            &colors.renamed_background,
            &colors.renamed_border,
        ),
        success: parse_status_style(
            &colors.success,
            &colors.success_background,
            &colors.success_border,
        ),
        unreachable: parse_status_style(
            &colors.unreachable,
            &colors.unreachable_background,
            &colors.unreachable_border,
        ),
        warning: parse_status_style(
            &colors.warning,
...
pub fn theme_colors_refinement(
    ...
    ThemeColorsRefinement {
        ...
        editor: EditorColorsRefinement {
            ...
            document_highlight_write_background: c(
                &colors.editor_document_highlight_write_background
            ),
            document_highlight_bracket_background: c(
