...
use anyhow::Result;
use carrot_language_model::LanguageModelProviderId;
use carrot_project::{AgentId, Project};
use carrot_task::{HideStrategy, SpawnInTerminal, TaskId};
use carrot_ui::{App, IconName};
use chrono::{DateTime, Utc};
use inazuma::{Entity, SharedString, Task};
...
mod test_support {
    ...
    use inazuma::{AppContext as _, WeakEntity};
        ...
        fn new() -> Self {
            Self {
                selected_model: Arc::new(Mutex::new(AgentModelInfo {
                    ...
                    icon: Some(AgentModelIcon::Named(carrot_ui::IconName::CarrotAssistant)),
                    is_latest: false,
                    cost: None,
                })),
            }
