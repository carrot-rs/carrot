...
pub trait LocalDapCommand: 'static + Send + Sync + std::fmt::Debug {
    ...
    type DapRequest: 'static + Send + carrot_dap::requests::Request;
    ...
    fn to_dap(&self) -> <Self::DapRequest as carrot_dap::requests::Request>::Arguments;

    fn response_from_dap(
        &self,
        message: <Self::DapRequest as carrot_dap::requests::Request>::Response,
...
impl LocalDapCommand for NextCommand {
    type Response = <Next as carrot_dap::requests::Request>::Response;
    ...
    fn response_from_dap(
        &self,
        _message: <Self::DapRequest as carrot_dap::requests::Request>::Response,
    ) -> Result<Self::Response> {
        Ok(())
    }
}
...
impl LocalDapCommand for StepInCommand {
    type Response = <carrot_dap::requests::StepIn as carrot_dap::requests::Request>::Response;
    type DapRequest = carrot_dap::requests::StepIn;
...
impl LocalDapCommand for StepOutCommand {
    type Response = <carrot_dap::requests::StepOut as carrot_dap::requests::Request>::Response;
    type DapRequest = carrot_dap::requests::StepOut;
...
impl LocalDapCommand for StepBackCommand {
    type Response = <carrot_dap::requests::StepBack as carrot_dap::requests::Request>::Response;
    type DapRequest = carrot_dap::requests::StepBack;
...
impl LocalDapCommand for ContinueCommand {
    type Response = <Continue as carrot_dap::requests::Request>::Response;
...
impl LocalDapCommand for PauseCommand {
    type Response = <carrot_dap::requests::Pause as carrot_dap::requests::Request>::Response;
    type DapRequest = carrot_dap::requests::Pause;
    fn to_dap(&self) -> <Self::DapRequest as carrot_dap::requests::Request>::Arguments {
        carrot_dap::PauseArguments {
...
impl LocalDapCommand for DisconnectCommand {
    type Response = <carrot_dap::requests::Disconnect as carrot_dap::requests::Request>::Response;
    type DapRequest = carrot_dap::requests::Disconnect;

    fn to_dap(&self) -> <Self::DapRequest as carrot_dap::requests::Request>::Arguments {
        carrot_dap::DisconnectArguments {
...
impl LocalDapCommand for TerminateThreadsCommand {
    type Response =
        <carrot_dap::requests::TerminateThreads as carrot_dap::requests::Request>::Response;
    type DapRequest = carrot_dap::requests::TerminateThreads;
    ...
    fn to_dap(&self) -> <Self::DapRequest as carrot_dap::requests::Request>::Arguments {
        carrot_dap::TerminateThreadsArguments {
...
impl LocalDapCommand for TerminateCommand {
    type Response = <carrot_dap::requests::Terminate as carrot_dap::requests::Request>::Response;
    type DapRequest = carrot_dap::requests::Terminate;

    fn is_supported(capabilities: &Capabilities) -> bool {
        capabilities.supports_terminate_request.unwrap_or_default()
    }
    fn to_dap(&self) -> <Self::DapRequest as carrot_dap::requests::Request>::Arguments {
        carrot_dap::TerminateArguments {
            restart: self.restart,
        }
    }
...
impl LocalDapCommand for RestartCommand {
    type Response = <carrot_dap::requests::Restart as carrot_dap::requests::Request>::Response;
    type DapRequest = carrot_dap::requests::Restart;
...
impl LocalDapCommand for VariablesCommand {
    ...
    type DapRequest = carrot_dap::requests::Variables;
    const CACHEABLE: bool = true;

    fn to_dap(&self) -> <Self::DapRequest as carrot_dap::requests::Request>::Arguments {
        carrot_dap::VariablesArguments {
...
impl LocalDapCommand for SetVariableValueCommand {
    ...
    type DapRequest = carrot_dap::requests::SetVariable;
    fn is_supported(capabilities: &Capabilities) -> bool {
        capabilities.supports_set_variable.unwrap_or_default()
    }
    fn to_dap(&self) -> <Self::DapRequest as carrot_dap::requests::Request>::Arguments {
        carrot_dap::SetVariableArguments {
            format: None,
...
impl LocalDapCommand for RestartStackFrameCommand {
    type Response = <carrot_dap::requests::RestartFrame as carrot_dap::requests::Request>::Response;
    type DapRequest = carrot_dap::requests::RestartFrame;
    ...
    fn to_dap(&self) -> <Self::DapRequest as carrot_dap::requests::Request>::Arguments {
        carrot_dap::RestartFrameArguments {
...
impl LocalDapCommand for ModulesCommand {
    type Response = Vec<carrot_dap::Module>;
    type DapRequest = carrot_dap::requests::Modules;
    const CACHEABLE: bool = true;
...
impl DapCommand for ModulesCommand {
    ...
    fn response_from_proto(&self, message: Self::ProtoResponse) -> Result<Self::Response> {
        Ok(message
            .modules
            .into_iter()
            .filter_map(|module| carrot_dap::Module::from_proto(module).ok())
            .collect())
    }
}
...
impl LocalDapCommand for LoadedSourcesCommand {
    type Response = Vec<carrot_dap::Source>;
    type DapRequest = carrot_dap::requests::LoadedSources;
    const CACHEABLE: bool = true;
    ...
    fn to_dap(&self) -> <Self::DapRequest as carrot_dap::requests::Request>::Arguments {
        carrot_dap::LoadedSourcesArguments {}
    }
...
impl DapCommand for LoadedSourcesCommand {
    ...
    fn response_from_proto(&self, message: Self::ProtoResponse) -> Result<Self::Response> {
        Ok(message
            .sources
            .into_iter()
            .map(carrot_dap::Source::from_proto)
            .collect())
    }
}
...
impl LocalDapCommand for StackTraceCommand {
    type Response = Vec<carrot_dap::StackFrame>;
    type DapRequest = carrot_dap::requests::StackTrace;
    const CACHEABLE: bool = true;

    fn to_dap(&self) -> <Self::DapRequest as carrot_dap::requests::Request>::Arguments {
        carrot_dap::StackTraceArguments {
            thread_id: self.thread_id,
...
impl DapCommand for StackTraceCommand {
    ...
    fn response_from_proto(&self, message: Self::ProtoResponse) -> Result<Self::Response> {
        Ok(message
            .frames
            .into_iter()
            .map(carrot_dap::StackFrame::from_proto)
            .collect())
    }
...
impl LocalDapCommand for ScopesCommand {
    type Response = Vec<carrot_dap::Scope>;
    type DapRequest = carrot_dap::requests::Scopes;
    const CACHEABLE: bool = true;

    fn to_dap(&self) -> <Self::DapRequest as carrot_dap::requests::Request>::Arguments {
        carrot_dap::ScopesArguments {
            frame_id: self.stack_frame_id,
        }
    }
...
impl LocalDapCommand for super::session::CompletionsQuery {
    type Response = carrot_dap::CompletionsResponse;
    type DapRequest = carrot_dap::requests::Completions;
    const CACHEABLE: bool = true;

    fn to_dap(&self) -> <Self::DapRequest as carrot_dap::requests::Request>::Arguments {
        carrot_dap::CompletionsArguments {
...
impl DapCommand for super::session::CompletionsQuery {
    ...
    fn response_from_proto(&self, message: Self::ProtoResponse) -> Result<Self::Response> {
        Ok(carrot_dap::CompletionsResponse {
...
pub(crate) struct EvaluateCommand {
    ...
    pub context: Option<carrot_dap::EvaluateArgumentsContext>,
    pub source: Option<carrot_dap::Source>,
}

impl LocalDapCommand for EvaluateCommand {
    type Response = carrot_dap::EvaluateResponse;
    type DapRequest = carrot_dap::requests::Evaluate;
    fn to_dap(&self) -> <Self::DapRequest as carrot_dap::requests::Request>::Arguments {
        carrot_dap::EvaluateArguments {
...
impl DapCommand for EvaluateCommand {
    ...
    fn from_proto(request: &Self::ProtoRequest) -> Self {
        Self {
            ...
            frame_id: request.frame_id,
            context: Some(carrot_dap::EvaluateArgumentsContext::from_proto(
                request.context(),
            )),
            source: None,
        }
    ...
    fn response_from_proto(&self, message: Self::ProtoResponse) -> Result<Self::Response> {
        Ok(carrot_dap::EvaluateResponse {
...
impl LocalDapCommand for ThreadsCommand {
    type Response = Vec<carrot_dap::Thread>;
    type DapRequest = carrot_dap::requests::Threads;
    const CACHEABLE: bool = true;

    fn to_dap(&self) -> <Self::DapRequest as carrot_dap::requests::Request>::Arguments {
        carrot_dap::ThreadsArgument {}
    }
...
fn dap_client_capabilities(adapter_id: String) -> InitializeRequestArguments {
    InitializeRequestArguments {
        client_id: Some("carrot".to_owned()),
        client_name: Some("Carrot".to_owned()),
        adapter_id,
...
impl LocalDapCommand for Initialize {
    ...
    type DapRequest = carrot_dap::requests::Initialize;
...
impl LocalDapCommand for ConfigurationDone {
    type Response = ();
    type DapRequest = carrot_dap::requests::ConfigurationDone;
    ...
    fn to_dap(&self) -> <Self::DapRequest as carrot_dap::requests::Request>::Arguments {
        carrot_dap::ConfigurationDoneArguments {}
    }
...
impl LocalDapCommand for Launch {
    type Response = ();
    type DapRequest = carrot_dap::requests::Launch;

    fn to_dap(&self) -> <Self::DapRequest as carrot_dap::requests::Request>::Arguments {
        carrot_dap::LaunchRequestArguments {
            raw: self.raw.clone(),
        }
    }
...
impl LocalDapCommand for Attach {
    type Response = ();
    type DapRequest = carrot_dap::requests::Attach;

    fn to_dap(&self) -> <Self::DapRequest as carrot_dap::requests::Request>::Arguments {
        carrot_dap::AttachRequestArguments {
            raw: self.raw.clone(),
        }
    }
...
pub(super) struct SetBreakpoints {
    pub(super) source: carrot_dap::Source,
    pub(super) breakpoints: Vec<SourceBreakpoint>,
    pub(super) source_modified: Option<bool>,
}

impl LocalDapCommand for SetBreakpoints {
    type Response = Vec<carrot_dap::Breakpoint>;
    type DapRequest = carrot_dap::requests::SetBreakpoints;

    fn to_dap(&self) -> <Self::DapRequest as carrot_dap::requests::Request>::Arguments {
        carrot_dap::SetBreakpointsArguments {
            lines: None,
...
impl LocalDapCommand for DataBreakpointInfoCommand {
    type Response = carrot_dap::DataBreakpointInfoResponse;
    type DapRequest = carrot_dap::requests::DataBreakpointInfo;
    const CACHEABLE: bool = true;
    ...
    fn to_dap(&self) -> <Self::DapRequest as carrot_dap::requests::Request>::Arguments {
        ...
        carrot_dap::DataBreakpointInfoArguments {
            variables_reference,
            name,
            frame_id,
            bytes,
...
pub(crate) struct SetDataBreakpointsCommand {
    pub breakpoints: Vec<carrot_dap::DataBreakpoint>,
}

impl LocalDapCommand for SetDataBreakpointsCommand {
    type Response = Vec<carrot_dap::Breakpoint>;
    type DapRequest = carrot_dap::requests::SetDataBreakpoints;
    ...
    fn to_dap(&self) -> <Self::DapRequest as carrot_dap::requests::Request>::Arguments {
        carrot_dap::SetDataBreakpointsArguments {
...
impl LocalDapCommand for SetExceptionBreakpoints {
    type Response = Vec<carrot_dap::Breakpoint>;
    type DapRequest = carrot_dap::requests::SetExceptionBreakpoints;

    fn to_dap(&self) -> <Self::DapRequest as carrot_dap::requests::Request>::Arguments {
        match self {
            SetExceptionBreakpoints::Plain { filters } => {
                carrot_dap::SetExceptionBreakpointsArguments {
...
impl LocalDapCommand for LocationsCommand {
    type Response = carrot_dap::LocationsResponse;
    type DapRequest = carrot_dap::requests::Locations;
    const CACHEABLE: bool = true;

    fn to_dap(&self) -> <Self::DapRequest as carrot_dap::requests::Request>::Arguments {
        carrot_dap::LocationsArguments {
...
impl DapCommand for LocationsCommand {
    ...
    fn response_from_proto(&self, response: Self::ProtoResponse) -> Result<Self::Response> {
        Ok(carrot_dap::LocationsResponse {
            source: response
                .source
                .map(<carrot_dap::Source as ProtoConversion>::from_proto)
...
impl LocalDapCommand for ReadMemory {
    ...
    type DapRequest = carrot_dap::requests::ReadMemory;
    const CACHEABLE: bool = true;
    ...
    fn to_dap(&self) -> <Self::DapRequest as carrot_dap::requests::Request>::Arguments {
        carrot_dap::ReadMemoryArguments {
...
impl LocalDapCommand for carrot_dap::WriteMemoryArguments {
    type Response = carrot_dap::WriteMemoryResponse;
    type DapRequest = carrot_dap::requests::WriteMemory;
    fn is_supported(capabilities: &Capabilities) -> bool {
        capabilities
