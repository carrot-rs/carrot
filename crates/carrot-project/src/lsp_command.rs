...
use carrot_client::proto::{self, PeerId};
use carrot_language::{
...
use futures::future;
use inazuma::{App, AsyncApp, Entity, SharedString, Task, prelude::FluentBuilder};
use inazuma_clock::Global;
use inazuma_collections::HashMap;
use inazuma_text::{BufferId, LineEnding};
use inazuma_util::{ResultExt as _, debug_panic};
...
fn code_action_kind_matches(
    requested: &carrot_lsp::CodeActionKind,
    actual: &carrot_lsp::CodeActionKind,
) -> bool {
...
pub fn lsp_formatting_options(settings: &LanguageSettings) -> carrot_lsp::FormattingOptions {
    carrot_lsp::FormattingOptions {
        ...
        ..carrot_lsp::FormattingOptions::default()
    }
}

pub fn file_path_to_lsp_url(path: &Path) -> Result<carrot_lsp::Uri> {
    match carrot_lsp::Uri::from_file_path(path) {
        Ok(url) => Ok(url),
        Err(()) => anyhow::bail!("Invalid file path provided to LSP request: {path:?}"),
    }
}

pub(crate) fn make_text_document_identifier(
    path: &Path,
) -> Result<carrot_lsp::TextDocumentIdentifier> {
    Ok(carrot_lsp::TextDocumentIdentifier {
...
pub(crate) fn make_lsp_text_document_position(
    path: &Path,
    position: PointUtf16,
) -> Result<carrot_lsp::TextDocumentPositionParams> {
    Ok(carrot_lsp::TextDocumentPositionParams {
...
pub trait LspCommand: 'static + Sized + Send + std::fmt::Debug {
    ...
    type LspRequest: 'static + Send + carrot_lsp::request::Request;
    ...
    fn to_lsp_params_or_response(
        ...
        LspParamsOrResponse<
            <Self::LspRequest as carrot_lsp::request::Request>::Params,
            Self::Response,
        >,
    > {
    ...
    fn to_lsp(
        ...
        language_server: &Arc<LanguageServer>,
        cx: &App,
    ) -> Result<<Self::LspRequest as carrot_lsp::request::Request>::Params>;

    async fn response_from_lsp(
        self,
        message: <Self::LspRequest as carrot_lsp::request::Request>::Result,
...
pub(crate) struct GetCompletions {
    ...
    pub server_id: Option<carrot_lsp::LanguageServerId>,
}

#[derive(Clone, Debug)]
pub(crate) struct GetCodeActions {
    pub range: Range<Anchor>,
    pub kinds: Option<Vec<carrot_lsp::CodeActionKind>>,
}
...
pub(crate) struct OnTypeFormatting {
    pub position: PointUtf16,
    pub trigger: String,
    pub options: carrot_lsp::FormattingOptions,
    pub push_to_history: bool,
}
...
impl LspCommand for PrepareRename {
    ...
    type LspRequest = carrot_lsp::request::PrepareRenameRequest;
    ...
    fn to_lsp_params_or_response(
        ...
        language_server: &Arc<LanguageServer>,
        cx: &App,
    ) -> Result<LspParamsOrResponse<carrot_lsp::TextDocumentPositionParams, PrepareRenameResponse>>
    {
        ...
        match rename_provider {
            Some(carrot_lsp::OneOf::Right(RenameOptions {
            ...
            Some(carrot_lsp::OneOf::Right(_)) => Ok(LspParamsOrResponse::Response(
                PrepareRenameResponse::OnlyUnpreparedRenameSupported,
            )),
            Some(carrot_lsp::OneOf::Left(true)) => Ok(LspParamsOrResponse::Response(
                PrepareRenameResponse::OnlyUnpreparedRenameSupported,
            )),
    ...
    async fn response_from_lsp(
        self,
        message: Option<carrot_lsp::PrepareRenameResponse>,
        _: Entity<LspStore>,
        buffer: Entity<Buffer>,
        _: LanguageServerId,
        cx: AsyncApp,
        ...
        buffer.read_with(&cx, |buffer, _| match message {
            Some(carrot_lsp::PrepareRenameResponse::Range(range))
            | Some(carrot_lsp::PrepareRenameResponse::RangeWithPlaceholder { range, .. }) => {
            ...
            Some(carrot_lsp::PrepareRenameResponse::DefaultBehavior { .. }) => {
    ...
    fn to_proto(&self, project_id: u64, buffer: &Buffer) -> proto::PrepareRename {
        proto::PrepareRename {
            ...
            position: Some(carrot_language::proto::serialize_anchor(
    ...
    fn response_to_proto(
        ...
        match response {
            PrepareRenameResponse::Success(range) => proto::PrepareRenameResponse {
                ...
                start: Some(carrot_language::proto::serialize_anchor(&range.start)),
                end: Some(carrot_language::proto::serialize_anchor(&range.end)),
...
impl LspCommand for PerformRename {
    ...
    type LspRequest = carrot_lsp::request::Rename;
    ...
    fn to_lsp(
        ...
        _: &Arc<LanguageServer>,
        _: &App,
    ) -> Result<carrot_lsp::RenameParams> {
        Ok(carrot_lsp::RenameParams {
    ...
    async fn response_from_lsp(
        self,
        message: Option<carrot_lsp::WorkspaceEdit>,
        lsp_store: Entity<LspStore>,
        buffer: Entity<Buffer>,
        server_id: LanguageServerId,
        mut cx: AsyncApp,
...
impl LspCommand for GetDefinitions {
    ...
    type LspRequest = carrot_lsp::request::GotoDefinition;
    ...
    fn to_lsp(
        ...
        _: &Arc<LanguageServer>,
        _: &App,
    ) -> Result<carrot_lsp::GotoDefinitionParams> {
        Ok(carrot_lsp::GotoDefinitionParams {
    ...
    async fn response_from_lsp(
        self,
        message: Option<carrot_lsp::GotoDefinitionResponse>,
        lsp_store: Entity<LspStore>,
        buffer: Entity<Buffer>,
        server_id: LanguageServerId,
        cx: AsyncApp,
...
impl LspCommand for GetDeclarations {
    type Response = Vec<LocationLink>;
    type LspRequest = carrot_lsp::request::GotoDeclaration;
    ...
    fn check_capabilities(&self, capabilities: AdapterServerCapabilities) -> bool {
        capabilities
            ...
            .is_some_and(|capability| match capability {
                carrot_lsp::DeclarationCapability::Simple(supported) => supported,
                carrot_lsp::DeclarationCapability::RegistrationOptions(..) => true,
                carrot_lsp::DeclarationCapability::Options(..) => true,
            })
    }
    ...
    fn to_lsp(
        ...
        _: &Arc<LanguageServer>,
        _: &App,
    ) -> Result<carrot_lsp::GotoDeclarationParams> {
        Ok(carrot_lsp::GotoDeclarationParams {
            text_document_position_params: make_lsp_text_document_position(path, self.position)?,
            work_done_progress_params: Default::default(),
            partial_result_params: Default::default(),
        })
    ...
    async fn response_from_lsp(
        self,
        message: Option<carrot_lsp::GotoDeclarationResponse>,
        lsp_store: Entity<LspStore>,
        buffer: Entity<Buffer>,
        server_id: LanguageServerId,
        cx: AsyncApp,
...
impl LspCommand for GetImplementations {
    type Response = Vec<LocationLink>;
    type LspRequest = carrot_lsp::request::GotoImplementation;
    ...
    fn check_capabilities(&self, capabilities: AdapterServerCapabilities) -> bool {
        capabilities
            ...
            .is_some_and(|capability| match capability {
                carrot_lsp::ImplementationProviderCapability::Simple(enabled) => enabled,
                carrot_lsp::ImplementationProviderCapability::Options(_options) => true,
            })
    }
    ...
    fn to_lsp(
        ...
        _: &Arc<LanguageServer>,
        _: &App,
    ) -> Result<carrot_lsp::GotoImplementationParams> {
        Ok(carrot_lsp::GotoImplementationParams {
            text_document_position_params: make_lsp_text_document_position(path, self.position)?,
            work_done_progress_params: Default::default(),
            partial_result_params: Default::default(),
        })
    ...
    async fn response_from_lsp(
        self,
        message: Option<carrot_lsp::GotoImplementationResponse>,
        lsp_store: Entity<LspStore>,
        buffer: Entity<Buffer>,
        server_id: LanguageServerId,
        cx: AsyncApp,
...
impl LspCommand for GetTypeDefinitions {
    type Response = Vec<LocationLink>;
    type LspRequest = carrot_lsp::request::GotoTypeDefinition;
    ...
    fn check_capabilities(&self, capabilities: AdapterServerCapabilities) -> bool {
        !matches!(
            ...
            None | Some(carrot_lsp::TypeDefinitionProviderCapability::Simple(false))
        )
    }
    ...
    fn to_lsp(
        ...
        _: &Arc<LanguageServer>,
        _: &App,
    ) -> Result<carrot_lsp::GotoTypeDefinitionParams> {
        Ok(carrot_lsp::GotoTypeDefinitionParams {
            text_document_position_params: make_lsp_text_document_position(path, self.position)?,
            work_done_progress_params: Default::default(),
            partial_result_params: Default::default(),
        })
    ...
    async fn response_from_lsp(
        self,
        message: Option<carrot_lsp::GotoTypeDefinitionResponse>,
        project: Entity<LspStore>,
        buffer: Entity<Buffer>,
        server_id: LanguageServerId,
        cx: AsyncApp,
...
pub async fn location_links_from_lsp(
    ...
    match message {
        carrot_lsp::GotoDefinitionResponse::Scalar(loc) => {
            unresolved_links.push((None, loc.uri, loc.range));
        }

        carrot_lsp::GotoDefinitionResponse::Array(locs) => {
            unresolved_links.extend(locs.into_iter().map(|l| (None, l.uri, l.range)));
        }

        carrot_lsp::GotoDefinitionResponse::Link(links) => {
...
impl LspCommand for GetReferences {
    ...
    type LspRequest = carrot_lsp::request::References;
    ...
    fn to_lsp(
        ...
        _: &Arc<LanguageServer>,
        _: &App,
    ) -> Result<carrot_lsp::ReferenceParams> {
        Ok(carrot_lsp::ReferenceParams {
            text_document_position: make_lsp_text_document_position(path, self.position)?,
            work_done_progress_params: Default::default(),
            partial_result_params: Default::default(),
            context: carrot_lsp::ReferenceContext {
    ...
    async fn response_from_lsp(
        self,
        locations: Option<Vec<carrot_lsp::Location>>,
        lsp_store: Entity<LspStore>,
        buffer: Entity<Buffer>,
        server_id: LanguageServerId,
        mut cx: AsyncApp,
...
impl LspCommand for GetDocumentHighlights {
    ...
    type LspRequest = carrot_lsp::request::DocumentHighlightRequest;
    ...
    fn to_lsp(
        ...
        _: &Arc<LanguageServer>,
        _: &App,
    ) -> Result<carrot_lsp::DocumentHighlightParams> {
        Ok(carrot_lsp::DocumentHighlightParams {
            text_document_position_params: make_lsp_text_document_position(path, self.position)?,
            work_done_progress_params: Default::default(),
            partial_result_params: Default::default(),
        })
    ...
    async fn response_from_lsp(
        self,
        lsp_highlights: Option<Vec<carrot_lsp::DocumentHighlight>>,
        _: Entity<LspStore>,
        buffer: Entity<Buffer>,
        _: LanguageServerId,
        cx: AsyncApp,
            ...
            lsp_highlights
                ...
                .map(|lsp_highlight| {
                    ...
                    DocumentHighlight {
                        ...
                        kind: lsp_highlight
                            .kind
                            .unwrap_or(carrot_lsp::DocumentHighlightKind::READ),
                    }
                })
                .collect()
        }))
...
impl LspCommand for GetDocumentSymbols {
    ...
    type LspRequest = carrot_lsp::request::DocumentSymbolRequest;
    ...
    fn to_lsp(
        ...
        _: &Arc<LanguageServer>,
        _: &App,
    ) -> Result<carrot_lsp::DocumentSymbolParams> {
        Ok(carrot_lsp::DocumentSymbolParams {
            text_document: make_text_document_identifier(path)?,
            work_done_progress_params: Default::default(),
            partial_result_params: Default::default(),
        })
    ...
    async fn response_from_lsp(
        self,
        lsp_symbols: Option<carrot_lsp::DocumentSymbolResponse>,
        _: Entity<LspStore>,
        _: Entity<Buffer>,
        _: LanguageServerId,
        _: AsyncApp,
        ...
        let symbols = match lsp_symbols {
            carrot_lsp::DocumentSymbolResponse::Flat(symbol_information) => symbol_information
                .into_iter()
                ...
                .collect(),
            carrot_lsp::DocumentSymbolResponse::Nested(nested_responses) => {
                fn convert_symbol(lsp_symbol: carrot_lsp::DocumentSymbol) -> DocumentSymbol {
                    DocumentSymbol {
                        name: lsp_symbol.name,
                        kind: lsp_symbol.kind,
    ...
    async fn response_from_proto(
        ...
        for serialized_symbol in message.symbols {
            fn deserialize_symbol_with_children(
                ...
                let kind = unsafe {
                    mem::transmute::<i32, carrot_lsp::SymbolKind>(serialized_symbol.kind)
                };
...
impl LspCommand for GetSignatureHelp {
    ...
    type LspRequest = carrot_lsp::SignatureHelpRequest;
    ...
    fn to_lsp(
        ...
        _: &Arc<LanguageServer>,
        _cx: &App,
    ) -> Result<carrot_lsp::SignatureHelpParams> {
        Ok(carrot_lsp::SignatureHelpParams {
            text_document_position_params: make_lsp_text_document_position(path, self.position)?,
            context: None,
            work_done_progress_params: Default::default(),
        })
    ...
    async fn response_from_lsp(
        self,
        message: Option<carrot_lsp::SignatureHelp>,
        lsp_store: Entity<LspStore>,
        _: Entity<Buffer>,
        id: LanguageServerId,
        cx: AsyncApp,
...
impl LspCommand for GetHover {
    ...
    type LspRequest = carrot_lsp::request::HoverRequest;
    ...
    fn check_capabilities(&self, capabilities: AdapterServerCapabilities) -> bool {
        match capabilities.server_capabilities.hover_provider {
            Some(carrot_lsp::HoverProviderCapability::Simple(enabled)) => enabled,
            Some(carrot_lsp::HoverProviderCapability::Options(_)) => true,
            None => false,
        }
    }
    ...
    fn to_lsp(
        ...
        _: &Arc<LanguageServer>,
        _: &App,
    ) -> Result<carrot_lsp::HoverParams> {
        Ok(carrot_lsp::HoverParams {
            text_document_position_params: make_lsp_text_document_position(path, self.position)?,
            work_done_progress_params: Default::default(),
        })
    }
    ...
    async fn response_from_lsp(
        self,
        message: Option<carrot_lsp::Hover>,
        _: Entity<LspStore>,
        buffer: Entity<Buffer>,
        _: LanguageServerId,
        cx: AsyncApp,
        ...
        fn hover_blocks_from_marked_string(
            marked_string: carrot_lsp::MarkedString,
        ) -> Option<HoverBlock> {
            let block = match marked_string {
                carrot_lsp::MarkedString::String(content) => HoverBlock {
                    text: content,
                    kind: HoverBlockKind::Markdown,
                },
                carrot_lsp::MarkedString::LanguageString(carrot_lsp::LanguageString {
                    language,
                    value,
                }) => HoverBlock {
                    text: value,
        ...
        let contents = match hover.contents {
            carrot_lsp::HoverContents::Scalar(marked_string) => {
                hover_blocks_from_marked_string(marked_string)
                    .into_iter()
                    .collect()
            }
            carrot_lsp::HoverContents::Array(marked_strings) => marked_strings
                .into_iter()
                .filter_map(hover_blocks_from_marked_string)
                .collect(),
            carrot_lsp::HoverContents::Markup(markup_content) => vec![HoverBlock {
                text: markup_content.value,
                kind: if markup_content.kind == carrot_lsp::MarkupKind::Markdown {
    ...
    fn response_to_proto(
        ...
        if let Some(response) = response {
            let (start, end) = if let Some(range) = response.range {
                (
                    Some(carrot_language::proto::serialize_anchor(&range.start)),
                    Some(carrot_language::proto::serialize_anchor(&range.end)),
                )
            } else {
                (None, None)
            };
    ...
    async fn response_from_proto(
        ...
        let range = if let (Some(start), Some(end)) = (message.start, message.end) {
            carrot_language::proto::deserialize_anchor(start).and_then(|start| {
                carrot_language::proto::deserialize_anchor(end).map(|end| start..end)
            })
        } else {
            None
        };
...
impl GetCompletions {
    pub fn can_resolve_completions(capabilities: &carrot_lsp::ServerCapabilities) -> bool {
        capabilities
            .completion_provider
            .as_ref()
...
impl LspCommand for GetCompletions {
    ...
    type LspRequest = carrot_lsp::request::Completion;
    ...
    fn to_lsp(
        ...
        _: &Arc<LanguageServer>,
        _: &App,
    ) -> Result<carrot_lsp::CompletionParams> {
        Ok(carrot_lsp::CompletionParams {
            text_document_position: make_lsp_text_document_position(path, self.position)?,
    ...
    async fn response_from_lsp(
        self,
        completions: Option<carrot_lsp::CompletionResponse>,
        lsp_store: Entity<LspStore>,
        buffer: Entity<Buffer>,
        server_id: LanguageServerId,
        mut cx: AsyncApp,
        ...
        let (mut completions, mut is_incomplete) = if let Some(completions) = completions {
            match completions {
                carrot_lsp::CompletionResponse::Array(completions) => (completions, false),
                carrot_lsp::CompletionResponse::List(mut list) => {
                ...
                let lsp_edit = lsp_completion.text_edit.clone().or_else(|| {
                    ...
                    match default_text_edit {
                        CompletionListItemDefaultsEditRange::Range(range) => {
                            Some(carrot_lsp::CompletionTextEdit::Edit(carrot_lsp::TextEdit {
                                range: *range,
                                new_text,
                            }))
                        }
                        CompletionListItemDefaultsEditRange::InsertAndReplace {
                            insert,
                            replace,
                        } => Some(carrot_lsp::CompletionTextEdit::InsertAndReplace(
                            carrot_lsp::InsertReplaceEdit {
                                new_text,
                                insert: *insert,
                                replace: *replace,
                            },
    ...
    fn to_proto(&self, project_id: u64, buffer: &Buffer) -> proto::GetCompletions {
        ...
        proto::GetCompletions {
            project_id,
            buffer_id: buffer.remote_id().into(),
            position: Some(carrot_language::proto::serialize_anchor(&anchor)),
            version: serialize_version(&buffer.version()),
    ...
    async fn from_proto(
        ...
        let position = message
            .position
            .and_then(carrot_language::proto::deserialize_anchor)
            .map(|p| {
        ...
        Ok(Self {
            ...
            server_id: message
                .server_id
                .map(|id| carrot_lsp::LanguageServerId::from_proto(id)),
        })
    }
...
pub(crate) fn parse_completion_text_edit(
    edit: &carrot_lsp::CompletionTextEdit,
    snapshot: &BufferSnapshot,
) -> Option<ParsedCompletionEdit> {
    let (replace_range, insert_range, new_text) = match edit {
        carrot_lsp::CompletionTextEdit::Edit(edit) => (edit.range, None, &edit.new_text),
        carrot_lsp::CompletionTextEdit::InsertAndReplace(edit) => {
...
impl LspCommand for GetCodeActions {
    ...
    type LspRequest = carrot_lsp::request::CodeActionRequest;
    ...
    fn check_capabilities(&self, capabilities: AdapterServerCapabilities) -> bool {
        match &capabilities.server_capabilities.code_action_provider {
            None => false,
            Some(carrot_lsp::CodeActionProviderCapability::Simple(false)) => false,
            _ => {
    ...
    fn to_lsp(
        ...
        language_server: &Arc<LanguageServer>,
        _: &App,
    ) -> Result<carrot_lsp::CodeActionParams> {
        let mut relevant_diagnostics = Vec::new();
        for entry in buffer
            .snapshot()
            .diagnostics_in_range::<_, carrot_language::PointUtf16>(self.range.clone(), false)
        {
        ...
        Ok(carrot_lsp::CodeActionParams {
            text_document: make_text_document_identifier(path)?,
            range: range_to_lsp(self.range.to_point_utf16(buffer))?,
            work_done_progress_params: Default::default(),
            partial_result_params: Default::default(),
            context: carrot_lsp::CodeActionContext {
                diagnostics: relevant_diagnostics,
                only,
                ..carrot_lsp::CodeActionContext::default()
            },
        })
    }
    ...
    async fn response_from_lsp(
        self,
        actions: Option<carrot_lsp::CodeActionResponse>,
        lsp_store: Entity<LspStore>,
        _: Entity<Buffer>,
        server_id: LanguageServerId,
        cx: AsyncApp,
        ...
        Ok(actions
            ...
            .filter_map(|entry| {
                let (lsp_action, resolved) = match entry {
                    carrot_lsp::CodeActionOrCommand::CodeAction(lsp_action) => {
                    ...
                    carrot_lsp::CodeActionOrCommand::Command(command) => {
    ...
    fn to_proto(&self, project_id: u64, buffer: &Buffer) -> proto::GetCodeActions {
        proto::GetCodeActions {
            project_id,
            buffer_id: buffer.remote_id().into(),
            start: Some(carrot_language::proto::serialize_anchor(&self.range.start)),
            end: Some(carrot_language::proto::serialize_anchor(&self.range.end)),
            version: serialize_version(&buffer.version()),
        }
    }
...
impl GetCodeActions {
    fn supported_code_action_kinds(
        ...
        match capabilities.server_capabilities.code_action_provider {
            Some(carrot_lsp::CodeActionProviderCapability::Options(CodeActionOptions {
    ...
    pub fn can_resolve_actions(capabilities: &ServerCapabilities) -> bool {
        capabilities
            ...
            .and_then(|options| match options {
                carrot_lsp::CodeActionProviderCapability::Simple(_is_supported) => None,
                carrot_lsp::CodeActionProviderCapability::Options(options) => {
...
impl LspCommand for OnTypeFormatting {
    ...
    type LspRequest = carrot_lsp::request::OnTypeFormatting;
    ...
    fn to_lsp(
        ...
        _: &Arc<LanguageServer>,
        _: &App,
    ) -> Result<carrot_lsp::DocumentOnTypeFormattingParams> {
        Ok(carrot_lsp::DocumentOnTypeFormattingParams {
            text_document_position: make_lsp_text_document_position(path, self.position)?,
    ...
    async fn response_from_lsp(
        self,
        message: Option<Vec<carrot_lsp::TextEdit>>,
        lsp_store: Entity<LspStore>,
        buffer: Entity<Buffer>,
        server_id: LanguageServerId,
        mut cx: AsyncApp,
    ...
    fn response_to_proto(
        ...
        proto::OnTypeFormattingResponse {
            transaction: response
                .map(|transaction| carrot_language::proto::serialize_transaction(&transaction)),
        }
    }
    ...
    async fn response_from_proto(
        ...
        Ok(Some(carrot_language::proto::deserialize_transaction(
            transaction,
        )?))
    }
...
impl InlayHints {
    pub async fn lsp_to_project_hint(
        ...
        let kind = lsp_hint.kind.and_then(|kind| match kind {
            carrot_lsp::InlayHintKind::TYPE => Some(InlayHintKind::Type),
            carrot_lsp::InlayHintKind::PARAMETER => Some(InlayHintKind::Parameter),
            _ => None,
        });
        ...
        Ok(InlayHint {
            ...
            tooltip: lsp_hint.tooltip.map(|tooltip| match tooltip {
                carrot_lsp::InlayHintTooltip::String(s) => InlayHintTooltip::String(s),
                carrot_lsp::InlayHintTooltip::MarkupContent(markup_content) => {
                    InlayHintTooltip::MarkupContent(MarkupContent {
                        kind: match markup_content.kind {
                            carrot_lsp::MarkupKind::PlainText => HoverBlockKind::PlainText,
                            carrot_lsp::MarkupKind::Markdown => HoverBlockKind::Markdown,
                        },
    ...
    async fn lsp_inlay_label_to_project(
        lsp_label: carrot_lsp::InlayHintLabel,
        server_id: LanguageServerId,
    ) -> anyhow::Result<InlayHintLabel> {
        let label = match lsp_label {
            carrot_lsp::InlayHintLabel::String(s) => InlayHintLabel::String(s),
            carrot_lsp::InlayHintLabel::LabelParts(lsp_parts) => {
                ...
                for lsp_part in lsp_parts {
                    parts.push(InlayHintLabelPart {
                        ...
                        tooltip: lsp_part.tooltip.map(|tooltip| match tooltip {
                            carrot_lsp::InlayHintLabelPartTooltip::String(s) => {
                                InlayHintLabelPartTooltip::String(s)
                            }
                            carrot_lsp::InlayHintLabelPartTooltip::MarkupContent(
                                markup_content,
    ...
    pub fn project_to_proto_hint(response_hint: InlayHint) -> proto::InlayHint {
        ...
        proto::InlayHint {
            position: Some(carrot_language::proto::serialize_anchor(&response_hint.position)),
        ...
        let resolve_state_data = resolve_state
            ...
            .map(|lsp_resolve_state| {
                let value = lsp_resolve_state.value.as_deref().map(|value| {
                    serde_json::from_str::<Option<carrot_lsp::LSPAny>>(value)
                            ...
                            location: {
                                    ...
                                    .zip(part.language_server_id)
                                {
                                    Some(((uri, range), server_id)) => Some((
                                        ...
                                        carrot_lsp::Location {
                                            uri: carrot_lsp::Uri::from_str(&uri).with_context(
    ...
    pub fn project_to_lsp_hint(
        hint: InlayHint,
        snapshot: &BufferSnapshot,
    ) -> carrot_lsp::InlayHint {
        carrot_lsp::InlayHint {
            position: point_to_lsp(hint.position.to_point_utf16(snapshot)),
            kind: hint.kind.map(|kind| match kind {
                InlayHintKind::Type => carrot_lsp::InlayHintKind::TYPE,
                InlayHintKind::Parameter => carrot_lsp::InlayHintKind::PARAMETER,
            }),
            text_edits: None,
            tooltip: hint.tooltip.and_then(|tooltip| {
                Some(match tooltip {
                    InlayHintTooltip::String(s) => carrot_lsp::InlayHintTooltip::String(s),
                    InlayHintTooltip::MarkupContent(markup_content) => {
                        carrot_lsp::InlayHintTooltip::MarkupContent(carrot_lsp::MarkupContent {
                            kind: match markup_content.kind {
                                HoverBlockKind::PlainText => carrot_lsp::MarkupKind::PlainText,
                                HoverBlockKind::Markdown => carrot_lsp::MarkupKind::Markdown,
            ...
            label: match hint.label {
                InlayHintLabel::String(s) => carrot_lsp::InlayHintLabel::String(s),
                InlayHintLabel::LabelParts(label_parts) => carrot_lsp::InlayHintLabel::LabelParts(
                    label_parts
                        .into_iter()
                        .map(|part| carrot_lsp::InlayHintLabelPart {
                            value: part.value,
        ...
        capabilities
            ...
            .and_then(|options| match options {
                ...
                OneOf::Right(capabilities) => match capabilities {
                    carrot_lsp::InlayHintServerCapabilities::Options(o) => o.resolve_provider,
                    carrot_lsp::InlayHintServerCapabilities::RegistrationOptions(o) => {
    ...
    pub fn check_capabilities(capabilities: &ServerCapabilities) -> bool {
        capabilities
            ...
            .is_some_and(|inlay_hint_provider| match inlay_hint_provider {
                carrot_lsp::OneOf::Left(enabled) => *enabled,
                carrot_lsp::OneOf::Right(_) => true,
            })
    }
}
...
impl LspCommand for InlayHints {
    ...
    type LspRequest = carrot_lsp::InlayHintRequest;
    ...
    fn to_lsp(
        ...
        _: &Arc<LanguageServer>,
        _: &App,
    ) -> Result<carrot_lsp::InlayHintParams> {
        Ok(carrot_lsp::InlayHintParams {
            text_document: carrot_lsp::TextDocumentIdentifier {
                uri: file_path_to_lsp_url(path)?,
            },
            range: range_to_lsp(self.range.to_point_utf16(buffer))?,
            work_done_progress_params: Default::default(),
    ...
    async fn response_from_lsp(
        self,
        message: Option<Vec<carrot_lsp::InlayHint>>,
        lsp_store: Entity<LspStore>,
        buffer: Entity<Buffer>,
        server_id: LanguageServerId,
        mut cx: AsyncApp,
...
impl LspCommand for SemanticTokensFull {
    ...
    type LspRequest = carrot_lsp::SemanticTokensFullRequest;
        ...
        capabilities
            ...
            .is_some_and(|semantic_tokens_provider| {
                let options = match semantic_tokens_provider {
                    carrot_lsp::SemanticTokensServerCapabilities::SemanticTokensOptions(opts) => opts,
                    carrot_lsp::SemanticTokensServerCapabilities::SemanticTokensRegistrationOptions(
                        opts,
                    ) => &opts.semantic_tokens_options,
                };

                match options.full {
                    Some(carrot_lsp::SemanticTokensFullOptions::Bool(is_supported)) => is_supported,
                    Some(carrot_lsp::SemanticTokensFullOptions::Delta { .. }) => true,
                    None => false,
                }
            })
    }
    ...
    fn to_lsp(
        ...
        _: &Arc<LanguageServer>,
        _: &App,
    ) -> Result<carrot_lsp::SemanticTokensParams> {
        Ok(carrot_lsp::SemanticTokensParams {
            text_document: carrot_lsp::TextDocumentIdentifier {
                uri: file_path_to_lsp_url(path)?,
            },
            partial_result_params: Default::default(),
    ...
    async fn response_from_lsp(
        self,
        message: Option<carrot_lsp::SemanticTokensResult>,
        _: Entity<LspStore>,
        _: Entity<Buffer>,
        _: LanguageServerId,
        _: AsyncApp,
        ...
        match message {
            Some(carrot_lsp::SemanticTokensResult::Tokens(tokens)) => {
                Ok(SemanticTokensResponse::Full {
                    data: tokens.data,
                    result_id: tokens.result_id.map(SharedString::new),
                })
            }
            Some(carrot_lsp::SemanticTokensResult::Partial(_)) => {
                anyhow::bail!(
...
impl LspCommand for SemanticTokensDelta {
    type Response = SemanticTokensResponse;
    type LspRequest = carrot_lsp::SemanticTokensFullDeltaRequest;
    type ProtoRequest = proto::SemanticTokens;
    ...
    fn check_capabilities(&self, capabilities: AdapterServerCapabilities) -> bool {
        capabilities
            ...
            .is_some_and(|semantic_tokens_provider| {
                ...
                match options.full {
                    Some(carrot_lsp::SemanticTokensFullOptions::Delta { delta }) => delta.unwrap_or(false),
    ...
    fn to_lsp(
        ...
        _: &Arc<LanguageServer>,
        _: &App,
    ) -> Result<carrot_lsp::SemanticTokensDeltaParams> {
        Ok(carrot_lsp::SemanticTokensDeltaParams {
            text_document: carrot_lsp::TextDocumentIdentifier {
                uri: file_path_to_lsp_url(path)?,
            },
    ...
    async fn response_from_lsp(
        self,
        message: Option<carrot_lsp::SemanticTokensFullDeltaResult>,
        _: Entity<LspStore>,
        _: Entity<Buffer>,
        _: LanguageServerId,
        _: AsyncApp,
        ...
        match message {
            Some(carrot_lsp::SemanticTokensFullDeltaResult::Tokens(tokens)) => {
                Ok(SemanticTokensResponse::Full {
                    data: tokens.data,
                    result_id: tokens.result_id.map(SharedString::new),
                })
            }
            Some(carrot_lsp::SemanticTokensFullDeltaResult::TokensDelta(delta)) => {
            ...
            Some(carrot_lsp::SemanticTokensFullDeltaResult::PartialTokensDelta { .. }) => {
                anyhow::bail!(
                    "Unexpected semantic tokens response with partial result for inlay hints"
                )
            }
...
impl LspCommand for GetCodeLens {
    type Response = Vec<CodeAction>;
    type LspRequest = carrot_lsp::CodeLensRequest;
    ...
    fn to_lsp(
        ...
        _: &Arc<LanguageServer>,
        _: &App,
    ) -> Result<carrot_lsp::CodeLensParams> {
        Ok(carrot_lsp::CodeLensParams {
            text_document: carrot_lsp::TextDocumentIdentifier {
                uri: file_path_to_lsp_url(path)?,
            },
            work_done_progress_params: carrot_lsp::WorkDoneProgressParams::default(),
            partial_result_params: carrot_lsp::PartialResultParams::default(),
        })
    }

    async fn response_from_lsp(
        self,
        message: Option<Vec<carrot_lsp::CodeLens>>,
        lsp_store: Entity<LspStore>,
        buffer: Entity<Buffer>,
        server_id: LanguageServerId,
        cx: AsyncApp,
...
impl LspCommand for LinkedEditingRange {
    ...
    type LspRequest = carrot_lsp::request::LinkedEditingRange;
    ...
    fn to_lsp(
        ...
        _: &App,
    ) -> Result<carrot_lsp::LinkedEditingRangeParams> {
        let position = self.position.to_point_utf16(&buffer.snapshot());
        Ok(carrot_lsp::LinkedEditingRangeParams {
    ...
    async fn response_from_lsp(
        self,
        message: Option<carrot_lsp::LinkedEditingRanges>,
        _: Entity<LspStore>,
        buffer: Entity<Buffer>,
        _server_id: LanguageServerId,
        cx: AsyncApp,
    ) -> Result<Vec<Range<Anchor>>> {
        if let Some(carrot_lsp::LinkedEditingRanges { mut ranges, .. }) = message {
...
impl GetDocumentDiagnostics {
        ...
        response
            ...
            .filter_map(|diagnostics| {
                Some(LspPullDiagnostics::Response {
                    ...
                    uri: carrot_lsp::Uri::from_str(diagnostics.uri.as_str()).log_err()?,
    ...
    pub fn deserialize_lsp_diagnostic(
        diagnostic: proto::LspDiagnostic,
    ) -> Result<carrot_lsp::Diagnostic> {
        ...
        let code = diagnostic.code.map(carrot_lsp::NumberOrString::String);
            ...
            .map(|info| {
                ...
                carrot_lsp::DiagnosticRelatedInformation {
                    location: carrot_lsp::Location {
                        ...
                        uri: carrot_lsp::Uri::from_str(&info.location_url.unwrap()).unwrap(),
                    },
        ...
        let tags = diagnostic
            ...
            .filter_map(|tag| match proto::LspDiagnosticTag::from_i32(tag) {
                Some(proto::LspDiagnosticTag::Unnecessary) => {
                    Some(carrot_lsp::DiagnosticTag::UNNECESSARY)
                }
                Some(proto::LspDiagnosticTag::Deprecated) => {
                    Some(carrot_lsp::DiagnosticTag::DEPRECATED)
                }
                _ => None,
            })
            .collect::<Vec<_>>();

        Ok(carrot_lsp::Diagnostic {
            range: carrot_language::range_to_lsp(range)?,
            severity: match proto::lsp_diagnostic::Severity::from_i32(diagnostic.severity).unwrap()
            {
                proto::lsp_diagnostic::Severity::Error => {
                    Some(carrot_lsp::DiagnosticSeverity::ERROR)
                }
                proto::lsp_diagnostic::Severity::Warning => {
                    Some(carrot_lsp::DiagnosticSeverity::WARNING)
                }
                proto::lsp_diagnostic::Severity::Information => {
                    Some(carrot_lsp::DiagnosticSeverity::INFORMATION)
                }
                proto::lsp_diagnostic::Severity::Hint => Some(carrot_lsp::DiagnosticSeverity::HINT),
                _ => None,
            },
            code,
            code_description: diagnostic
                ...
                .map(|code_description| CodeDescription {
                    href: Some(carrot_lsp::Uri::from_str(&code_description).unwrap()),
                }),
    ...
    pub fn serialize_lsp_diagnostic(
        diagnostic: carrot_lsp::Diagnostic,
    ) -> Result<proto::LspDiagnostic> {
        let range = carrot_language::range_from_lsp(diagnostic.range);
        let related_information = diagnostic
            .related_information
            .unwrap_or_default()
            .into_iter()
        ...
        let tags = diagnostic
            ...
            .into_iter()
            .map(|tag| match tag {
                carrot_lsp::DiagnosticTag::UNNECESSARY => proto::LspDiagnosticTag::Unnecessary,
                carrot_lsp::DiagnosticTag::DEPRECATED => proto::LspDiagnosticTag::Deprecated,
        ...
        Ok(proto::LspDiagnostic {
            ...
            severity: match diagnostic.severity {
                ...
                Some(carrot_lsp::DiagnosticSeverity::HINT) => proto::lsp_diagnostic::Severity::Hint,
                _ => proto::lsp_diagnostic::Severity::None,
            } as i32,
            code: diagnostic.code.as_ref().map(|code| match code {
                carrot_lsp::NumberOrString::Number(code) => code.to_string(),
                carrot_lsp::NumberOrString::String(code) => code.clone(),
            }),
            source: diagnostic.source.clone(),
            related_information,
            tags,
    ...
    pub fn deserialize_workspace_diagnostics_report(
        ...
        match report {
            carrot_lsp::WorkspaceDiagnosticReportResult::Report(workspace_diagnostic_report) => {
                for report in workspace_diagnostic_report.items {
                    match report {
                        carrot_lsp::WorkspaceDocumentDiagnosticReport::Full(report) => {
                        ...
                        carrot_lsp::WorkspaceDocumentDiagnosticReport::Unchanged(report) => {
            ...
            carrot_lsp::WorkspaceDiagnosticReportResult::Partial(
...
fn process_full_workspace_diagnostics_report(
    diagnostics: &mut HashMap<carrot_lsp::Uri, WorkspaceLspPullDiagnostics>,
    server_id: LanguageServerId,
    report: carrot_lsp::WorkspaceFullDocumentDiagnosticReport,
    registration_id: Option<SharedString>,
) {
...
fn process_unchanged_workspace_diagnostics_report(
    diagnostics: &mut HashMap<carrot_lsp::Uri, WorkspaceLspPullDiagnostics>,
    server_id: LanguageServerId,
    report: carrot_lsp::WorkspaceUnchangedDocumentDiagnosticReport,
    registration_id: Option<SharedString>,
) {
    let mut new_diagnostics = HashMap::default();
...
impl LspCommand for GetDocumentDiagnostics {
    ...
    type LspRequest = carrot_lsp::request::DocumentDiagnosticRequest;
    ...
    fn to_lsp(
        ...
        _: &Arc<LanguageServer>,
        _: &App,
    ) -> Result<carrot_lsp::DocumentDiagnosticParams> {
        Ok(carrot_lsp::DocumentDiagnosticParams {
            text_document: carrot_lsp::TextDocumentIdentifier {
                uri: file_path_to_lsp_url(path)?,
            },
    ...
    async fn response_from_lsp(
        self,
        message: carrot_lsp::DocumentDiagnosticReportResult,
        _: Entity<LspStore>,
        buffer: Entity<Buffer>,
        server_id: LanguageServerId,
        cx: AsyncApp,
        ...
        let mut pulled_diagnostics = HashMap::default();
        match message {
            carrot_lsp::DocumentDiagnosticReportResult::Report(report) => match report {
                carrot_lsp::DocumentDiagnosticReport::Full(report) => {
                ...
                carrot_lsp::DocumentDiagnosticReport::Unchanged(report) => {
                    if let Some(related_documents) = report.related_documents {
                        process_related_documents(
                            &mut pulled_diagnostics,
                            server_id,
            ...
            carrot_lsp::DocumentDiagnosticReportResult::Partial(report) => {
                if let Some(related_documents) = report.related_documents {
                    process_related_documents(
                        &mut pulled_diagnostics,
                        server_id,
...
impl LspCommand for GetDocumentColor {
    ...
    type LspRequest = carrot_lsp::request::DocumentColor;
    ...
    fn check_capabilities(&self, server_capabilities: AdapterServerCapabilities) -> bool {
        server_capabilities
            ...
            .as_ref()
            .is_some_and(|capability| match capability {
                carrot_lsp::ColorProviderCapability::Simple(supported) => *supported,
                carrot_lsp::ColorProviderCapability::ColorProvider(..) => true,
                carrot_lsp::ColorProviderCapability::Options(..) => true,
            })
    }
    ...
    fn to_lsp(
        ...
        _: &Arc<LanguageServer>,
        _: &App,
    ) -> Result<carrot_lsp::DocumentColorParams> {
        Ok(carrot_lsp::DocumentColorParams {
            text_document: make_text_document_identifier(path)?,
            work_done_progress_params: Default::default(),
            partial_result_params: Default::default(),
        })
    ...
    async fn response_from_lsp(
        self,
        message: Vec<carrot_lsp::ColorInformation>,
        _: Entity<LspStore>,
        _: Entity<Buffer>,
        _: LanguageServerId,
        _: AsyncApp,
        ...
        Ok(message
            ...
            .filter_map(|color| {
                ...
                Some(DocumentColor {
                    resolved: false,
                    color_presentations: Vec::new(),
                    lsp_range: carrot_lsp::Range {
                        start: point_to_lsp(start),
                        end: point_to_lsp(end),
                    },
                    color: carrot_lsp::Color {
                        red: color.red,
                        green: color.green,
                        blue: color.blue,
                        alpha: color.alpha,
...
impl LspCommand for GetFoldingRanges {
    ...
    type LspRequest = carrot_lsp::request::FoldingRangeRequest;
    ...
    fn check_capabilities(&self, server_capabilities: AdapterServerCapabilities) -> bool {
        server_capabilities
            ...
            .as_ref()
            .is_some_and(|capability| match capability {
                carrot_lsp::FoldingRangeProviderCapability::Simple(supported) => *supported,
                carrot_lsp::FoldingRangeProviderCapability::FoldingProvider(..)
                | carrot_lsp::FoldingRangeProviderCapability::Options(..) => true,
            })
    }
    ...
    fn to_lsp(
        ...
        _: &Arc<LanguageServer>,
        _: &App,
    ) -> Result<carrot_lsp::FoldingRangeParams> {
        Ok(carrot_lsp::FoldingRangeParams {
            text_document: make_text_document_identifier(path)?,
            work_done_progress_params: Default::default(),
            partial_result_params: Default::default(),
        })
    ...
    async fn response_from_lsp(
        self,
        message: Option<Vec<carrot_lsp::FoldingRange>>,
        _: Entity<LspStore>,
        buffer: Entity<Buffer>,
        _: LanguageServerId,
        cx: AsyncApp,
...
fn process_related_documents(
    diagnostics: &mut HashMap<carrot_lsp::Uri, LspPullDiagnostics>,
    server_id: LanguageServerId,
    documents: impl IntoIterator<Item = (carrot_lsp::Uri, carrot_lsp::DocumentDiagnosticReportKind)>,
    registration_id: Option<SharedString>,
) {
    for (url, report_kind) in documents {
        match report_kind {
            carrot_lsp::DocumentDiagnosticReportKind::Full(report) => {
                process_full_diagnostics_report(
                    diagnostics,
                    server_id,
                    url,
            ...
            carrot_lsp::DocumentDiagnosticReportKind::Unchanged(report) => {
                process_unchanged_diagnostics_report(
                    diagnostics,
                    server_id,
                    url,
...
fn process_unchanged_diagnostics_report(
    ...
    server_id: LanguageServerId,
    uri: carrot_lsp::Uri,
    report: carrot_lsp::UnchangedDocumentDiagnosticReport,
    registration_id: Option<SharedString>,
) {
...
fn process_full_diagnostics_report(
    ...
    server_id: LanguageServerId,
    uri: carrot_lsp::Uri,
    report: carrot_lsp::FullDocumentDiagnosticReport,
    registration_id: Option<SharedString>,
) {
