...
use inazuma_collections::{BTreeMap, IndexSet};
...
#[async_trait(?Send)]
impl carrot_language::LocalLanguageToolchainStore for LocalStore {
    fn active_toolchain(
        self: Arc<Self>,
...
#[async_trait(?Send)]
impl carrot_language::LanguageToolchainStore for RemoteStore {
...
impl carrot_language::LocalLanguageToolchainStore for EmptyToolchainStore {
    fn active_toolchain(
        self: Arc<Self>,
        _: WorktreeId,
        _: &Arc<RelPath>,
