...
use carrot_lsp::{AdapterServerCapabilities, LanguageServer, LanguageServerId};
use carrot_rpc::proto::{self, PeerId};
use carrot_task::TaskTemplate;
use inazuma::{App, AsyncApp, Entity};
use inazuma_collections::HashMap;
use inazuma_text::{BufferId, PointUtf16, ToPointUtf16};
...
impl carrot_lsp::request::Request for LspExtExpandMacro {
...
pub struct ExpandMacroParams {
    pub text_document: carrot_lsp::TextDocumentIdentifier,
    pub position: carrot_lsp::Position,
}
...
impl carrot_lsp::request::Request for LspOpenDocs {
...
impl LspCommand for OpenDocs {
    ...
    fn to_lsp(
        ...
        let uri = carrot_lsp::Uri::from_file_path(path)
            .map_err(|()| anyhow::anyhow!("{path:?} is not a valid URI"))?;
        Ok(OpenDocsParams {
            text_document: carrot_lsp::TextDocumentIdentifier { uri },
            position: point_to_lsp(self.position),
        })
    }
...
impl carrot_lsp::request::Request for LspSwitchSourceHeader {
...
#[derive(Serialize, Deserialize, Debug)]
#[serde(rename_all = "camelCase")]
pub struct SwitchSourceHeaderParams(carrot_lsp::TextDocumentIdentifier);
...
impl carrot_lsp::request::Request for LspGoToParentModule {
    type Params = carrot_lsp::TextDocumentPositionParams;
    type Result = Option<Vec<carrot_lsp::LocationLink>>;
...
impl LspCommand for GoToParentModule {
    ...
    async fn response_from_lsp(
        self,
        links: Option<Vec<carrot_lsp::LocationLink>>,
        ...
        location_links_from_lsp(
            links.map(carrot_lsp::GotoDefinitionResponse::Link),
            lsp_store,
            buffer,
            server_id,
            cx,
...
impl carrot_lsp::request::Request for Runnables {
...
pub struct RunnablesParams {
    pub text_document: carrot_lsp::TextDocumentIdentifier,
    #[serde(default)]
    pub position: Option<carrot_lsp::Position>,
}
...
pub struct Runnable {
    ...
    pub location: Option<carrot_lsp::LocationLink>,
...
impl LspCommand for GetLspRunnables {
    ...
    fn to_lsp(
        ...
        Ok(RunnablesParams {
            text_document: carrot_lsp::TextDocumentIdentifier::new(url),
            position: self
                .position
...
impl carrot_lsp::notification::Notification for LspExtCancelFlycheck {
    type Params = ();
    const METHOD: &'static str = "rust-analyzer/cancelFlycheck";
}

impl carrot_lsp::notification::Notification for LspExtRunFlycheck {
...
pub struct RunFlycheckParams {
    pub text_document: Option<carrot_lsp::TextDocumentIdentifier>,
}

impl carrot_lsp::notification::Notification for LspExtClearFlycheck {
    type Params = ();
