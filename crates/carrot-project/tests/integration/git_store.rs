mod conflict_set_tests {
    ...
    use carrot_project::git_store::*;
    use inazuma::{BackgroundExecutor, TestAppContext};
    use inazuma_text::{Buffer, BufferId, OffsetRangeExt, Point, ReplicaId, ToOffset as _};
...
mod git_traversal {
    ...
    fn check_git_statuses(
        ...
        worktree_snapshot: &carrot_worktree::Snapshot,
...
mod git_worktrees {
    use carrot_fs::FakeFs;
    use carrot_project::worktrees_directory_for_repo;
    use inazuma::TestAppContext;
    use inazuma_settings_framework::SettingsStore;
    ...
    fn test_validate_worktree_directory() {
        ...
        // Valid: subdirectory
        assert!(worktrees_directory_for_repo(work_dir, ".git/carrot-worktrees").is_ok());
...
mod trust_tests {
    ...
    async fn test_repository_trust_restrict_trust_cycle(cx: &mut TestAppContext) {
        ...
        cx.update(|cx| {
            carrot_project::trusted_worktrees::init(DbTrustedPaths::default(), cx);
        });
...
mod resolve_worktree_tests {
    ...
    fn test_linked_worktree_short_name() {
        let examples = [
            (
                "/home/bob/carrot",
                "/home/bob/worktrees/olivetti/carrot",
                Some("olivetti".into()),
            ),
            (
                "/home/bob/carrot",
            ...
            (
                "/home/bob/carrot",
                "/home/bob/worktrees/carrot/selectric",
                Some("selectric".into()),
            ),
            ("/home/bob/carrot", "/home/bob/carrot", None),
        ];
