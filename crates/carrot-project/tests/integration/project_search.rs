...
use carrot_project::{
    Project, ProjectEntryId, project_search::PathInclusionMatcher, search::SearchQuery,
};
use carrot_worktree::{Entry, EntryKind, WorktreeSettings};
...
#[inazuma::test]
async fn test_path_inclusion_matcher(cx: &mut inazuma::TestAppContext) {
    init_test(cx);
