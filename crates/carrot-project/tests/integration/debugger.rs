mod go_locator {
    use carrot_dap::{DapLocator, adapters::DebugAdapterName};
    use carrot_project::debugger::locators::go::{DelveLaunchRequest, GoLocator};
    use carrot_task::{
        HideStrategy, RevealStrategy, RevealTarget, SaveStrategy, Shell, TaskTemplate,
    };
...
mod python_locator {
    ...
    use carrot_project::debugger::locators::python::*;
    use carrot_task::{DebugScenario, TaskTemplate};
    ...
    async fn test_python_locator() {
        ...
        let build_task = TaskTemplate {
            ...
            use_new_terminal: false,
            allow_concurrent_runs: false,
            reveal: carrot_task::RevealStrategy::Always,
