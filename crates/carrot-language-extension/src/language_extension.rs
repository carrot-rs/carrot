...
use anyhow::Result;
use carrot_extension::{ExtensionGrammarProxy, ExtensionHostProxy, ExtensionLanguageProxy};
use carrot_language::{LanguageMatcher, LanguageName, LanguageRegistry, LoadedLanguage};
use carrot_project::LspStore;
