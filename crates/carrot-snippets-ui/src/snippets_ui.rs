...
use carrot_language::{LanguageMatcher, LanguageName, LanguageRegistry};
use carrot_open_path_prompt::file_finder_settings::FileFinderSettings;
use carrot_paths::snippets_dir;
use carrot_ui::{HighlightedLabel, ListItem, ListItemSpacing, prelude::*};
use carrot_workspace::{
    ModalView, OpenOptions, OpenVisible, Workspace, notifications::NotifyResultExt,
};
use inazuma::{
