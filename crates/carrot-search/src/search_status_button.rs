...
use carrot_ui::{Clickable as _, Context, Render, Tooltip, Window, prelude::*};
use carrot_workspace::{ItemHandle, StatusItemView};
        ...
        button.child(
            IconButton::new("project-search-indicator", SEARCH_ICON)
                ...
                .on_click(cx.listener(|_this, _, window, cx| {
                    window.dispatch_action(Box::new(carrot_workspace::DeploySearch::default()), cx);
                })),
        )
    }
}
