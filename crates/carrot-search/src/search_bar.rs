use carrot_editor::{Editor, EditorElement, EditorStyle, MultiBufferOffset, ToOffset};
use carrot_theme_settings::ThemeSettings;
use carrot_ui::{IconButton, IconButtonShape};
use carrot_ui::{Tooltip, prelude::*};
use inazuma::{Action, App, Entity, FocusHandle, IntoElement, Oklch, TextStyle};
