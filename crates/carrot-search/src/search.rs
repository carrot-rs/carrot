...
pub use carrot_actions::search::ToggleIncludeIgnored;
pub use carrot_editor::HighlightKey;
use carrot_editor::SearchSettings;
use carrot_project::search::SearchQuery;
use carrot_ui::{ButtonStyle, IconButton, IconButtonShape};
use carrot_ui::{Tooltip, prelude::*};
use carrot_workspace::notifications::NotificationId;
use carrot_workspace::{Toast, Workspace};
use inazuma::{Action, App, ClickEvent, FocusHandle, IntoElement, actions};
...
impl SearchOption {
    ...
    pub fn icon(&self) -> carrot_ui::IconName {
        match self {
            SearchOption::WholeWord => carrot_ui::IconName::WholeWord,
            SearchOption::CaseSensitive => carrot_ui::IconName::CaseSensitive,
            SearchOption::IncludeIgnored => carrot_ui::IconName::Sliders,
            SearchOption::Regex => carrot_ui::IconName::Regex,
