...
use carrot_theme::{ActiveTheme, Appearance};
...
impl From<FontStyle> for inazuma::FontStyle {
...
impl StatusColors {
    ...
    pub fn error(&self, cx: &App) -> Oklch {
        self.error.unwrap_or(cx.theme().status().error.color)
    }

    #[inline]
    pub fn error_background(&self, cx: &App) -> Oklch {
        self.error_background
            .unwrap_or(cx.theme().status().error.background)
    }

    #[inline]
    pub fn error_border(&self, cx: &App) -> Oklch {
        self.error_border
            .unwrap_or(cx.theme().status().error.border)
    }

    #[inline]
    pub fn warning(&self, cx: &App) -> Oklch {
        self.warning.unwrap_or(cx.theme().status().warning.color)
    }

    #[inline]
    pub fn warning_background(&self, cx: &App) -> Oklch {
        self.warning_background
            .unwrap_or(cx.theme().status().warning.background)
    }

    #[inline]
    pub fn warning_border(&self, cx: &App) -> Oklch {
        self.warning_border
            .unwrap_or(cx.theme().status().warning.border)
    }

    #[inline]
    pub fn info(&self, cx: &App) -> Oklch {
        self.info.unwrap_or(cx.theme().status().info.color)
    }

    #[inline]
    pub fn info_background(&self, cx: &App) -> Oklch {
        self.info_background
            .unwrap_or(cx.theme().status().info.background)
    }

    #[inline]
    pub fn info_border(&self, cx: &App) -> Oklch {
        self.info_border.unwrap_or(cx.theme().status().info.border)
    }

    #[inline]
    pub fn success(&self, cx: &App) -> Oklch {
        self.success.unwrap_or(cx.theme().status().created.color)
    }

    #[inline]
    pub fn success_background(&self, cx: &App) -> Oklch {
        self.success_background
            .unwrap_or(cx.theme().status().created.background)
    }

    #[inline]
    pub fn success_border(&self, cx: &App) -> Oklch {
        self.success_border
            .unwrap_or(cx.theme().status().created.border)
    }

    #[inline]
    pub fn hint(&self, cx: &App) -> Oklch {
        self.hint.unwrap_or(cx.theme().status().hint.color)
    }

    #[inline]
    pub fn hint_background(&self, cx: &App) -> Oklch {
        self.hint_background
            .unwrap_or(cx.theme().status().hint.background)
    }
...
///
/// This json is compatible with the Carrot theme format.
///
/// https://carrot.dev/docs/extensions/languages#syntax-highlighting
