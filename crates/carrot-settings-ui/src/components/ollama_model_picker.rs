...
use carrot_ui::{ListItem, ListItemSpacing, PopoverMenu, prelude::*};
use inazuma::{AnyElement, App, Context, DismissEvent, ReadGlobal, SharedString, Task, Window, px};
...
impl OllamaModelPickerDelegate {
    fn new(
        ...
        let mut models = carrot_edit_prediction::ollama::fetch_models(cx);
                    ...
                    move |model_name, window, cx| {
                        update_settings_file(
                            ...
                            move |settings, _cx| {
                                (field.write)(
                                    settings,
                                    Some(inazuma_settings_framework::OllamaModelName(
