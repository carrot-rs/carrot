...
use carrot_ui::{Tooltip, prelude::*, rems};
use inazuma::{AnyElement, ElementId, Focusable, TextStyleRefinement};
...
impl RenderOnce for SettingsInputField {
    fn render(self, window: &mut Window, cx: &mut App) -> impl carrot_ui::IntoElement {
        ...
        h_flex()
            ...
            .when_some(self.confirm, |this, confirm| {
                this.on_action::<inazuma_menu::Confirm>({
                    move |_, window, cx| {
