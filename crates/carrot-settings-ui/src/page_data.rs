...
use carrot_ui::IntoElement;
use inazuma::{Action as _, App};
    ...
    fn security_section() -> [SettingsPageItem; 2] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                description: "When opening Carrot, avoid Restricted Mode by auto-trusting all projects, enabling use of all features without having to give permission to each new project.",
                field: Box::new(SettingField {
    ...
    fn workspace_restoration_section() -> [SettingsPageItem; 3] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                description: "What to restore from the previous session when opening Carrot.",
                field: Box::new(SettingField {
    ...
    fn scoped_settings_section() -> [SettingsPageItem; 3] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                description: "Which settings should be activated only in Preview build of Carrot.",
                field: Box::new(
                    SettingField {
    ...
    fn privacy_section() -> [SettingsPageItem; 3] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                description: "Send anonymized usage data like what languages you're using Carrot with.",
                field: Box::new(SettingField {
...
fn appearance_page() -> SettingsPage {
        ...
        [
                                ...
                                inazuma_settings_framework::ThemeSelectionDiscriminants::Static => {
                                    let name = match settings_value {
                                        ...
                                        inazuma_settings_framework::ThemeSelection::Dynamic { mode, light, dark } => {
                                            match mode {
                                                carrot_theme_settings::ThemeAppearanceMode::Light => light.clone(),
                                                carrot_theme_settings::ThemeAppearanceMode::Dark => dark.clone(),
                                                carrot_theme_settings::ThemeAppearanceMode::System => dark.clone(), // no cx, can't determine correct choice
                                            }
                                        },
                                    };
            ...
            SettingsPageItem::DynamicItem(DynamicItem {
                discriminant: SettingItem {
                    files: USER,
                    title: "Icon Theme",
                    description: "The custom set of icons Carrot will associate with files and directories.",
                    field: Box::new(SettingField {
                        ...
                        write: |settings_content, value| {
                            ...
                            let settings_value = settings_content.theme.icon_theme.get_or_insert_with(|| {
                                inazuma_settings_framework::IconThemeSelection::Static(inazuma_settings_framework::IconThemeName(carrot_theme::icon_theme::default_icon_theme().name.clone().into()))
                            });
                            *settings_value = match value {
                        ...
                        write: |settings_content, value| {
                            ...
                            *settings_value = match value {
                                ...
                                inazuma_settings_framework::BufferLineHeightDiscriminants::Custom => {
                                    let custom_value =
                                        carrot_theme_settings::BufferLineHeight::from(*settings_value)
                                            .value();
    ...
    fn tabs_section() -> [SettingsPageItem; 8] {
        [
            SettingsPageItem::SectionHeader("Tabs"),
            SettingsPageItem::SettingItem(SettingItem {
                title: "View as",
                description: "Whether each split pane gets its own row, or \
                              only the focused pane per tab is listed.",
                field: Box::new(SettingField {
                    json_path: Some("view_mode"),
                    pick: |settings_content| {
                        settings_content
                            .vertical_tabs
                            .as_ref()
                            .and_then(|v| v.view_mode.as_ref())
                    },
                    write: |settings_content, value| {
                        settings_content
                            .vertical_tabs
            ...
            SettingsPageItem::SettingItem(SettingItem {
                title: "Density",
                description: "Compact rows show a single line; expanded rows \
                              add a description and a metadata badges row.",
                field: Box::new(SettingField {
                    json_path: Some("density"),
                    pick: |settings_content| {
                        settings_content
                            .vertical_tabs
                            .as_ref()
                            .and_then(|v| v.density.as_ref())
                    },
                    write: |settings_content, value| {
                        settings_content
                            .vertical_tabs
            ...
            SettingsPageItem::SettingItem(SettingItem {
                title: "Pane title as",
                description: "Source for the primary title text on each row: \
                              last command, working directory, or git branch.",
                field: Box::new(SettingField {
                    json_path: Some("pane_title"),
                    pick: |settings_content| {
                        settings_content
                            .vertical_tabs
                            .as_ref()
                            .and_then(|v| v.pane_title.as_ref())
                    },
                    write: |settings_content, value| {
                        settings_content
                            .vertical_tabs
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                description: "Compact-mode subtitle: branch, working directory, \
                              or last command / conversation.",
                field: Box::new(SettingField {
                    json_path: Some("additional_metadata"),
                    pick: |settings_content| {
                        settings_content
                            .vertical_tabs
                            .as_ref()
                            .and_then(|v| v.additional_metadata.as_ref())
                    },
                    write: |settings_content, value| {
                        settings_content
                            .vertical_tabs
            ...
            SettingsPageItem::SettingItem(SettingItem {
                title: "Show PR link",
                description: "In expanded mode, resolve the current branch's \
                              GitHub PR via the gh CLI and render a badge.",
                field: Box::new(SettingField {
                    json_path: Some("show_pr_link"),
                    pick: |settings_content| {
                        settings_content
                            .vertical_tabs
                            .as_ref()
                            .and_then(|v| v.show_pr_link.as_ref())
                    },
                    write: |settings_content, value| {
                        settings_content
                            .vertical_tabs
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                description: "In expanded mode, render a `+N -M` badge from \
                              the shell's live git diff stats.",
                field: Box::new(SettingField {
                    json_path: Some("show_diff_stats"),
                    pick: |settings_content| {
                        settings_content
                            .vertical_tabs
                            .as_ref()
                            .and_then(|v| v.show_diff_stats.as_ref())
                    },
                    write: |settings_content, value| {
                        settings_content
                            .vertical_tabs
                            .get_or_insert_default()
                            .show_diff_stats = value;
                    },
                }),
                metadata: None,
                files: USER,
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                description: "Display a floating detail sidecar beside a tab \
                              row while the cursor is over it.",
                field: Box::new(SettingField {
                    json_path: Some("show_details_on_hover"),
                    pick: |settings_content| {
                        settings_content
                            .vertical_tabs
                            .as_ref()
                            .and_then(|v| v.show_details_on_hover.as_ref())
                    },
                    write: |settings_content, value| {
                        settings_content
                            .vertical_tabs
                            .get_or_insert_default()
                            .show_details_on_hover = value;
                    },
                }),
                metadata: None,
                files: USER,
                ...
                on_click: Arc::new(|settings_window, window, cx| {
                    ...
                    original_window
                        .update(cx, |_workspace, original_window, cx| {
                            original_window
                                .dispatch_action(carrot_actions::OpenKeymap.boxed_clone(), cx);
    ...
    fn file_scan_section() -> [SettingsPageItem; 5] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                description: "Files or globs of files that will be excluded by Carrot entirely. They will be skipped during file scans, file searches, and not be displayed in the project file tree. Takes precedence over \"File Scan Inclusions\"",
                field: Box::new(
                    SettingField {
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                description: "Files or globs of files that will be included by Carrot, even when ignored by git. This is useful for files that are not tracked by git, but are still important to your project. Note that globs that are overly broad can slow down Carrot's file scanning. \"File Scan Exclusions\" takes precedence over these inclusions",
                field: Box::new(
                    SettingField {
    ...
    fn window_section() -> [SettingsPageItem; 3] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                description: "(Linux only) whether Carrot or your compositor should draw window decorations.",
                field: Box::new(SettingField {
    ...
    fn general_section() -> [SettingsPageItem; 6] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                description: "Whether breakpoints should be reused across Carrot sessions.",
                field: Box::new(SettingField {
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                description: "Whether to log messages between active debug adapters and Carrot.",
                field: Box::new(SettingField {
        ...
        [
            ...
            SettingsPageItem::DynamicItem(DynamicItem {
                discriminant: SettingItem {
                    ...
                    description: "Disable all Git integration features in Carrot.",
...
fn ai_page(cx: &App) -> SettingsPage {
    fn general_section() -> [SettingsPageItem; 2] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                title: "Disable AI",
                description: "Whether to disable all AI features in Carrot.",
                field: Box::new(SettingField {
...
fn network_page() -> SettingsPage {
    fn network_section() -> [SettingsPageItem; 3] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                title: "Server URL",
                description: "The URL of the Carrot server to connect to.",
                field: Box::new(SettingField {
                ...
                metadata: Some(Box::new(SettingsFieldMetadata {
                    placeholder: Some("https://carrot.dev"),
                    ..Default::default()
                })),
                files: USER,
            }),
...
fn language_settings_data() -> Box<[SettingsPageItem]> {
    ...
    fn autoclose_section() -> [SettingsPageItem; 5] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                title: "Use Autoclose",
                description: "Whether to automatically type closing characters for you. For example, when you type '(', Carrot will automatically add a closing ')' at the correct position.",
                field: Box::new(SettingField {
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                description: "Whether to automatically surround text with characters for you. For example, when you select text and type '(', Carrot will automatically surround text with ().",
                field: Box::new(SettingField {
    ...
    fn tasks_section() -> [SettingsPageItem; 4] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                title: "Prefer LSP",
                description: "Use LSP tasks over Carrot language extension tasks.",
                field: Box::new(SettingField {
...
fn edit_prediction_language_settings_section() -> [SettingsPageItem; 4] {
    [
        ...
        SettingsPageItem::SubPageLink(SubPageLink {
            ...
            description: Some("Set up different edit prediction providers in complement to Carrot's built-in Zeta model.".into()),
            in_json: false,
            files: USER,
