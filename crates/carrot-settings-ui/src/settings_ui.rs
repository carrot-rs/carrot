...
use carrot_editor::{Editor, EditorEvent};
...
use inazuma::{
    ...
    WindowBounds, WindowOptions, actions, div, list, point, prelude::*, px, uniform_list,
};
use inazuma_fuzzy::StringMatchCandidate;

use carrot_language::Buffer;
use carrot_platform_title_bar::PlatformTitleBar;
use carrot_project::{Project, ProjectPath, Worktree, WorktreeId};
...
use carrot_actions::{OpenProjectSettings, OpenSettings, OpenSettingsAt};
use carrot_workspace::{OpenOptions, OpenVisible, Workspace, client_side_decorations};
...
trait AnySettingField {
    ...
    fn file_set_in(
        ...
        file: SettingsUiFile,
        cx: &App,
    ) -> (inazuma_settings_framework::SettingsFile, bool);
    fn reset_to_default_fn(
        &self,
        current_file: &SettingsUiFile,
        file_set_in: &inazuma_settings_framework::SettingsFile,
        cx: &App,
...
impl<T: PartialEq + Clone + Send + Sync + 'static> AnySettingField for SettingField<T> {
    ...
    fn reset_to_default_fn(
        ...
        if file_set_in == &inazuma_settings_framework::SettingsFile::Default {
            return None;
        }
        ...
        return Some(Box::new(move |window, cx| {
            ...
            let is_set_somewhere_other_than_default = store
                ...
                .0
                != inazuma_settings_framework::SettingsFile::Default;
...
pub fn init(cx: &mut App) {
    ...
    cx.observe_new(|workspace: &mut carrot_workspace::Workspace, _, _| {
        workspace
...
fn init_renderers(cx: &mut App) {
    cx.default_global::<SettingFieldRenderer>()
        ...
        .add_basic_renderer::<inazuma_settings_framework::SaturatingBool>(render_toggle_button)
        .add_basic_renderer::<inazuma_settings_framework::CursorShape>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::RestoreOnStartupBehavior>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::BottomDockLayout>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::OnLastWindowClosed>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::CloseWindowWhenNoItems>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::TextRenderingMode>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::FontFamilyName>(render_font_picker)
        .add_basic_renderer::<inazuma_settings_framework::BaseKeymapContent>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::MultiCursorModifier>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::HideMouseMode>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::CurrentLineHighlight>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::ShowWhitespaceSetting>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::SoftWrap>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::AutoIndentMode>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::ScrollBeyondLastLine>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::SnippetSortOrder>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::ClosePosition>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::DockSide>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::TerminalDockPosition>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::DockPosition>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::VerticalTabsDensity>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::VerticalTabsViewMode>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::PaneTitleSource>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::AdditionalMetadata>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::GitGutterSetting>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::GitHunkStyleSetting>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::GitPathStyle>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::DiagnosticSeverityContent>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::SeedQuerySetting>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::DoubleClickInMultibuffer>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::GoToDefinitionFallback>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::ActivateOnClose>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::ShowDiagnostics>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::ShowCloseButton>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::ProjectPanelEntrySpacing>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::ProjectPanelSortMode>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::RewrapBehavior>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::FormatOnSave>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::IndentGuideColoring>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::IndentGuideBackgroundColoring>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::FileFinderWidthContent>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::ShowDiagnostics>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::WordsCompletionMode>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::LspInsertMode>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::CompletionDetailAlignment>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::DiffViewStyle>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::AlternateScroll>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::TerminalBlink>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::CursorShapeContent>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::EditPredictionPromptFormat>(render_dropdown)
        ...
        .add_basic_renderer::<inazuma_settings_framework::CodeFade>(render_number_field)
        .add_basic_renderer::<inazuma_settings_framework::DelayMs>(render_number_field)
        .add_basic_renderer::<inazuma_settings_framework::FontWeightContent>(render_number_field)
        .add_basic_renderer::<inazuma_settings_framework::CenteredPaddingSettings>(render_number_field)
        .add_basic_renderer::<inazuma_settings_framework::InactiveOpacity>(render_number_field)
        .add_basic_renderer::<inazuma_settings_framework::MinimumContrast>(render_number_field)
        .add_basic_renderer::<inazuma_settings_framework::ShowScrollbar>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::ScrollbarDiagnostics>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::ShowMinimap>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::DisplayIn>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::MinimapThumb>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::MinimapThumbBorder>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::ModeContent>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::UseSystemClipboard>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::VimInsertModeCursorShape>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::SteppingGranularity>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::NotifyWhenAgentWaiting>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::NewThreadLocation>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::ImageFileSizeUnit>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::StatusStyle>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::EncodingDisplayOptions>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::PaneSplitDirectionHorizontal>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::PaneSplitDirectionVertical>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::PaneSplitDirectionVertical>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::DocumentColorsRenderMode>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::ThemeSelectionDiscriminants>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::ThemeAppearanceMode>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::ThemeName>(render_theme_picker)
        .add_basic_renderer::<inazuma_settings_framework::IconThemeSelectionDiscriminants>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::IconThemeName>(render_icon_theme_picker)
        .add_basic_renderer::<inazuma_settings_framework::BufferLineHeightDiscriminants>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::AutosaveSettingDiscriminants>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::WorkingDirectoryDiscriminants>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::IncludeIgnoredContent>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::ShowIndentGuides>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::ShellDiscriminants>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::EditPredictionsMode>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::RelativeLineNumbers>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::WindowDecorations>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::WindowButtonLayoutContentDiscriminants>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::FontSize>(render_editable_number_field)
        .add_basic_renderer::<inazuma_settings_framework::OllamaModelName>(render_ollama_model_picker)
        .add_basic_renderer::<inazuma_settings_framework::SemanticTokens>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::DocumentFoldingRanges>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::DocumentSymbols>(render_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::AudioInputDeviceName>(render_input_audio_device_dropdown)
        .add_basic_renderer::<inazuma_settings_framework::AudioOutputDeviceName>(render_output_audio_device_dropdown)
...
pub fn open_settings_editor(
    ...
    carrot_telemetry::event!("Settings Viewed");
    ...
    cx.defer(move |cx| {
        let current_rem_size: f32 = carrot_theme_settings::ThemeSettings::get_global(cx)
            .ui_font_size(cx)
            .into();
        ...
        cx.open_window(
            WindowOptions {
                titlebar: Some(TitlebarOptions {
                    title: Some("Carrot — Settings".into()),
                ...
                show: true,
                is_movable: true,
                kind: inazuma::WindowKind::Normal,
...
pub struct SettingsWindow {
    ...
    navbar_focus_subscriptions: Vec<inazuma::Subscription>,
             ...
             cx: &mut Context<SettingsWindow>| {
                ...
                let field = match field_renderer_or_warning {
                    ...
                    Err(warning) => render_settings_item(
                        ...
                        file.clone(),
                        <Button as ButtonCommon>::size(
                            Button::new("error-warning", warning).style(ButtonStyle::Outlined),
                            ButtonSize::Medium,
                        )
...
fn render_settings_item_link(
    ...
    let clipboard_has_link = cx
        ...
        .map_or(false, |maybe_url| {
            json_path.is_some() && maybe_url.strip_prefix("carrot://settings/") == json_path
        });
            ...
            IconButton::new((id.into(), "copy-link-btn"), link_icon)
                ...
                .when_some(json_path, |this, path| {
                    this.on_click(cx.listener(move |_, _, _, cx| {
                        let link = format!("carrot://settings/{}", path);
...
fn all_language_names(cx: &App) -> Vec<SharedString> {
    carrot_workspace::AppState::global(cx)
        .upgrade()
        .map_or(vec![], |state| {
            state
                .languages
                .language_names()
                .into_iter()
                .filter(|name| name.as_ref() != "Carrot Keybind Context")
                .map(Into::into)
                .collect()
        })
}
...
impl SettingsUiFile {
    ...
    fn from_settings(file: inazuma_settings_framework::SettingsFile) -> Option<Self> {
        Some(match file {
            inazuma_settings_framework::SettingsFile::User => SettingsUiFile::User,
            inazuma_settings_framework::SettingsFile::Project(location) => {
                SettingsUiFile::Project(location)
            }
            inazuma_settings_framework::SettingsFile::Server => {
                SettingsUiFile::Server("todo: server name")
            }
            inazuma_settings_framework::SettingsFile::Default => return None,
            inazuma_settings_framework::SettingsFile::Global => return None,
        })
    }

    fn to_settings(&self) -> inazuma_settings_framework::SettingsFile {
        match self {
            SettingsUiFile::User => inazuma_settings_framework::SettingsFile::User,
            SettingsUiFile::Project(location) => {
                inazuma_settings_framework::SettingsFile::Project(location.clone())
            }
            SettingsUiFile::Server(_) => inazuma_settings_framework::SettingsFile::Server,
        }
    }
...
impl SettingsWindow {
    fn new(
        ...
        cx.on_window_closed(|cx: &mut App| {
                ...
                && cx.windows().len() == 1
            {
                ...
                carrot_telemetry::event!("Settings Closed")
            }
        })
        .detach();

        // Carrot has a single workspace — project observation is handled
        ...
        let list_state =
            inazuma::ListState::new(0, inazuma::ListAlignment::Top, px(0.0)).measure_all();
    ...
    fn handle_project_event(
        ...
        match event {
            carrot_project::Event::WorktreeRemoved(_) | carrot_project::Event::WorktreeAdded(_) => {
    ...
    fn update_matches(&mut self, cx: &mut Context<SettingsWindow>) {
        ...
        self.search_task = Some(cx.spawn(async move |this, cx| {
            ...
            carrot_telemetry::event!("Settings Searched", query = query)
        }));
    }
    ...
    fn fetch_files(&mut self, window: &mut Window, cx: &mut Context<SettingsWindow>) {
        ...
        if !all_files.contains(&inazuma_settings_framework::SettingsFile::User) {
            all_files.push(inazuma_settings_framework::SettingsFile::User);
        }
    ...
    fn change_file(&mut self, ix: usize, window: &mut Window, cx: &mut Context<SettingsWindow>) {
        ...
        if let SettingsUiFile::Project((_, _)) = &self.current_file {
            carrot_telemetry::event!("Setting Project Clicked");
        }
        ...
        let file_button =
            |ix, file: &SettingsUiFile, focus_handle, cx: &mut Context<SettingsWindow>| {
                <Button as ButtonCommon>::track_focus(
                    ...
                    .selected_style(ButtonStyle::tinted(carrot_ui::TintColor::Accent)),
                    focus_handle,
                )
    ...
    //             .map(|directory_name| {
    //                 let path_style = PathStyle::local();
    //                 let file_path = path.join(carrot_paths::local_settings_file_relative_path());
    //                 format!(
    //                     "{}{}{}",
    //                     directory_name,
        ...
        v_flex()
            ...
            .on_action(cx.listener(|this, _: &FocusNextNavEntry, window, cx| {
                ...
                this.open_and_scroll_to_navbar_entry(
                    next_entry_index,
                    Some(inazuma::ScrollStrategy::Bottom),
                    false,
                    window,
                    cx,
                );
            ...
            .on_action(cx.listener(|this, _: &FocusPreviousNavEntry, window, cx| {
                ...
                this.open_and_scroll_to_navbar_entry(
                    prev_entry_index,
                    Some(inazuma::ScrollStrategy::Top),
                    false,
                    window,
                    cx,
                );
    ...
    fn open_and_scroll_to_navbar_entry(
        ...
        scroll_strategy: Option<inazuma::ScrollStrategy>,
        focus_content: bool,
        window: &mut Window,
        cx: &mut Context<Self>,
    ) {
    ...
    fn scroll_to_content_item(
        ...
        if index == 0 {
            ...
            self.list_state.scroll_to(inazuma::ListOffset {
                item_ix: 0,
                offset_in_item: px(0.),
            });
            return;
    ...
    fn focus_and_scroll_to_nav_entry(
        ...
        self.navbar_scroll_handle
            .scroll_to_item(position, inazuma::ScrollStrategy::Top);
            ...
            let list_content = list(
                ...
                cx.processor(move |this, index, window, cx| {
                    ...
                    let Some((actual_item_index, item)) = visible_items.nth(index - 1) else {
                        return inazuma::Empty.into_any_element();
                    };
    ...
    fn render_page(
        ...
        let mut warning_banner = inazuma::Empty.into_any_element();
        if let Some(error) =
            SettingsStore::global(cx).error_for_file(self.current_file.to_settings())
        {
            fn banner(
                ...
                if shown_errors.insert(error.clone()) {
                    carrot_telemetry::event!("Settings Error Shown", label = label, error = &error);
                }
                Banner::new()
                    ...
                    .action_slot(
                        div().pr_1().pb_1().child(
                            Button::new("fix-in-json", "Fix in settings.toml")
                                .style(ButtonStyle::tinted(carrot_ui::TintColor::Warning))
                                .on_click(cx.listener(|this, _, window, cx| {
                                    this.open_current_settings_file(window, cx);
                                })),
                        ),
        ...
        v_flex()
            .id("settings-ui-page")
            .on_action(
                cx.listener(|this, _: &inazuma_menu::SelectNext, window, cx| {
                    ...
                    for (logical_index, (actual_index, _)) in this.visible_page_items().enumerate()
                    {
                        ...
                        if let Some((_, next_item)) =
                            this.visible_page_items().nth(logical_index + 1)
                            && matches!(next_item, SettingsPageItem::SectionHeader(_))
                        {
                            offset += 1;
                        }
            ...
            .on_action(
                cx.listener(|this, _: &inazuma_menu::SelectPrevious, window, cx| {
                    if !this.sub_page_stack.is_empty() {
                        window.focus_prev(cx);
                        return;
                    }
                    let mut prev_was_header = false;
                    for (logical_index, (actual_index, item)) in
                        this.visible_page_items().enumerate()
                    {
            ...
            .when_some(current_sub_page, |this, current_sub_page| {
                this.custom_scrollbars(
                    Scrollbars::new(carrot_ui::ScrollAxes::Vertical)
    ...
    fn open_current_settings_file(&mut self, window: &mut Window, cx: &mut Context<Self>) {
        match &self.current_file {
            ...
            SettingsUiFile::Project((worktree_id, path)) => {
                let settings_path = path.join(carrot_paths::local_settings_file_relative_path());

                let Some((workspace_window, worktree, corresponding_workspace)) = cx
                    .windows()
                    .into_iter()
                    .filter_map(|window_handle| {
                        let workspace = carrot_workspace::workspace_for_window(window_handle, cx)?;
                ...
                // TODO: move carrot::open_local_file() APIs to this crate, and
                ...
                .child(
                    div()
                        ...
                        .on_action(cx.listener(
                            |this, _: &carrot_search::FocusSearch, window, cx| {
...
fn all_projects(
    ...
    let projects: Vec<Entity<Project>> = cx
        ...
        .into_iter()
        .filter_map(|wh| {
            let workspace = carrot_workspace::workspace_for_window(wh, cx)?;
...
fn open_user_settings_in_workspace(
    ...
    cx.spawn_in(window, async move |workspace, cx| {
        let (config_dir, settings_file) = project.update(cx, |project, cx| {
            (
                project.try_windows_path_to_wsl(carrot_paths::config_dir().as_path(), cx),
                project.try_windows_path_to_wsl(carrot_paths::settings_file().as_path(), cx),
            )
        });
...
fn update_settings_file(
    ...
    carrot_telemetry::event!("Settings Change", setting = file_name, type = file.setting_type());

    match file {
        SettingsUiFile::Project((worktree_id, rel_path)) => {
            let rel_path = rel_path.join(carrot_paths::local_settings_file_relative_path());
        ...
        SettingsUiFile::User => {
            ...
            SettingsStore::global(cx).update_settings_file(<dyn carrot_fs::Fs>::global(cx), update);
            Ok(())
        }
    ...
    Switch::new("toggle_button")
        ...
        .on_click({
            move |state: &bool, window, cx| {
                carrot_telemetry::event!("Settings Change", setting = field.json_path, type = file.setting_type());
...
fn render_font_picker(
    field: SettingField<inazuma_settings_framework::FontFamilyName>,
    file: SettingsUiFile,
    _metadata: Option<&SettingsFieldMetadata>,
    _window: &mut Window,
    cx: &mut App,
    ...
    let current_value = SettingsStore::global(cx)
        ...
        .map_or_else(
            ...
            |value| SharedString::from(value.0.clone()),
        );
    ...
    PopoverMenu::new("font-picker")
        ...
        .with_handle(carrot_ui::PopoverMenuHandle::default())
        .into_any_element()
}

fn render_theme_picker(
    field: SettingField<inazuma_settings_framework::ThemeName>,
    file: SettingsUiFile,
    _metadata: Option<&SettingsFieldMetadata>,
    _window: &mut Window,
    cx: &mut App,
                    ...
                    move |theme_name, window, cx| {
                        update_settings_file(
                            ...
                            move |settings, _cx| {
                                (field.write)(
                                    settings,
                                    Some(inazuma_settings_framework::ThemeName(theme_name.into())),
                                );
                            },
                        )
                        .log_err(); // todo(settings_ui) don't log err
...
fn render_icon_theme_picker(
    field: SettingField<inazuma_settings_framework::IconThemeName>,
    file: SettingsUiFile,
    _metadata: Option<&SettingsFieldMetadata>,
    _window: &mut Window,
    cx: &mut App,
                    ...
                    move |theme_name, window, cx| {
                        update_settings_file(
                            ...
                            move |settings, _cx| {
                                (field.write)(
                                    settings,
                                    Some(inazuma_settings_framework::IconThemeName(
                                        theme_name.into(),
                                    )),
                                );
                            },
...
pub mod test {
    ...
    impl SettingsWindow {
        ...
        pub fn test(window: &mut Window, cx: &mut Context<Self>) -> Self {
            ...
            Self {
                ...
                search_index: None,
                list_state: ListState::new(0, inazuma::ListAlignment::Top, px(0.0)),
                shown_errors: HashSet::default(),
                regex_validation_error: None,
            }
        }
    ...
    macro_rules! check_navbar_toggle {
        ($name:ident, before: $before:expr, toggle_page: $toggle_page:expr, after: $after:expr) => {
            #[inazuma::test]
            fn $name(cx: &mut inazuma::TestAppContext) {
    ...
    async fn test_settings_window_shows_worktrees_from_multiple_workspaces(
        ...
        let app_state = cx.update(|cx| {
            let app_state = carrot_workspace::AppState::test(cx);
            carrot_workspace::AppState::set_global(Arc::downgrade(&app_state), cx);
            app_state
        });
...
mod project_settings_update_tests {
    ...
    async fn init_test(cx: &mut TestAppContext, initial_settings: Option<&str>) -> TestSetup {
        ...
        let rel_path: Arc<RelPath> = RelPath::unix(".carrot/settings.toml")
            .expect("valid path")
            .into_arc();
        let project_path = ProjectPath {
            worktree_id,
    ...
    async fn test_handles_dropped_worktree(cx: &mut TestAppContext) {
        ...
        let file_content = setup
            .fs
            .load("/project/.carrot/settings.toml".as_ref())
            .await
            .unwrap();
        assert_eq!(
            file_content, "{}",
