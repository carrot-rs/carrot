use carrot_audio::{AudioDeviceInfo, AvailableAudioDevices};
use carrot_ui::{ContextMenu, DropdownMenu, DropdownStyle, IconPosition, IntoElement};
use cpal::DeviceId;
use inazuma::{AnyElement, App, ElementId, ReadGlobal, SharedString, Window};
use inazuma_settings_framework::{AudioInputDeviceName, AudioOutputDeviceName, SettingsStore};
...
{
    carrot_audio::ensure_devices_initialized(cx);
