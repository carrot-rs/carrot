...
use anyhow::Result;
use carrot_language::CodeLabelBuilder;
use carrot_language::HighlightId;
use carrot_language::{BufferSnapshot, CodeLabel, LspAdapterDelegate, OffsetRangeExt};
pub use carrot_language_model::Role;
use carrot_ui::ActiveTheme;
use carrot_ui::IconName;
use carrot_workspace::Workspace;
use futures::StreamExt;
use futures::stream::{self, BoxStream};
use inazuma::{App, SharedString, Task, WeakEntity, Window};
...
pub trait SlashCommand: 'static + Send + Sync {
    ...
    fn run(
        self: Arc<Self>,
        arguments: &[String],
        context_slash_command_output_sections: &[SlashCommandOutputSection<
...
impl SlashCommandOutputSection<carrot_language::Anchor> {
