...
use carrot_extension::{
    Extension, ExtensionHostProxy, ExtensionSlashCommandProxy, WorktreeDelegate,
};
use carrot_language::{BufferSnapshot, LspAdapterDelegate};
use carrot_ui::prelude::*;
use carrot_workspace::Workspace;
use inazuma::{App, Task, WeakEntity, Window};
...
impl ExtensionSlashCommandProxy for SlashCommandRegistryProxy {
    fn register_slash_command(
        ...
        command: carrot_extension::SlashCommand,
    ) {
...
impl ExtensionSlashCommand {
    pub fn new(extension: Arc<dyn Extension>, command: carrot_extension::SlashCommand) -> Self {
