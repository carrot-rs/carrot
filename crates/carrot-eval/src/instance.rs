...
use carrot_client::proto::LspWorkProgress;
use futures::channel::mpsc;
use futures::future::Shared;
use futures::{FutureExt as _, StreamExt as _, future};
use inazuma::{App, AppContext as _, AsyncApp, Entity, Task};
use handlebars::Handlebars;
use carrot_language::{Buffer, DiagnosticSeverity, OffsetRangeExt as _};
...
use carrot_project::{DiagnosticSummary, Project, ProjectPath, lsp_store::OpenLspBufferHandle};
...
use inazuma_util::{ResultExt as _, command::new_command, markdown::MarkdownCodeBlock};
...
pub const ZED_REPO_URL: &str = "https://github.com/carrot-rs/carrot.git";
...
impl ExampleInstance {
    ...
    pub fn run(&self, app_state: Arc<AgentAppState>, cx: &mut App) -> Task<Result<RunOutput>> {
        ...
        cx.spawn(async move |cx| {
            ...
            // Write an empty "last.diff" so that it can be opened in Carrot for convenient view of the
