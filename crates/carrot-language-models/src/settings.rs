...
use crate::provider::{
    anthropic::AnthropicSettings, bedrock::AmazonBedrockSettings, cloud::CarrotDotDevSettings,
...
pub struct AllLanguageModelSettings {
    ...
    pub carrot_dot_dev: CarrotDotDevSettings,
}
...
impl inazuma_settings_framework::Settings for AllLanguageModelSettings {
    ...
    fn from_settings(content: &inazuma_settings_framework::SettingsContent) -> Self {
        ...
        let carrot_dot_dev = language_models.carrot_dot_dev.unwrap();
        Self {
            ...
            carrot_dot_dev: CarrotDotDevSettings {
                available_models: carrot_dot_dev.available_models.unwrap_or_default(),
            },
        }
    }
}
