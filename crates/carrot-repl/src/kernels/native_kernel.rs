...
use inazuma::{App, Entity, EntityId, Task, Window};
    ...
    pub fn new<S: KernelSession + 'static>(
        ...
        window.spawn(cx, async move |cx| {
            ...
            let connection_info = ConnectionInfo {
                ...
                kernel_name: Some(format!("carrot-{}", kernel_specification.name)),
            };
            ...
            let connection_path = runtime_dir.join(format!("kernel-carrot-{entity_id}.json"));
