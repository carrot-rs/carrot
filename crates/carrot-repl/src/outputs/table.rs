...
//!
//! This module provides functionality to render tabular data in Carrot's REPL output.
//!
...
//! display(df)
//! ```
use inazuma::{AnyElement, ClipboardItem, TextRun};
...
use carrot_ui::{IntoElement, Styled, div, prelude::*, v_flex};
