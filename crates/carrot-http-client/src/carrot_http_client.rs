...
impl HttpClientWithUrl {
    ...
    /// Builds a Carrot API URL using the given path.
    pub fn build_carrot_api_url(&self, path: &str, query: &[(&str, &str)]) -> Result<Url> {
        let base_url = self.base_url();
        let base_api_url = match base_url.as_ref() {
            "https://carrot.dev" => "https://api.carrot.dev",
            "https://staging.carrot.dev" => "https://api-staging.carrot.dev",
    ...
    /// Builds a Carrot Cloud URL using the given path.
    pub fn build_carrot_cloud_url(&self, path: &str) -> Result<Url> {
        let base_url = self.base_url();
        let base_api_url = match base_url.as_ref() {
            "https://carrot.dev" => "https://cloud.carrot.dev",
            "https://staging.carrot.dev" => "https://cloud.carrot.dev",
    ...
    /// Builds a Carrot Cloud URL using the given path and query params.
    pub fn build_carrot_cloud_url_with_query(
        &self,
        path: &str,
    ...
    /// Builds a Carrot LLM URL using the given path.
    pub fn build_carrot_llm_url(&self, path: &str, query: &[(&str, &str)]) -> Result<Url> {
        let base_url = self.base_url();
        let base_api_url = match base_url.as_ref() {
            "https://carrot.dev" => "https://cloud.carrot.dev",
            "https://staging.carrot.dev" => "https://llm-staging.carrot.dev",
            "http://localhost:3000" => "http://localhost:8787",
            other => other,
        };
