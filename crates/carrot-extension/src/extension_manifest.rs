...
use inazuma_collections::{BTreeMap, BTreeSet, HashMap};
use semver::Version;
...
pub struct AgentServerManifestEntry {
    ...
    /// use Carrot's managed Node.js runtime instead of relying on the user's PATH:
    /// ```toml
...
impl TargetConfig {
    pub fn from_proto(proto: carrot_proto::ExternalExtensionAgentTarget) -> Self {
        Self {
    ...
    pub fn to_proto(&self) -> carrot_proto::ExternalExtensionAgentTarget {
        carrot_proto::ExternalExtensionAgentTarget {
...
pub struct LanguageServerManifestEntry {
    ...
    #[serde(default)]
    pub code_action_kinds: Option<Vec<carrot_lsp::CodeActionKind>>,
}
