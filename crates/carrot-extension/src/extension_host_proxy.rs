...
use anyhow::Result;
use carrot_fs::Fs;
use carrot_language::{BinaryStatus, LanguageMatcher, LanguageName, LoadedLanguage};
use carrot_lsp::LanguageServerName;
use inazuma::{App, Global, ReadGlobal, SharedString, Task};
...
impl ExtensionLanguageProxy for ExtensionHostProxy {
    #[carrot_tracing::instrument(skip_all, fields(lang = language.0.as_str()))]
    fn register_language(
        &self,
        language: LanguageName,
        grammar: Option<Arc<str>>,
