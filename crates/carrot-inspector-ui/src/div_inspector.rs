...
use carrot_ui::{Label, LabelSize, Tooltip, prelude::*, styled_ext_reflection, v_flex};
use inazuma::{
...
use inazuma_util::split_str_with_ranges;
...
const CARROT_INSPECTOR_STYLE_JSON: &str =
    inazuma_util_macros::path!("/carrot-inspector-style.json");
        ...
        cx.spawn_in(window, {
            ...
            async move |this, cx| {
                ...
                let json_style_buffer =
                    Self::create_buffer_in_project(CARROT_INSPECTOR_STYLE_JSON, &project, cx).await;
