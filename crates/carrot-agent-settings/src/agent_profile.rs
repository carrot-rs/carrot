...
/// A profile for the Carrot Agent that controls its behavior.
#[derive(Debug, Clone)]
...
impl From<inazuma_settings_framework::ContextServerPresetContent> for ContextServerPreset {
    fn from(content: inazuma_settings_framework::ContextServerPresetContent) -> Self {
        Self {
            tools: content.tools,
        }
    }
