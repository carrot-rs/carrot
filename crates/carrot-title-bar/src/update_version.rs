...
use anyhow::anyhow;
use carrot_auto_update::{AutoUpdateStatus, AutoUpdater, UpdateCheckType, VersionCheckType};
use carrot_ui::{UpdateButton, prelude::*};
use inazuma::{Empty, Render};
use semver::Version;
...
#[cfg(test)]
mod tests {
    use carrot_auto_update::VersionCheckType;
    use carrot_release_channel::AppCommitSha;
    use semver::Version;
