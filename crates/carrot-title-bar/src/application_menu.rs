use inazuma::{Action, Entity, OwnedMenu, OwnedMenuItem, actions};
use inazuma_settings_framework::Settings;

use schemars::JsonSchema;
use serde::Deserialize;

use carrot_ui::{ContextMenu, PopoverMenu, PopoverMenuHandle, Tooltip, prelude::*};
