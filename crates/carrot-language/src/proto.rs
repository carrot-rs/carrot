...
use carrot_lsp::{DiagnosticSeverity, LanguageServerId};
...
/// Deserializes a `[inazuma_text::LineEnding]` from the RPC representation.
pub fn deserialize_line_ending(message: proto::LineEnding) -> inazuma_text::LineEnding {
    match message {
        proto::LineEnding::Unix => inazuma_text::LineEnding::Unix,
        proto::LineEnding::Windows => inazuma_text::LineEnding::Windows,
    }
}

/// Serializes a [`inazuma_text::LineEnding`] to be sent over RPC.
pub fn serialize_line_ending(message: inazuma_text::LineEnding) -> proto::LineEnding {
    match message {
        inazuma_text::LineEnding::Unix => proto::LineEnding::Unix,
        inazuma_text::LineEnding::Windows => proto::LineEnding::Windows,
    }
}
...
pub fn serialize_operation(operation: &crate::Operation) -> proto::Operation {
    proto::Operation {
        variant: Some(match operation {
            crate::Operation::Buffer(inazuma_text::Operation::Edit(edit)) => {
                proto::operation::Variant::Edit(serialize_edit_operation(edit))
            }

            crate::Operation::Buffer(inazuma_text::Operation::Undo(undo)) => {
...
pub fn serialize_undo_map_entry(
    (edit_id, counts): (&inazuma_clock::Lamport, &[(inazuma_clock::Lamport, u32)]),
) -> proto::UndoMapEntry {
    proto::UndoMapEntry {
        replica_id: edit_id.replica_id.as_u16() as u32,
...
pub fn deserialize_operation(message: proto::Operation) -> Result<crate::Operation> {
    Ok(
        match message.variant.context("missing operation variant")? {
            proto::operation::Variant::Edit(edit) => crate::Operation::Buffer(
                inazuma_text::Operation::Edit(deserialize_edit_operation(edit)),
            ),
            proto::operation::Variant::Undo(undo) => {
                crate::Operation::Buffer(inazuma_text::Operation::Undo(UndoOperation {
...
) -> (inazuma_clock::Lamport, Vec<(inazuma_clock::Lamport, u32)>) {
    (
        inazuma_clock::Lamport {
        ...
        .filter_map(|diagnostic| {
            ...
            Some(DiagnosticEntry {
                ...
                diagnostic: Diagnostic {
                    ...
                    code: diagnostic.code.map(carrot_lsp::NumberOrString::from_string),
                    code_description: diagnostic
                        .code_description
                        .and_then(|s| carrot_lsp::Uri::from_str(&s).ok()),
...
/// Returns a `[inazuma_clock::Lamport`] timestamp for the given [`proto::Operation`].
...
/// Serializes a [`inazuma_clock::Lamport`] timestamp to be sent over RPC.
pub fn serialize_timestamp(timestamp: inazuma_clock::Lamport) -> proto::LamportTimestamp {
...
/// Deserializes a [`inazuma_clock::Lamport`] timestamp from the RPC representation.
pub fn deserialize_timestamp(timestamp: proto::LamportTimestamp) -> inazuma_clock::Lamport {
    inazuma_clock::Lamport {
...
pub fn deserialize_version(message: &[proto::VectorClockEntry]) -> inazuma_clock::Global {
...
pub fn serialize_version(version: &inazuma_clock::Global) -> Vec<proto::VectorClockEntry> {
    version
        .iter()
...
pub fn serialize_lsp_edit(edit: carrot_lsp::TextEdit) -> proto::TextEdit {
...
pub fn deserialize_lsp_edit(edit: proto::TextEdit) -> Option<carrot_lsp::TextEdit> {
