...
use carrot_task::{TaskTemplates, TaskVariables};
...
/// Language Contexts are used by Carrot tasks to extract information about the source file where the tasks are supposed to be scheduled from.
/// Multiple context providers may be used together: by default, Carrot provides a base [`BasicContextProvider`] context that fills all non-custom [`VariableName`] variants.
///
