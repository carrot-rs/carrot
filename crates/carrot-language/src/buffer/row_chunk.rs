...
use inazuma_text::{Anchor, OffsetRangeExt as _, Point};
use inazuma_util::RangeExt;

use crate::BufferRow;

/// An range of rows, exclusive as [`carrot_lsp::Range`] and
...
impl RowChunks {
    pub fn new(snapshot: &inazuma_text::BufferSnapshot, max_rows_per_chunk: u32) -> Self {
