...
/// Carrot command block badge colors.
#[derive(Refineable, Clone, Debug, PartialEq)]
#[refineable(Debug, serde::Deserialize)]
...
///
/// Controls the appearance of terminal context chips: semi-transparent background,
    ...
    pub fn color(&self, field: ThemeColorField) -> Oklch {
        match field {
            ...
            ThemeColorField::EditorHighlightedLineBackground => {
                self.editor.highlighted_line_background
            }
            ThemeColorField::EditorDebuggerActiveLineBackground => {
                self.editor.debugger_active_line_background
            }
            ...
            ThemeColorField::EditorDocumentHighlightReadBackground => {
                self.editor.document_highlight_read_background
            }
            ThemeColorField::EditorDocumentHighlightWriteBackground => {
                self.editor.document_highlight_write_background
            }
            ThemeColorField::EditorDocumentHighlightBracketBackground => {
                self.editor.document_highlight_bracket_background
            }
            // Terminal
            ...
            ThemeColorField::ScrollbarThumbActiveBackground => {
                self.scrollbar.thumb_active_background
            }
            ...
            ThemeColorField::VersionControlConflictMarkerOurs => {
                self.version_control.conflict_marker_ours
            }
            ThemeColorField::VersionControlConflictMarkerTheirs => {
                self.version_control.conflict_marker_theirs
            }
            // Block
