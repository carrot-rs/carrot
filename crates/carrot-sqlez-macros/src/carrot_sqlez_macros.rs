...
static SQLITE: std::sync::LazyLock<carrot_sqlez::thread_safe_connection::ThreadSafeConnection> =
    std::sync::LazyLock::new(|| {
        carrot_sqlez::thread_safe_connection::ThreadSafeConnection::new(
            ":memory:",
            false,
            None,
            Some(carrot_sqlez::thread_safe_connection::locking_queue()),
        )
    });
