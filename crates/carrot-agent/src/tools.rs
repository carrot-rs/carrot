...
use crate::AgentTool;
use carrot_language_model::{LanguageModelRequestTool, LanguageModelToolSchemaFormat};
...
macro_rules! tools {
    ($($tool:ty),* $(,)?) => {
        ...
        pub fn tool_supports_provider(name: &str, provider: &carrot_language_model::LanguageModelProviderId) -> bool {
            $(
                if name == <$tool>::NAME {
