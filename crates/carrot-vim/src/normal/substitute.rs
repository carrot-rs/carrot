...
use carrot_editor::{Editor, SelectionEffects, movement};
...
mod test {
    ...
    #[inazuma::test]
    async fn test_substitute(cx: &mut inazuma::TestAppContext) {
    ...
    #[inazuma::test]
    async fn test_visual_change(cx: &mut inazuma::TestAppContext) {
    ...
    #[inazuma::test]
    async fn test_visual_line_change(cx: &mut inazuma::TestAppContext) {
        let mut cx = NeovimBackedTestContext::new(cx).await;
        cx.simulate(
            "shift-v c",
            indoc! {"
    ...
    #[inazuma::test]
    async fn test_substitute_line(cx: &mut inazuma::TestAppContext) {
        let mut cx = NeovimBackedTestContext::new(cx).await;
