use carrot_editor::{SelectionEffects, display_map::ToDisplayPoint};
use carrot_language::{Bias, Point, SelectionGoal};
...
mod test {
    ...
    #[inazuma::test]
    async fn test_change_case(cx: &mut inazuma::TestAppContext) {
        ...
        // works with multiple cursors (carrot only)
    ...
    #[inazuma::test]
    async fn test_convert_to_upper_case(cx: &mut inazuma::TestAppContext) {
        let mut cx = NeovimBackedTestContext::new(cx).await;
        // works in visual mode
        cx.set_shared_state("a😀C«dÉ1*fˇ»\n").await;
    ...
    #[inazuma::test]
    async fn test_convert_to_lower_case(cx: &mut inazuma::TestAppContext) {
        let mut cx = NeovimBackedTestContext::new(cx).await;
        // works in visual mode
        cx.set_shared_state("A😀c«DÉ1*fˇ»\n").await;
    ...
    #[inazuma::test]
    async fn test_change_case_motion(cx: &mut inazuma::TestAppContext) {
        let mut cx = NeovimBackedTestContext::new(cx).await;
    ...
    #[inazuma::test]
    async fn test_change_case_motion_object(cx: &mut inazuma::TestAppContext) {
        let mut cx = NeovimBackedTestContext::new(cx).await;
    ...
    #[inazuma::test]
    async fn test_convert_to_rot13(cx: &mut inazuma::TestAppContext) {
        let mut cx = NeovimBackedTestContext::new(cx).await;
        // works in visual mode
        cx.set_shared_state("a😀C«dÉ1*fˇ»\n").await;
    ...
    #[inazuma::test]
    async fn test_change_rot13_motion(cx: &mut inazuma::TestAppContext) {
        let mut cx = NeovimBackedTestContext::new(cx).await;
    ...
    #[inazuma::test]
    async fn test_change_rot13_object(cx: &mut inazuma::TestAppContext) {
        let mut cx = NeovimBackedTestContext::new(cx).await;
    ...
    #[inazuma::test]
    async fn test_change_case_helix_mode(cx: &mut inazuma::TestAppContext) {
