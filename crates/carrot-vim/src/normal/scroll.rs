...
impl Vim {
    ...
    fn scroll_editor(
        ...
        self.update_editor(cx, |vim, editor, cx| {
            ...
            let mut move_cursor = |map: &carrot_editor::display_map::DisplaySnapshot,
...
mod test {
    ...
    use carrot_editor::ScrollBeyondLastLine;
    use carrot_language::Point;
    use inazuma::{AppContext as _, point, px, size};
    ...
    #[inazuma::test]
    async fn test_scroll(cx: &mut inazuma::TestAppContext) {
    ...
    #[inazuma::test]
    async fn test_ctrl_d_u(cx: &mut inazuma::TestAppContext) {
    ...
    #[inazuma::test]
    async fn test_ctrl_f_b(cx: &mut inazuma::TestAppContext) {
        let mut cx = NeovimBackedTestContext::new(cx).await;
    ...
    #[inazuma::test]
    async fn test_scroll_beyond_last_line(cx: &mut inazuma::TestAppContext) {
        let mut cx = NeovimBackedTestContext::new(cx).await;
    ...
    #[inazuma::test]
    async fn test_ctrl_y_e(cx: &mut inazuma::TestAppContext) {
        let mut cx = NeovimBackedTestContext::new(cx).await;
    ...
    #[inazuma::test]
    async fn test_scroll_jumps(cx: &mut inazuma::TestAppContext) {
        let mut cx = NeovimBackedTestContext::new(cx).await;
    ...
    #[inazuma::test]
    async fn test_horizontal_scroll(cx: &mut inazuma::TestAppContext) {
        let mut cx = NeovimBackedTestContext::new(cx).await;
