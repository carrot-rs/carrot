...
use carrot_language::{Bias, SelectionGoal};
use carrot_vim_mode_setting::HelixModeSetting;
    ...
    pub fn paste(&mut self, action: &Paste, window: &mut Window, cx: &mut Context<Self>) {
        ...
        self.update_editor(cx, |vim, editor, cx| {
            ...
            editor.transact(window, cx, |editor, window, cx| {
                ...
                // unlike carrot, if you have a multi-cursor selection from vim block mode,
                ...
                let first_selection_indent_column =
                    clipboard_selections.as_ref().and_then(|carrot_selections| {
                        carrot_selections
                            .first()
...
mod test {
    ...
    use carrot_language::{LanguageName, language_settings::LanguageSettingsContent};
    use inazuma::ClipboardItem;
    use inazuma_settings_framework::{SettingsStore, UseSystemClipboard};
    use indoc::indoc;

    #[inazuma::test]
    async fn test_paste(cx: &mut inazuma::TestAppContext) {
    ...
    #[inazuma::test]
    async fn test_yank_system_clipboard_never(cx: &mut inazuma::TestAppContext) {
    ...
    #[inazuma::test]
    async fn test_yank_system_clipboard_on_yank(cx: &mut inazuma::TestAppContext) {
        let mut cx = VimTestContext::new(cx, true).await;
    ...
    #[inazuma::test]
    async fn test_paste_visual(cx: &mut inazuma::TestAppContext) {
        let mut cx = NeovimBackedTestContext::new(cx).await;
    ...
    #[inazuma::test]
    async fn test_paste_visual_block(cx: &mut inazuma::TestAppContext) {
        let mut cx = NeovimBackedTestContext::new(cx).await;
    ...
    #[inazuma::test]
    async fn test_paste_indent(cx: &mut inazuma::TestAppContext) {
    ...
    #[inazuma::test]
    async fn test_paste_auto_indent(cx: &mut inazuma::TestAppContext) {
        let mut cx = VimTestContext::new(cx, true).await;
    ...
    #[inazuma::test]
    async fn test_paste_count(cx: &mut inazuma::TestAppContext) {
        let mut cx = NeovimBackedTestContext::new(cx).await;
    ...
    #[inazuma::test]
    async fn test_paste_system_clipboard_never(cx: &mut inazuma::TestAppContext) {
        let mut cx = VimTestContext::new(cx, true).await;
        ...
        cx.dispatch_action(carrot_editor::actions::Paste);
        cx.assert_state(
            indoc! {"
                ˇsomething else
                the lazy dog"},
    ...
    #[inazuma::test]
    async fn test_numbered_registers(cx: &mut inazuma::TestAppContext) {
        let mut cx = NeovimBackedTestContext::new(cx).await;
    ...
    #[inazuma::test]
    async fn test_named_registers(cx: &mut inazuma::TestAppContext) {
        let mut cx = NeovimBackedTestContext::new(cx).await;
    ...
    #[inazuma::test]
    async fn test_special_registers(cx: &mut inazuma::TestAppContext) {
        let mut cx = NeovimBackedTestContext::new(cx).await;
    ...
    #[inazuma::test]
    async fn test_multicursor_paste(cx: &mut inazuma::TestAppContext) {
        let mut cx = VimTestContext::new(cx, true).await;
    ...
    #[inazuma::test]
    async fn test_replace_with_register(cx: &mut inazuma::TestAppContext) {
        let mut cx = VimTestContext::new(cx, true).await;
    ...
    #[inazuma::test]
    async fn test_replace_with_register_dot_repeat(cx: &mut inazuma::TestAppContext) {
        let mut cx = VimTestContext::new(cx, true).await;
    ...
    #[inazuma::test]
    async fn test_paste_entire_line_from_editor_copy(cx: &mut inazuma::TestAppContext) {
        let mut cx = VimTestContext::new(cx, true).await;
        ...
        let clipboard_selections = vec![
            carrot_editor::ClipboardSelection {
                len: "line one\n".len(),
                is_entire_line: true,
                first_line_indent: 0,
                file_path: None,
