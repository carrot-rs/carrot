...
use carrot_ui::App;
use carrot_workspace::OpenOptions;
use inazuma::{Context, Entity, EntityId, UpdateGlobal, Window};
    ...
    fn open_path_mark(
        ...
        let task = workspace.update(cx, |workspace, cx| {
            workspace.open_abs_path(
                path.to_path_buf(),
                OpenOptions {
                    visible: Some(carrot_workspace::OpenVisible::All),
                    focus: Some(true),
                    ..Default::default()
                },
                window,
...
mod test {
    ...
    use carrot_workspace::{CloseActiveItem, OpenOptions};
