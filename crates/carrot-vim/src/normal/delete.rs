...
use carrot_language::{Point, Selection};
...
mod test {
    ...
    #[inazuma::test]
    async fn test_delete_h(cx: &mut inazuma::TestAppContext) {
    ...
    #[inazuma::test]
    async fn test_delete_l(cx: &mut inazuma::TestAppContext) {
        let mut cx = NeovimBackedTestContext::new(cx).await;
    ...
    #[inazuma::test]
    async fn test_delete_w(cx: &mut inazuma::TestAppContext) {
        let mut cx = NeovimBackedTestContext::new(cx).await;
        cx.simulate(
            "d w",
            indoc! {"
    ...
    #[inazuma::test]
    async fn test_delete_next_word_end(cx: &mut inazuma::TestAppContext) {
        let mut cx = NeovimBackedTestContext::new(cx).await;
    ...
    #[inazuma::test]
    async fn test_delete_b(cx: &mut inazuma::TestAppContext) {
        let mut cx = NeovimBackedTestContext::new(cx).await;
    ...
    #[inazuma::test]
    async fn test_delete_end_of_line(cx: &mut inazuma::TestAppContext) {
        let mut cx = NeovimBackedTestContext::new(cx).await;
        cx.simulate(
            "d $",
            indoc! {"
    ...
    #[inazuma::test]
    async fn test_delete_end_of_paragraph(cx: &mut inazuma::TestAppContext) {
        let mut cx = NeovimBackedTestContext::new(cx).await;
        cx.simulate(
            "d }",
            indoc! {"
    ...
    #[inazuma::test]
    async fn test_delete_0(cx: &mut inazuma::TestAppContext) {
        let mut cx = NeovimBackedTestContext::new(cx).await;
        cx.simulate(
            "d 0",
            indoc! {"
    ...
    #[inazuma::test]
    async fn test_delete_k(cx: &mut inazuma::TestAppContext) {
        let mut cx = NeovimBackedTestContext::new(cx).await;
        cx.simulate(
            "d k",
            indoc! {"
    ...
    #[inazuma::test]
    async fn test_delete_j(cx: &mut inazuma::TestAppContext) {
        let mut cx = NeovimBackedTestContext::new(cx).await;
        cx.simulate(
            "d j",
            indoc! {"
    ...
    #[inazuma::test]
    async fn test_delete_end_of_document(cx: &mut inazuma::TestAppContext) {
        let mut cx = NeovimBackedTestContext::new(cx).await;
        cx.simulate(
            "d shift-g",
            indoc! {"
    ...
    #[inazuma::test]
    async fn test_delete_to_line(cx: &mut inazuma::TestAppContext) {
        let mut cx = NeovimBackedTestContext::new(cx).await;
        cx.simulate(
            "d 3 shift-g",
            indoc! {"
    ...
    #[inazuma::test]
    async fn test_delete_gg(cx: &mut inazuma::TestAppContext) {
        let mut cx = NeovimBackedTestContext::new(cx).await;
        cx.simulate(
            "d g g",
            indoc! {"
    ...
    #[inazuma::test]
    async fn test_cancel_delete_operator(cx: &mut inazuma::TestAppContext) {
    ...
    #[inazuma::test]
    async fn test_unbound_command_cancels_pending_operator(cx: &mut inazuma::TestAppContext) {
        let mut cx = VimTestContext::new(cx, true).await;
        cx.set_state(
            indoc! {"
                The quick brown
    ...
    #[inazuma::test]
    async fn test_delete_with_counts(cx: &mut inazuma::TestAppContext) {
        let mut cx = NeovimBackedTestContext::new(cx).await;
    ...
    #[inazuma::test]
    async fn test_delete_to_adjacent_character(cx: &mut inazuma::TestAppContext) {
        let mut cx = NeovimBackedTestContext::new(cx).await;
    ...
    #[inazuma::test]
    async fn test_delete_sentence(cx: &mut inazuma::TestAppContext) {
        let mut cx = NeovimBackedTestContext::new(cx).await;
        // cx.simulate(
        //     "d )",
        //     indoc! {"
