    ...
    pub fn helix_select_motion(
        ...
        self.update_editor(cx, |_, editor, cx| {
            ...
            editor.change_selections(Default::default(), window, cx, |s| {
                if let Motion::CarrotSearchResult { new_selections, .. } = &motion {
...
mod test {
    ...
    use inazuma::{KeyBinding, UpdateGlobal, VisualTestContext};
    ...
    #[inazuma::test]
    async fn test_word_motions(cx: &mut inazuma::TestAppContext) {
    ...
    #[inazuma::test]
    async fn test_delete(cx: &mut inazuma::TestAppContext) {
        let mut cx = VimTestContext::new(cx, true).await;
        cx.enable_helix();
    ...
    #[inazuma::test]
    async fn test_delete_character_end_of_line(cx: &mut inazuma::TestAppContext) {
        let mut cx = VimTestContext::new(cx, true).await;
    ...
    // #[inazuma::test]
    // async fn test_delete_character_end_of_buffer(cx: &mut inazuma::TestAppContext) {
    //     let mut cx = VimTestContext::new(cx, true).await;
    ...
    #[inazuma::test]
    async fn test_newline_char(cx: &mut inazuma::TestAppContext) {
        let mut cx = VimTestContext::new(cx, true).await;
        cx.enable_helix();
    ...
    #[inazuma::test]
    async fn test_insert_selected(cx: &mut inazuma::TestAppContext) {
        let mut cx = VimTestContext::new(cx, true).await;
        cx.enable_helix();
        cx.set_state(
            indoc! {"
    ...
    #[inazuma::test]
    async fn test_append(cx: &mut inazuma::TestAppContext) {
        let mut cx = VimTestContext::new(cx, true).await;
        cx.enable_helix();
    ...
    #[inazuma::test]
    async fn test_replace(cx: &mut inazuma::TestAppContext) {
        let mut cx = VimTestContext::new(cx, true).await;
        cx.enable_helix();
    ...
    #[inazuma::test]
    async fn test_helix_yank(cx: &mut inazuma::TestAppContext) {
        let mut cx = VimTestContext::new(cx, true).await;
        cx.enable_helix();
    ...
    #[inazuma::test]
    async fn test_shift_r_paste(cx: &mut inazuma::TestAppContext) {
        let mut cx = VimTestContext::new(cx, true).await;
        cx.enable_helix();
    ...
    #[inazuma::test]
    async fn test_helix_select_mode(cx: &mut inazuma::TestAppContext) {
        let mut cx = VimTestContext::new(cx, true).await;
    ...
    #[inazuma::test]
    async fn test_insert_mode_stickiness(cx: &mut inazuma::TestAppContext) {
        let mut cx = VimTestContext::new(cx, true).await;
        cx.enable_helix();
    ...
    #[inazuma::test]
    async fn test_goto_last_modification(cx: &mut inazuma::TestAppContext) {
        let mut cx = VimTestContext::new(cx, true).await;
        cx.enable_helix();
    ...
    #[inazuma::test]
    async fn test_helix_select_lines(cx: &mut inazuma::TestAppContext) {
        let mut cx = VimTestContext::new(cx, true).await;
        cx.set_state(
            "line one\nline ˇtwo\nline three\nline four",
            Mode::HelixNormal,
    ...
    #[inazuma::test]
    async fn test_helix_insert_before_after_select_lines(cx: &mut inazuma::TestAppContext) {
        let mut cx = VimTestContext::new(cx, true).await;
    ...
    #[inazuma::test]
    async fn test_helix_insert_before_after_helix_select(cx: &mut inazuma::TestAppContext) {
        let mut cx = VimTestContext::new(cx, true).await;
        cx.enable_helix();
    ...
    #[inazuma::test]
    async fn test_helix_select_mode_motion(cx: &mut inazuma::TestAppContext) {
        let mut cx = VimTestContext::new(cx, true).await;
    ...
    #[inazuma::test]
    async fn test_helix_select_mode_motion_multiple_cursors(cx: &mut inazuma::TestAppContext) {
        let mut cx = VimTestContext::new(cx, true).await;
    ...
    #[inazuma::test]
    async fn test_helix_select_word_motions(cx: &mut inazuma::TestAppContext) {
        let mut cx = VimTestContext::new(cx, true).await;
    ...
    #[inazuma::test]
    async fn test_exit_visual_mode(cx: &mut inazuma::TestAppContext) {
        let mut cx = VimTestContext::new(cx, true).await;
    ...
    #[inazuma::test]
    async fn test_helix_select_motion(cx: &mut inazuma::TestAppContext) {
        let mut cx = VimTestContext::new(cx, true).await;
        cx.enable_helix();
    ...
    #[inazuma::test]
    async fn test_helix_full_cursor_selection(cx: &mut inazuma::TestAppContext) {
        let mut cx = VimTestContext::new(cx, true).await;
        cx.enable_helix();
    ...
    #[inazuma::test]
    async fn test_helix_select_regex(cx: &mut inazuma::TestAppContext) {
        let mut cx = VimTestContext::new(cx, true).await;
        cx.enable_helix();
    ...
    #[inazuma::test]
    async fn test_helix_select_next_match(cx: &mut inazuma::TestAppContext) {
        let mut cx = VimTestContext::new(cx, true).await;
    ...
    #[inazuma::test]
    async fn test_helix_select_next_match_wrapping(cx: &mut inazuma::TestAppContext) {
        let mut cx = VimTestContext::new(cx, true).await;
        cx.enable_helix();
    ...
    #[inazuma::test]
    async fn test_helix_substitute(cx: &mut inazuma::TestAppContext) {
        let mut cx = VimTestContext::new(cx, true).await;
    ...
    #[inazuma::test]
    async fn test_g_l_end_of_line(cx: &mut inazuma::TestAppContext) {
        let mut cx = VimTestContext::new(cx, true).await;
        cx.enable_helix();
    ...
    #[inazuma::test]
    async fn test_scroll_with_selection(cx: &mut inazuma::TestAppContext) {
        let mut cx = VimTestContext::new(cx, true).await;
        cx.enable_helix();
    ...
    #[inazuma::test]
    async fn test_helix_insert_end_of_line(cx: &mut inazuma::TestAppContext) {
        let mut cx = VimTestContext::new(cx, true).await;
        cx.enable_helix();
    ...
    #[inazuma::test]
    async fn test_helix_replace_uses_graphemes(cx: &mut inazuma::TestAppContext) {
        let mut cx = VimTestContext::new(cx, true).await;
        cx.enable_helix();
