...
use carrot_editor::{Bias, Editor};
use carrot_language::SelectionGoal;
...
mod test {
    ...
    #[inazuma::test]
    async fn test_enter_and_exit_insert_mode(cx: &mut inazuma::TestAppContext) {
    ...
    #[inazuma::test]
    async fn test_insert_with_counts(cx: &mut inazuma::TestAppContext) {
    ...
    #[inazuma::test]
    async fn test_insert_with_repeat(cx: &mut inazuma::TestAppContext) {
        let mut cx = NeovimBackedTestContext::new(cx).await;
    ...
    #[inazuma::test]
    async fn test_insert_ctrl_r(cx: &mut inazuma::TestAppContext) {
        let mut cx = NeovimBackedTestContext::new(cx).await;
    ...
    #[inazuma::test]
    async fn test_insert_ctrl_y(cx: &mut inazuma::TestAppContext) {
        let mut cx = NeovimBackedTestContext::new(cx).await;
