...
use carrot_language::{BufferSnapshot, CharKind, Point, Selection, TextObject, TreeSitterOptions};
use carrot_multi_buffer::MultiBufferRow;
use carrot_ui::Context;
use inazuma::{Action, Window, actions};
...
mod test {
    use carrot_editor::{
        Editor, EditorMode, MultiBuffer, test::editor_test_context::EditorTestContext,
    };
    ...
    #[inazuma::test]
    async fn test_change_word_object(cx: &mut inazuma::TestAppContext) {
    ...
    #[inazuma::test]
    async fn test_delete_word_object(cx: &mut inazuma::TestAppContext) {
        let mut cx = NeovimBackedTestContext::new(cx).await;
    ...
    #[inazuma::test]
    async fn test_visual_word_object(cx: &mut inazuma::TestAppContext) {
        let mut cx = NeovimBackedTestContext::new(cx).await;
    ...
    #[inazuma::test]
    async fn test_word_object_with_count(cx: &mut inazuma::TestAppContext) {
        let mut cx = NeovimBackedTestContext::new(cx).await;
    ...
    #[inazuma::test]
    async fn test_change_paragraph_object(cx: &mut inazuma::TestAppContext) {
        let mut cx = NeovimBackedTestContext::new(cx).await;
    ...
    #[inazuma::test]
    async fn test_delete_paragraph_object(cx: &mut inazuma::TestAppContext) {
        let mut cx = NeovimBackedTestContext::new(cx).await;
    ...
    #[inazuma::test]
    async fn test_visual_paragraph_object(cx: &mut inazuma::TestAppContext) {
        let mut cx = NeovimBackedTestContext::new(cx).await;
    ...
    #[inazuma::test]
    async fn test_change_paragraph_object_with_soft_wrap(cx: &mut inazuma::TestAppContext) {
        let mut cx = NeovimBackedTestContext::new(cx).await;
    ...
    #[inazuma::test]
    async fn test_delete_paragraph_object_with_soft_wrap(cx: &mut inazuma::TestAppContext) {
        let mut cx = NeovimBackedTestContext::new(cx).await;
    ...
    #[inazuma::test]
    async fn test_delete_paragraph_whitespace(cx: &mut inazuma::TestAppContext) {
        let mut cx = NeovimBackedTestContext::new(cx).await;
    ...
    #[inazuma::test]
    async fn test_visual_paragraph_object_with_soft_wrap(cx: &mut inazuma::TestAppContext) {
        let mut cx = NeovimBackedTestContext::new(cx).await;
    ...
    #[inazuma::test]
    async fn test_change_surrounding_character_objects(cx: &mut inazuma::TestAppContext) {
        let mut cx = NeovimBackedTestContext::new(cx).await;
    ...
    #[inazuma::test]
    async fn test_singleline_surrounding_character_objects(cx: &mut inazuma::TestAppContext) {
        let mut cx = NeovimBackedTestContext::new(cx).await;
    ...
    #[inazuma::test]
    async fn test_multiline_surrounding_character_objects(cx: &mut inazuma::TestAppContext) {
    ...
    #[inazuma::test]
    async fn test_vertical_bars(cx: &mut inazuma::TestAppContext) {
        let mut cx = VimTestContext::new(cx, true).await;
        cx.set_state(
            indoc! {"
            fn boop() {
    ...
    #[inazuma::test]
    async fn test_argument_object(cx: &mut inazuma::TestAppContext) {
        let mut cx = VimTestContext::new(cx, true).await;
    ...
    #[inazuma::test]
    async fn test_indent_object(cx: &mut inazuma::TestAppContext) {
        let mut cx = VimTestContext::new(cx, true).await;
    ...
    #[inazuma::test]
    async fn test_delete_surrounding_character_objects(cx: &mut inazuma::TestAppContext) {
        let mut cx = NeovimBackedTestContext::new(cx).await;
    ...
    #[inazuma::test]
    async fn test_anyquotes_object(cx: &mut inazuma::TestAppContext) {
        let mut cx = VimTestContext::new(cx, true).await;
        cx.update(|_, cx| {
    ...
    #[inazuma::test]
    async fn test_miniquotes_object(cx: &mut inazuma::TestAppContext) {
        ...
        const TEST_CASES: &[(&str, &str, &str, Mode)] = &[
            ...
            // Bug reference: https://github.com/carrot-rs/carrot/issues/23889
    ...
    #[inazuma::test]
    async fn test_anybrackets_object(cx: &mut inazuma::TestAppContext) {
        let mut cx = VimTestContext::new(cx, true).await;
        cx.update(|_, cx| {
            cx.bind_keys([KeyBinding::new(
                "b",
    ...
    #[inazuma::test]
    async fn test_minibrackets_object(cx: &mut inazuma::TestAppContext) {
        let mut cx = VimTestContext::new(cx, true).await;
        cx.update(|_, cx| {
            cx.bind_keys([KeyBinding::new(
                "b",
    ...
    #[inazuma::test]
    async fn test_minibrackets_multibuffer(cx: &mut inazuma::TestAppContext) {
        ...
        let (editor, cx) = cx.add_window_view(|window, cx| {
            ...
            if let Some(buffer) = multi_buffer.read(cx).buffer(buffer_ids[1]) {
                buffer.update(cx, |buffer, cx| {
                    buffer.set_language(Some(carrot_language::rust_lang()), cx);
                })
            };
    ...
    #[inazuma::test]
    async fn test_minibrackets_trailing_space(cx: &mut inazuma::TestAppContext) {
        let mut cx = NeovimBackedTestContext::new(cx).await;
    ...
    #[inazuma::test]
    async fn test_tags(cx: &mut inazuma::TestAppContext) {
    ...
    #[inazuma::test]
    async fn test_around_containing_word_indent(cx: &mut inazuma::TestAppContext) {
        let mut cx = NeovimBackedTestContext::new(cx).await;
    ...
    #[inazuma::test]
    async fn test_arrow_function_text_object(cx: &mut inazuma::TestAppContext) {
        let mut cx = VimTestContext::new_typescript(cx).await;
    ...
    #[inazuma::test]
    async fn test_arrow_function_in_jsx(cx: &mut inazuma::TestAppContext) {
    ...
    #[inazuma::test]
    async fn test_subword_object(cx: &mut inazuma::TestAppContext) {
        let mut cx = VimTestContext::new(cx, true).await;
