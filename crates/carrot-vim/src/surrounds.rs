...
use carrot_editor::{Bias, MultiBufferOffset, movement};
use carrot_language::BracketPair;
...
mod test {
    ...
    #[inazuma::test]
    async fn test_add_surrounds(cx: &mut inazuma::TestAppContext) {
    ...
    #[inazuma::test]
    async fn test_add_surrounds_visual(cx: &mut inazuma::TestAppContext) {
        let mut cx = VimTestContext::new(cx, true).await;
    ...
    #[inazuma::test]
    async fn test_delete_surrounds(cx: &mut inazuma::TestAppContext) {
        let mut cx = VimTestContext::new(cx, true).await;
    ...
    #[inazuma::test]
    async fn test_change_surrounds(cx: &mut inazuma::TestAppContext) {
        let mut cx = VimTestContext::new(cx, true).await;
    ...
    #[inazuma::test]
    async fn test_change_surrounds_any_brackets(cx: &mut inazuma::TestAppContext) {
        let mut cx = VimTestContext::new(cx, true).await;
        ...
        cx.set_state(indoc! {"(< name: ˇ'Carrot' >)"}, Mode::Normal);
        cx.simulate_keystrokes("c s b }");
        cx.assert_state(indoc! {"(ˇ{ name: 'Carrot' })"}, Mode::Normal);
    ...
    #[inazuma::test]
    async fn test_change_surrounds_vim(cx: &mut inazuma::TestAppContext) {
        let mut cx = VimTestContext::new(cx, true).await;
    ...
    #[inazuma::test]
    async fn test_surrounds(cx: &mut inazuma::TestAppContext) {
        let mut cx = VimTestContext::new(cx, true).await;
    ...
    #[inazuma::test]
    async fn test_surround_aliases(cx: &mut inazuma::TestAppContext) {
        let mut cx = VimTestContext::new(cx, true).await;
