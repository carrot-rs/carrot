...
use carrot_editor::{Bias, Editor, display_map::ToDisplayPoint};
...
mod test {
    ...
    #[inazuma::test]
    async fn test_indent_gv(cx: &mut inazuma::TestAppContext) {
    ...
    #[inazuma::test]
    async fn test_indent_hx(cx: &mut inazuma::TestAppContext) {
    ...
    #[inazuma::test]
    async fn test_autoindent_op(cx: &mut inazuma::TestAppContext) {
        let mut cx = VimTestContext::new(cx, true).await;
