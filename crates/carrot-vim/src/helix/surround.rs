...
use carrot_editor::{Bias, DisplayPoint, MultiBufferOffset};
...
fn selection_cursor(map: &DisplaySnapshot, selection: &Selection<DisplayPoint>) -> DisplayPoint {
    if selection.reversed || selection.is_empty() {
        ...
        carrot_editor::movement::left(map, selection.head())
    }
}
...
mod test {
    ...
    #[inazuma::test]
    async fn test_helix_surround_add(cx: &mut inazuma::TestAppContext) {
    ...
    #[inazuma::test]
    async fn test_helix_surround_delete(cx: &mut inazuma::TestAppContext) {
        let mut cx = VimTestContext::new(cx, true).await;
        cx.enable_helix();
    ...
    #[inazuma::test]
    async fn test_helix_surround_replace(cx: &mut inazuma::TestAppContext) {
        let mut cx = VimTestContext::new(cx, true).await;
        cx.enable_helix();
    ...
    #[inazuma::test]
    async fn test_helix_surround_multiline(cx: &mut inazuma::TestAppContext) {
        let mut cx = VimTestContext::new(cx, true).await;
        cx.enable_helix();
    ...
    #[inazuma::test]
    async fn test_helix_surround_select_mode(cx: &mut inazuma::TestAppContext) {
        let mut cx = VimTestContext::new(cx, true).await;
        cx.enable_helix();
    ...
    #[inazuma::test]
    async fn test_helix_surround_multi_cursor(cx: &mut inazuma::TestAppContext) {
        let mut cx = VimTestContext::new(cx, true).await;
        cx.enable_helix();
    ...
    #[inazuma::test]
    async fn test_helix_surround_escape_cancels(cx: &mut inazuma::TestAppContext) {
        let mut cx = VimTestContext::new(cx, true).await;
        cx.enable_helix();
    ...
    #[inazuma::test]
    async fn test_helix_surround_no_vim_aliases(cx: &mut inazuma::TestAppContext) {
        let mut cx = VimTestContext::new(cx, true).await;
        cx.enable_helix();
    ...
    #[inazuma::test]
    async fn test_helix_surround_match_nearest(cx: &mut inazuma::TestAppContext) {
        let mut cx = VimTestContext::new(cx, true).await;
        cx.enable_helix();
