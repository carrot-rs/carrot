...
use carrot_editor::{DisplayPoint, MultiBufferOffset, display_map::DisplaySnapshot};
...
mod tests {
    ...
    #[inazuma::test]
    async fn test_selection_duplication(cx: &mut inazuma::TestAppContext) {
    ...
    #[inazuma::test]
    async fn test_selection_duplication_backwards(cx: &mut inazuma::TestAppContext) {
        let mut cx = VimTestContext::new(cx, true).await;
        cx.enable_helix();
    ...
    #[inazuma::test]
    async fn test_selection_duplication_count(cx: &mut inazuma::TestAppContext) {
        let mut cx = VimTestContext::new(cx, true).await;
        cx.enable_helix();
    ...
    #[inazuma::test]
    async fn test_selection_duplication_multiline_multibyte(cx: &mut inazuma::TestAppContext) {
        let mut cx = VimTestContext::new(cx, true).await;
        cx.enable_helix();
    ...
    #[inazuma::test]
    async fn test_selection_duplication_multibyte(cx: &mut inazuma::TestAppContext) {
        let mut cx = VimTestContext::new(cx, true).await;
        cx.enable_helix();
