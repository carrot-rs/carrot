...
use inazuma::{ClipboardEntry, Context, Window, actions};
use std::ops::Range;
use std::sync::Arc;
...
mod test {
    ...
    #[inazuma::test]
    async fn test_enter_and_exit_replace_mode(cx: &mut inazuma::TestAppContext) {
    ...
    async fn test_replace_mode(cx: &mut inazuma::TestAppContext) {
    ...
    #[inazuma::test]
    async fn test_replace_mode_with_counts(cx: &mut inazuma::TestAppContext) {
        let mut cx: NeovimBackedTestContext = NeovimBackedTestContext::new(cx).await;
    ...
    #[inazuma::test]
    async fn test_replace_mode_repeat(cx: &mut inazuma::TestAppContext) {
        let mut cx: NeovimBackedTestContext = NeovimBackedTestContext::new(cx).await;
    ...
    #[inazuma::test]
    async fn test_replace_mode_undo(cx: &mut inazuma::TestAppContext) {
        let mut cx: NeovimBackedTestContext = NeovimBackedTestContext::new(cx).await;
    ...
    #[inazuma::test]
    async fn test_replace_multicursor(cx: &mut inazuma::TestAppContext) {
        let mut cx = VimTestContext::new(cx, true).await;
    ...
    #[inazuma::test]
    async fn test_replace_undo(cx: &mut inazuma::TestAppContext) {
        let mut cx = VimTestContext::new(cx, true).await;
    ...
    #[inazuma::test]
    async fn test_exchange_separate_range(cx: &mut inazuma::TestAppContext) {
        let mut cx = VimTestContext::new(cx, true).await;
    ...
    #[inazuma::test]
    async fn test_exchange_complete_overlap(cx: &mut inazuma::TestAppContext) {
        let mut cx = VimTestContext::new(cx, true).await;
    ...
    #[inazuma::test]
    async fn test_exchange_partial_overlap(cx: &mut inazuma::TestAppContext) {
        let mut cx = VimTestContext::new(cx, true).await;
    ...
    #[inazuma::test]
    async fn test_clear_exchange_clears_operator(cx: &mut inazuma::TestAppContext) {
        let mut cx = VimTestContext::new(cx, true).await;
    ...
    #[inazuma::test]
    async fn test_clear_exchange(cx: &mut inazuma::TestAppContext) {
        let mut cx = VimTestContext::new(cx, true).await;
    ...
    #[inazuma::test]
    async fn test_paste_replace(cx: &mut inazuma::TestAppContext) {
        let mut cx = VimTestContext::new(cx, true).await;
