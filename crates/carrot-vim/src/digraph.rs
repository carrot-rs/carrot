...
use inazuma::{Action, App, Context, Keystroke, KeystrokeEvent, Window};
...
mod test {
    ...
    #[inazuma::test]
    async fn test_digraph_insert_mode(cx: &mut inazuma::TestAppContext) {
    ...
    #[inazuma::test]
    async fn test_digraph_insert_multicursor(cx: &mut inazuma::TestAppContext) {
    ...
    #[inazuma::test]
    async fn test_digraph_replace(cx: &mut inazuma::TestAppContext) {
        let mut cx: NeovimBackedTestContext = NeovimBackedTestContext::new(cx).await;
    ...
    #[inazuma::test]
    async fn test_digraph_find(cx: &mut inazuma::TestAppContext) {
        let mut cx: NeovimBackedTestContext = NeovimBackedTestContext::new(cx).await;
    ...
    #[inazuma::test]
    async fn test_digraph_replace_mode(cx: &mut inazuma::TestAppContext) {
        let mut cx: NeovimBackedTestContext = NeovimBackedTestContext::new(cx).await;
    ...
    #[inazuma::test]
    async fn test_digraph_custom(cx: &mut inazuma::TestAppContext) {
        let mut cx: VimTestContext = VimTestContext::new(cx, true).await;
    ...
    #[inazuma::test]
    async fn test_digraph_keymap_conflict(cx: &mut inazuma::TestAppContext) {
        let mut cx: NeovimBackedTestContext = NeovimBackedTestContext::new(cx).await;
    ...
    #[inazuma::test]
    async fn test_ctrl_v(cx: &mut inazuma::TestAppContext) {
        let mut cx: NeovimBackedTestContext = NeovimBackedTestContext::new(cx).await;
    ...
    #[inazuma::test]
    async fn test_ctrl_v_escape(cx: &mut inazuma::TestAppContext) {
        let mut cx: NeovimBackedTestContext = NeovimBackedTestContext::new(cx).await;
        cx.set_shared_state("ˇ").await;
    ...
    #[inazuma::test]
    async fn test_ctrl_v_control(cx: &mut inazuma::TestAppContext) {
        let mut cx: NeovimBackedTestContext = NeovimBackedTestContext::new(cx).await;
        cx.set_shared_state("ˇ").await;
