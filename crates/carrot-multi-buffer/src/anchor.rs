...
pub struct Anchor {
    ...
    pub text_anchor: inazuma_text::Anchor,
    ...
    pub diff_base_anchor: Option<inazuma_text::Anchor>,
}
...
impl Anchor {
    pub fn with_diff_base_anchor(self, diff_base_anchor: inazuma_text::Anchor) -> Self {
        Self {
    ...
    pub fn in_buffer(excerpt_id: ExcerptId, text_anchor: inazuma_text::Anchor) -> Self {
        Self {
            excerpt_id,
            text_anchor,
    ...
    pub fn min() -> Self {
        Self {
            ...
            text_anchor: inazuma_text::Anchor::MIN,
            diff_base_anchor: None,
        }
    }
    ...
    pub fn max() -> Self {
        Self {
            ...
            text_anchor: inazuma_text::Anchor::MAX,
            diff_base_anchor: None,
        }
    }
...
impl ToPoint for Anchor {
    ...
    fn to_point_utf16(&self, snapshot: &MultiBufferSnapshot) -> inazuma_rope::PointUtf16 {
        self.summary(snapshot)
    }
}
