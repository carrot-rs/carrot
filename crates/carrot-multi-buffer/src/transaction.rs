use carrot_language::{self, Buffer, TransactionId};
...
impl Default for History {
    fn default() -> Self {
        History {
            next_transaction_id: inazuma_clock::Lamport::MIN,
            undo_stack: Vec::new(),
            redo_stack: Vec::new(),
            transaction_depth: 0,
...
struct Transaction {
    id: TransactionId,
    buffer_transactions: HashMap<BufferId, inazuma_text::TransactionId>,
...
impl History {
    ...
    fn push_transaction<'a, T>(
        ...
        T: IntoIterator<Item = (&'a Entity<Buffer>, &'a carrot_language::Transaction)>,
    {
