...
use carrot_language_models::provider::open_ai_compatible::{AvailableModel, ModelCapabilities};
use inazuma_settings_framework::{OpenAiCompatibleSettingsContent, update_settings_file};
use carrot_ui::{
...
impl Render for AddLlmProviderModal {
    fn render(&mut self, window: &mut carrot_ui::Window, cx: &mut carrot_ui::Context<Self>) -> impl IntoElement {
