...
use carrot_acp_thread::{AgentConnection, LoadError};
...
use carrot_project::{AgentServerStore, AgentServersUpdated, Project};
use carrot_watch::Receiver;
...
impl AgentConnectionStore {
    ...
    fn start_connection(
        ...
        let (new_version_tx, new_version_rx) = carrot_watch::channel::<Option<String>>(None);
