...
use carrot_acp_thread::{ContentBlock, PlanEntry};
use carrot_cloud_api_types::{SubmitAgentThreadFeedbackBody, SubmitAgentThreadFeedbackCommentsBody};
use carrot_editor::actions::OpenExcerpts;

use crate::StartThreadIn;
use crate::message_editor::SharedSessionCapabilities;
use inazuma::{Corner, List};
use heapless::Vec as ArrayVec;
use carrot_language_model::{LanguageModelEffortLevel, Speed};
use inazuma_settings_framework::update_settings_file;
use carrot_ui::{ButtonLike, SplitButton, SplitButtonStyle, Tab};
    ...
    fn build_feedback_comments_editor(window: &mut Window, cx: &mut App) -> Entity<Editor> {
        ...
        let editor = cx.new(|cx| {
            let mut editor = Editor::new(
                carrot_editor::EditorMode::AutoHeight {
                    min_lines: 1,
                    max_lines: Some(4),
                },
                buffer,
...
pub struct ThreadView {
    ...
    pub last_token_limit_telemetry: Option<carrot_acp_thread::TokenUsageRatio>,
...
impl ThreadView {
    ...
    fn suppress_merge_conflict_notification(&self, cx: &mut Context<Self>) {
        self.workspace
            .update(cx, |workspace, cx| {
                workspace.suppress_notification(&carrot_workspace::merge_conflict_notification_id(), cx);
            })
            .ok();
    }
    ...
    fn unsuppress_merge_conflict_notification(&self, cx: &mut Context<Self>) {
        self.workspace
            .update(cx, |workspace, _cx| {
                workspace.unsuppress(carrot_workspace::merge_conflict_notification_id());
            })
            .ok();
    }
        ...
        let (error_kind, acp_error_code, message): (&str, Option<SharedString>, SharedString) =
            match error {
                ThreadError::PaymentRequired => (
                    "payment_required",
                    None,
                    "You reached your free usage limit. Upgrade to Carrot Pro for more prompts."
                        .into(),
                ),
                ThreadError::Refusal => {
    ...
    fn queue_message(
        ...
        let is_idle = self.thread.read(cx).status() == carrot_acp_thread::ThreadStatus::Idle;
    ...
    pub fn send_queued_message_at_index(
        ...
        if is_send_now {
            let is_generating =
                self.thread.read(cx).status() == carrot_acp_thread::ThreadStatus::Generating;
    ...
    fn share_thread(&mut self, _window: &mut Window, cx: &mut Context<Self>) {
        ...
        cx.spawn(async move |_this, cx| {
            ...
            client
                .request(carrot_proto::ShareAgentThread {
            ...
            let share_url = carrot_client::carrot_urls::shared_agent_thread_url(&session_id);
    ...
    pub fn sync_thread(
        ...
        cx.spawn_in(window, async move |this, cx| {
            let response = client
                .request(carrot_proto::GetSharedAgentThread {
                    session_id: session_id.to_string(),
                })
                .await?;
    ...
    fn toggle_following(&mut self, window: &mut Window, cx: &mut Context<Self>) {
        ...
        carrot_telemetry::event!("Follow Agent Selected", following = !following);
    }
    ...
    pub fn render_activity_bar(
        ...
        v_flex()
            ...
            .shadow(vec![inazuma::BoxShadow {
                color: inazuma::black().opacity(0.12),
                                    ...
                                    .child(
                                        Button::new(("send_now", index), "Send Now")
                                            ...
                                            .when(is_next && message_editor.is_empty(cx), |this| {
                                                let action: Box<dyn inazuma::Action> =
                                                    if can_fast_track {
                                                        Box::new(Chat)
                                                    } else {
        ...
        if self.is_loading_contents {
            ...
            IconButton::new("stop-generation", IconName::Stop)
                ...
                .tooltip(move |_window, cx| {
                    Tooltip::for_action("Stop Generation", &carrot_editor::actions::Cancel, cx)
                })
                        ...
                        .handler({
                            move |window, cx| {
                                window.dispatch_action(
                                    carrot_actions::agent::AddSelectionToThread.boxed_clone(),
                                    cx,
                                );
                            }
                        }),
    ...
    fn render_follow_toggle(&self, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        let tooltip_label = if following {
            if self.agent_id.as_ref() == carrot_agent::ZED_AGENT_ID.as_ref() {
...
impl Render for TokenUsageTooltip {
    fn render(&mut self, _window: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        carrot_ui::tooltip_container(cx, move |container, cx| {
            container
                .min_w_40()
...
impl ThreadView {
    pub(crate) fn render_entries(&mut self, cx: &mut Context<Self>) -> List {
        ...
        .with_sizing_behavior(inazuma::ListSizingBehavior::Auto)
        .flex_grow()
    }
    ...
    fn render_thread_controls(
            ...
            && self.thread.read(cx).connection().telemetry().is_some()
        {
            ...
            let tooltip_meta = || {
                SharedString::new(
                    "Rating the thread sends all of your current conversation to the Carrot team.",
                )
            };
    ...
    pub fn open_thread_as_markdown(
        ...
        window.spawn(cx, async move |cx| {
            ...
            buffer.update(cx, |buffer, cx| {
                ...
                buffer.set_capability(carrot_language::Capability::ReadWrite, cx);
            });
                ...
                ContextMenu::build(window, cx, move |menu, _, cx| {
                    ...
                    menu.when_some(focus, |menu, focus| menu.context(focus))
                        .action_disabled_when(
                            !has_selection,
                            "Copy Selection",
                            Box::new(carrot_markdown::CopyAsMarkdown),
                        )
        ...
        let header = h_flex()
            ...
            .when(truncated_output, |header| {
                let tooltip = if let Some(output) = output {
                    if output_line_count + 10 > carrot_terminal::MAX_SCROLL_HISTORY_LINES {
...
;
        ...
        window
            .spawn(cx, async move |cx| {
                ...
                active_editor.update_in(cx, |editor, window, cx| {
                    ...
                    {
                        let anchor = carrot_editor::Anchor::in_buffer(excerpt_id, agent_location.position);
    ...
    fn render_diff_editor(
        &self,
        entry_ix: usize,
        diff: &Entity<carrot_acp_thread::Diff>,
        tool_call: &ToolCall,
        has_failed: bool,
        cx: &Context<Self>,
    ) -> AnyElement {
    ...
    fn render_image_output(
        ...
        let dimensions_label = if show_dimensions {
            let format_name = match image.format() {
                inazuma::ImageFormat::Png => "PNG",
                inazuma::ImageFormat::Jpeg => "JPEG",
                inazuma::ImageFormat::Webp => "WebP",
                inazuma::ImageFormat::Gif => "GIF",
                inazuma::ImageFormat::Svg => "SVG",
                inazuma::ImageFormat::Bmp => "BMP",
                inazuma::ImageFormat::Tiff => "TIFF",
                inazuma::ImageFormat::Ico => "ICO",
            };
                                ...
                                this.cursor_pointer()
                                    ...
                                    .on_click(cx.listener({
                                        ...
                                        move |this, _, _, cx| {
                                            ...
                                            carrot_telemetry::event!("Subagent Toggled", expanded);
                                            cx.notify();
                                        }
                                    }))
                            }),
                                    ...
                                    |this, thread| {
                                        this.on_click(cx.listener(
                                            move |_this, _event, _window, cx| {
                                                carrot_telemetry::event!("Subagent Stopped");
                                                thread.update(cx, |thread, cx| {
                                                    thread.cancel(cx).detach();
                                                });
                                            },
            ...
            .when_some(thread_view, |this, thread_view| {
                ...
                let fullscreen_toggle = h_flex()
                    ...
                    .on_click(cx.listener(move |this, _event, window, cx| {
                        carrot_telemetry::event!("Subagent Maximized");
                        this.server_view
                            .update(cx, |this, cx| {
        ...
        if matches!(status, ToolCallStatus::Failed) {
            tool_call.content.iter().find_map(|content| {
                if let ToolCallContent::ContentBlock(block) = content {
                    if let carrot_acp_thread::ContentBlock::Markdown { markdown } = block {
                ...
                Button::new("open-wsl-modal", "Open in WSL").on_click(cx.listener({
                    move |_, _, _window, cx| {
                        ...
                        _window.dispatch_action(
                            carrot_actions::wsl_actions::OpenWsl::default().boxed_clone(),
                            cx,
                        );
                        cx.notify();
                    }
    ...
    fn render_token_limit_callout(&self, cx: &mut Context<Self>) -> Option<Callout> {
        ...
        let (severity, icon, title) = match ratio {
            carrot_acp_thread::TokenUsageRatio::Normal => return None,
            carrot_acp_thread::TokenUsageRatio::Warning => (
                Severity::Warning,
                IconName::Warning,
                "Thread reaching the token limit soon",
            ),
            carrot_acp_thread::TokenUsageRatio::Exceeded => (
                Severity::Error,
                IconName::XCircle,
...
impl Render for ThreadView {
    fn render(&mut self, window: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        v_flex()
            ...
            .on_action(cx.listener(|this, _: &carrot_workspace::GoBack, window, cx| {
