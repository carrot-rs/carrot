...
use carrot_ai_onboarding::{AgentPanelOnboardingCard, PlanDefinitions};
use carrot_client::carrot_urls;
use inazuma::{AnyElement, App, IntoElement, RenderOnce, Window};
use carrot_ui::{Divider, Tooltip, prelude::*};
...
impl RenderOnce for EndTrialUpsell {
    fn render(self, _window: &mut Window, cx: &mut App) -> impl IntoElement {
        let pro_section = v_flex()
            ...
            .child(
                Button::new("cta-button", "Upgrade to Carrot Pro")
                    .full_width()
                    .style(ButtonStyle::tinted(carrot_ui::TintColor::Accent))
                    .on_click(move |_, _window, cx| {
                        carrot_telemetry::event!("Upgrade To Pro Clicked", state = "end-of-trial");
        ...
        AgentPanelOnboardingCard::new()
            .child(Headline::new("Your Carrot Pro Trial has expired"))
            .child(
