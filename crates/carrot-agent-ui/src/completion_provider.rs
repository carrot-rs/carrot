...
use inazuma::{App, BackgroundExecutor, Entity, SharedString, Task, WeakEntity};
use carrot_language::{Buffer, CodeLabel, CodeLabelBuilder, HighlightId};
use carrot_lsp::CompletionContext;
use carrot_multi_buffer::ToOffset as _;
use ordered_float::OrderedFloat;
use carrot_project::lsp_store::{CompletionDocumentation, SymbolLocation};
use carrot_project::{
...
use carrot_prompt_store::{PromptStore, UserPromptId};
use inazuma_rope::Point;
use inazuma_settings_framework::{Settings, TerminalDockPosition};
use carrot_terminal::terminal_settings::TerminalSettings;
use carrot_terminal_view::terminal_panel::TerminalPanel;
use inazuma_text::{Anchor, ToOffset as _, ToPoint as _};
...
use carrot_workspace::dock::DockPosition;
...
// TODO(phase20): Needs carrot-terminal-view TerminalPanel integration
fn terminal_selections_if_panel_open(_workspace: &Entity<Workspace>, _cx: &App) -> Vec<String> {
    Vec::new()
}
