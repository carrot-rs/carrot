...
use carrot_project::agent_server_store::{AllAgentServersSettings, CustomAgentServerSettings};
use carrot_project::{AgentRegistryStore, RegistryAgent};
                            ...
                            .child(
                                ButtonCommon::size(
                                    ...
                                    .on_click(move |_, _: &mut Window, cx: &mut App| {
                                        cx.open_url(&carrot_urls::acp_registry_blog(cx))
                                    }),
                            ),
                    )
                    .child(
