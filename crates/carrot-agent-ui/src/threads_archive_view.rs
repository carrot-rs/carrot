...
use carrot_project::{AgentId, AgentServerStore};
...
impl ThreadsArchiveView {
                    ...
                    .map(|mut menu| {
                        ...
                        for item in &agent_items {
                            ...
                            if let Some(icon_path) = icon_path {
                                ...
                                entry = entry.icon(IconName::CarrotAgent);
                            }
    ...
    fn render_header(&self, window: &Window, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        h_flex()
            ...
            .map(|this| {
                if traffic_lights {
                    this.pl(px(carrot_ui::utils::TRAFFIC_LIGHT_PADDING))
                } else {
                    this.pl_1p5()
                }
            })
            ...
            .when(traffic_lights, |this| {
                this.child(Divider::vertical().color(carrot_ui::DividerColor::Border))
            })
            .child(
                h_flex()
                    .ml_1()
