                                    ...
                                    h_flex()
                                        ...
                                        .child(
                                            Button::new("confirm_delete", "Delete")
                                                .style(ButtonStyle::tinted(carrot_ui::TintColor::Error))
                                                .color(Color::Error)
                                                .label_size(LabelSize::Small)
...
impl EntryTimeFormat {
    fn format_timestamp(&self, timestamp: i64, timezone: UtcOffset) -> String {
        ...
        match self {
            EntryTimeFormat::DateAndTime => carrot_time_format::format_localized_timestamp(
                timestamp,
                OffsetDateTime::now_utc(),
                timezone,
                carrot_time_format::TimestampFormat::EnhancedAbsolute,
            ),
            EntryTimeFormat::TimeOnly => carrot_time_format::format_time(timestamp.to_offset(timezone)),
        }
    }
}
