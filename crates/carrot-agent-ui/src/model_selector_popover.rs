...
use carrot_acp_thread::{AgentModelIcon, AgentModelInfo, AgentModelSelector};
use carrot_fs::Fs;
use inazuma::{Entity, FocusHandle};
use inazuma_picker::popover_menu::PickerPopoverMenu;
use carrot_ui::{PopoverMenuHandle, Tooltip, prelude::*};
...
impl ModelSelectorPopover {
    pub(crate) fn new(
        ...
        agent_server: Rc<dyn carrot_agent_servers::AgentServer>,
        fs: Arc<dyn Fs>,
        menu_handle: PopoverMenuHandle<ModelSelector>,
