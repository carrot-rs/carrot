use carrot_acp_thread::{AgentSessionInfo, AgentSessionList, AgentSessionListRequest, SessionListUpdate};
    ...
    fn refresh_sessions(&mut self, load_all_pages: bool, cx: &mut Context<Self>) {
        ...
        self._refresh_task = cx.spawn(async move |this, cx| {
            ...
            loop {
                ...
                let carrot_acp_thread::AgentSessionListResponse {
...
mod tests {
    use super::*;
    use carrot_acp_thread::AgentSessionListResponse;
