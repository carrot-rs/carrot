...
use carrot_editor::{MultiBuffer, actions::SelectAll};
use carrot_fs::Fs;
...
use uuid::Uuid;
use carrot_workspace::{Toast, Workspace, carrot_notifications::NotificationId};
                ...
                LanguageModelRegistry::read_global(cx).inline_assistant_model()
            {
                ...
                report_anthropic_event(
                    ...
                    carrot_language_model::AnthropicEventData {
                        completion_type: carrot_language_model::AnthropicCompletionType::Terminal,
