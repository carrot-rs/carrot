...
use inazuma_sum_tree::{ContextLessSummary, Dimension, Edit, Item, KeyedItem, SumTree};
...
pub struct OperationKey(inazuma_clock::Lamport);
...
impl OperationKey {
    pub fn new(timestamp: inazuma_clock::Lamport) -> Self {
        Self(timestamp)
    }
}
...
mod tests {
    ...
    #[test]
    fn test_len() {
        let mut clock = inazuma_clock::Lamport::new(ReplicaId::LOCAL);
    ...
    struct TestOperation(inazuma_clock::Lamport);
