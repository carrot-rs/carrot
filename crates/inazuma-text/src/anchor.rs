...
use inazuma_sum_tree::{Bias, Dimensions};
...
pub struct Anchor {
    ...
    // pub(crate) timestamp: inazuma_clock::Lamport,
    ...
    pub(crate) timestamp_replica_id: inazuma_clock::ReplicaId,
    pub(crate) timestamp_value: inazuma_clock::Seq,
...
impl Anchor {
    pub const MIN: Self = Self {
        timestamp_replica_id: inazuma_clock::Lamport::MIN.replica_id,
        timestamp_value: inazuma_clock::Lamport::MIN.value,
        offset: u32::MIN,
        bias: Bias::Left,
        buffer_id: None,
    };
    ...
    pub const MAX: Self = Self {
        timestamp_replica_id: inazuma_clock::Lamport::MAX.replica_id,
        timestamp_value: inazuma_clock::Lamport::MAX.value,
        offset: u32::MAX,
        bias: Bias::Right,
        buffer_id: None,
    };
    ...
    pub fn is_min(&self) -> bool {
        self.timestamp() == inazuma_clock::Lamport::MIN
            && self.offset == u32::MIN
            && self.bias == Bias::Left
    }

    pub fn is_max(&self) -> bool {
        self.timestamp() == inazuma_clock::Lamport::MAX
            && self.offset == u32::MAX
