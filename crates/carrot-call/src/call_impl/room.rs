...
use carrot_livekit_client::{self as livekit, AudioStream, TrackSid};
...
use carrot_workspace::ParticipantLocation;
use inazuma_util::{ResultExt, TryFutureExt, paths::PathStyle, post_inc};
...
impl Room {
    ...
    pub fn mute_on_join(cx: &App) -> bool {
        CallSettings::get_global(cx).mute_on_join || carrot_client::IMPERSONATE_LOGIN.is_some()
    }
