...
use inazuma::{Context, Task, WeakEntity};
...
fn compute_network_stats(stats: &carrot_livekit_client::SessionStats) -> ComputedNetworkStats {
...
fn extract_metrics(
    _stat: &carrot_livekit_client::RtcStats,
