...
use carrot_audio::Audio;
use carrot_client::{
    CARROT_ALWAYS_ACTIVE, ChannelId, Client, TypedEnvelope, User, UserStore, proto,
};
...
pub use carrot_livekit_client::{
    RemoteVideoTrack, RemoteVideoTrackView, RemoteVideoTrackViewEvent,
};
pub use room::Room;
...
impl AnyActiveCall for ActiveCallEntity {
    fn entity(&self) -> inazuma::AnyEntity {
    ...
    fn remote_participant_for_peer_id(
        ...
        cx: &App,
    ) -> Option<carrot_workspace::RemoteCollaborator> {
    ...
    fn create_shared_screen(
        ...
        window: &mut Window,
        cx: &mut App,
    ) -> Option<Entity<carrot_workspace::SharedScreen>> {
            ...
            cx.subscribe(
                ...
                move |_: &mut SharedScreen,
                    ...
                    if let room::Event::RemoteVideoTrackUnsubscribed { sid } = ev
                        && *sid == my_sid
                    {
                        cx.emit(carrot_workspace::shared_screen::Event::Close);
                    }
                },
            )
            .detach();
...
pub struct ActiveCall {
    ...
    _subscriptions: Vec<carrot_client::Subscription>,
}
...
impl ActiveCall {
    ...
    pub fn decline_incoming(&mut self, _: &mut Context<Self>) -> Result<()> {
        ...
        carrot_telemetry::event!("Incoming Call Declined", room_id = call.room_id);
    ...
    pub fn set_location(
        ...
        if project.is_some() || !*CARROT_ALWAYS_ACTIVE {
