use carrot_editor::{Editor, EditorEvent, MBTextSummary, MultiBufferSnapshot};
use carrot_ui::{Tooltip, prelude::*};
use carrot_workspace::{StatusBarSettings, StatusItemView, Workspace, item::ItemHandle};
    ...
    pub(crate) fn at_selection_end(
            ...
            snapshot.point_to_buffer_point(selection_end)
        {
            ...
            let chars_to_last_position = buffer_snapshot
                .text_summary_for_range::<inazuma_text::TextSummary, _>(line_start..point)
                .chars as u32;
                ...
                .update(cx, |editor, cx| {
                    cursor_position.update(cx, |cursor_position, cx| {
                        ...
                        match editor.mode() {
                            ...
                            | carrot_editor::EditorMode::SingleLine
                            | carrot_editor::EditorMode::Minimap { .. } => {
                                cursor_position.position = None;
                                cursor_position.context = None;
                            }
                            carrot_editor::EditorMode::Full { .. } => {
...
impl From<inazuma_settings_framework::LineIndicatorFormat> for LineIndicatorFormat {
    fn from(format: inazuma_settings_framework::LineIndicatorFormat) -> Self {
        match format {
            inazuma_settings_framework::LineIndicatorFormat::Short => LineIndicatorFormat::Short,
            inazuma_settings_framework::LineIndicatorFormat::Long => LineIndicatorFormat::Long,
        }
    }
}
