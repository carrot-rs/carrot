...
use carrot_edit_prediction::{EditPredictionStore, ResetOnboarding, capture_example};
...
use carrot_ui::{App, prelude::*};
use carrot_workspace::{SplitDirection, Workspace};
...
fn feature_gate_predict_edits_actions(cx: &mut App) {
    ...
    let all_action_types = [
        ...
        TypeId::of::<carrot_edit_prediction::ResetOnboarding>(),
        carrot_actions::OpenCarrotPredictOnboarding.type_id(),
        TypeId::of::<carrot_edit_prediction::ClearHistory>(),
    ...
    CommandPaletteFilter::update_global(cx, |filter, _cx| {
        ...
        filter.hide_action_types(&[carrot_actions::OpenCarrotPredictOnboarding.type_id()]);
    });
