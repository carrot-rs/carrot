...
use carrot_http_client::{AsyncBody, HttpClient, HttpRequestExt, Request};
...
impl Gitlab {
    ...
    pub fn from_remote_url(remote_url: &str) -> Result<Self> {
        ...
        // is not very reliable. See https://github.com/carrot-rs/carrot/issues/26393 for more
        // information.
    ...
    async fn fetch_gitlab_commit_author(
        ...
        let request = Request::get(&url)
            ...
            .follow_redirects(carrot_http_client::RedirectPolicy::FollowAll);
...
#[cfg(test)]
mod tests {
    use carrot_git::repository::repo_path;
    ...
    fn test_invalid_self_hosted_remote_url() {
        let remote_url = "https://gitlab.com/carrot-rs/carrot.git";
    ...
    fn test_parse_remote_url_given_ssh_url() {
        let parsed_remote = Gitlab::public_instance()
            .parse_remote_url("git@gitlab.com:carrot-rs/carrot.git")
            .unwrap();

        assert_eq!(
            parsed_remote,
            ParsedGitRemote {
                owner: "carrot-rs".into(),
                repo: "carrot".into(),
            }
        );
    }
    ...
    fn test_parse_remote_url_given_https_url() {
        let parsed_remote = Gitlab::public_instance()
            .parse_remote_url("https://gitlab.com/carrot-rs/carrot.git")
            .unwrap();
    ...
    fn test_parse_remote_url_given_self_hosted_ssh_url() {
        let remote_url = "git@gitlab.my-enterprise.com:carrot-rs/carrot.git";
    ...
    fn test_parse_remote_url_given_self_hosted_https_url_with_subgroup() {
        let remote_url = "https://gitlab.my-enterprise.com/group/subgroup/carrot.git";
        let parsed_remote = Gitlab::from_remote_url(remote_url)
            .unwrap()
            .parse_remote_url(remote_url)
            .unwrap();
    ...
    fn test_build_gitlab_permalink() {
        ...
        let expected_url = "https://gitlab.com/carrot-rs/carrot/-/blob/e6ebe7974deb6bb6cc0e2595c8ec31f0c71084b7/crates/editor/src/git/permalink.rs";
    ...
    fn test_build_gitlab_permalink_with_single_line_selection() {
        ...
        let expected_url = "https://gitlab.com/carrot-rs/carrot/-/blob/e6ebe7974deb6bb6cc0e2595c8ec31f0c71084b7/crates/editor/src/git/permalink.rs#L7";
        assert_eq!(permalink.to_string(), expected_url.to_string())
    }
    ...
    fn test_build_gitlab_permalink_with_multi_line_selection() {
        ...
        let expected_url = "https://gitlab.com/carrot-rs/carrot/-/blob/e6ebe7974deb6bb6cc0e2595c8ec31f0c71084b7/crates/editor/src/git/permalink.rs#L24-48";
        assert_eq!(permalink.to_string(), expected_url.to_string())
    }
    ...
    fn test_build_gitlab_create_pr_url() {
        ...
        assert_eq!(
            url.as_str(),
            "https://gitlab.com/carrot-rs/carrot/-/merge_requests/new?merge_request%5Bsource_branch%5D=feature%2Fcool%20stuff"
        );
    }
    ...
    fn test_build_gitlab_self_hosted_permalink_from_ssh_url() {
        let gitlab =
            Gitlab::from_remote_url("git@gitlab.some-enterprise.com:carrot-rs/carrot.git").unwrap();
        ...
        let expected_url = "https://gitlab.some-enterprise.com/carrot-rs/carrot/-/blob/e6ebe7974deb6bb6cc0e2595c8ec31f0c71084b7/crates/editor/src/git/permalink.rs";
        assert_eq!(permalink.to_string(), expected_url.to_string())
    }
    ...
    fn test_build_gitlab_self_hosted_permalink_from_https_url() {
        let gitlab =
            Gitlab::from_remote_url("https://gitlab-instance.big-co.com/carrot-rs/carrot.git")
                .unwrap();
        let permalink = gitlab.build_permalink(
            ParsedGitRemote {
                owner: "carrot-rs".into(),
            ...
            BuildPermalinkParams::new(
                ...
                &repo_path("crates/carrot/src/main.rs"),
                None,
            ),
        );

        let expected_url = "https://gitlab-instance.big-co.com/carrot-rs/carrot/-/blob/b2efec9824c45fcc90c9a7eb107a50d1772a60aa/crates/carrot/src/main.rs";
        assert_eq!(permalink.to_string(), expected_url.to_string())
    }
    ...
    fn test_build_create_pull_request_url() {
        ...
        assert_eq!(
            url.as_str(),
            "https://gitlab.com/carrot-rs/carrot/-/merge_requests/new?merge_request%5Bsource_branch%5D=feature%2Fnew-feature"
        );

        let base_url = Url::parse("https://gitlab.carrot.com").unwrap();
        ...
        assert_eq!(
            url.as_str(),
            "https://gitlab.carrot.com/carrot-rs/carrot/-/merge_requests/new?merge_request%5Bsource_branch%5D=feature%2Fnew-feature"
        );
    }
    ...
    fn test_extract_merge_request_from_squash_commit() {
        ...
        assert_eq!(
            ...
            "https://gitlab.com/carrot-rs/carrot/-/merge_requests/456"
        );
    }
    ...
    fn test_extract_merge_request_from_merge_commit() {
        ...
        let message =
            "Merge branch 'feature' into 'main'\n\nSee merge request carrot-rs/carrot!789";
        let pull_request = provider.extract_pull_request(&remote, message).unwrap();

        assert_eq!(pull_request.number, 789);
        assert_eq!(
            pull_request.url.as_str(),
            "https://gitlab.com/carrot-rs/carrot/-/merge_requests/789"
        );
    }
