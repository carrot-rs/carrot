...
use inazuma_settings_content::{
    AlternateScroll, AppearanceColorspace, CursorShapeContent, GeneralInputMode,
    GeneralWorkingDirectory, Shell, TerminalBlink,
};
...
pub use inazuma_settings_content::{
    ...
    GeneralWorkingDirectory as WorkingDirectory, ResolvedSymbolMap, SymbolMapEntry, TuiAwareness,
};
...
impl Settings for GeneralSettings {
    fn from_settings(content: &inazuma_settings_content::SettingsContent) -> Self {
        ...
        GeneralSettings {
            ...
            tui_awareness: general.tui_awareness.unwrap_or_default(),
...
impl GeneralSettings {
    ...
    pub fn resolve_working_directory(&self) -> PathBuf {
        match &self.working_directory {
            GeneralWorkingDirectory::Home => dirs::home_dir().unwrap_or_else(|| PathBuf::from("/")),
            GeneralWorkingDirectory::Previous => {
                // Session persistence for last CWD will be implemented via carrot-session
