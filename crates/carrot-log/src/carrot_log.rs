...
static CARROT_LOG: CarrotLog = CarrotLog {};

pub struct CarrotLog {}

impl log::Log for CarrotLog {
...
mod tests {
    ...
    #[test]
    fn test_crate_name() {
        assert_eq!(crate_name!(), "carrot_log");
        assert_eq!(
