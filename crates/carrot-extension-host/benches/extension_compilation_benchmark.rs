...
fn manifest() -> ExtensionManifest {
    ExtensionManifest {
        ...
        capabilities: vec![ExtensionCapability::ProcessExec(
            carrot_extension::ProcessExecCapability {
                command: "echo".into(),
                args: vec!["hello!".into()],
            },
        )],
