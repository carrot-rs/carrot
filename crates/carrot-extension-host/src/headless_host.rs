...
use carrot_fs::{Fs, RemoveOptions, RenameOptions};
use carrot_http_client::HttpClient;
use carrot_language::{LanguageConfig, LanguageName, LanguageQueries, LoadedLanguage};
...
impl HeadlessExtensionStore {
    ...
    pub async fn load_extension(
        ...
        for (debug_adapter, meta) in &manifest.debug_adapters {
            let schema_path =
                carrot_extension::build_debug_adapter_schema_path(debug_adapter, meta);
    ...
    pub async fn handle_sync_extensions(
        ...
        Ok(proto::SyncExtensionsResponse {
            missing_extensions: missing_extensions
                ...
                .collect(),
            tmp_dir: carrot_paths::remote_extensions_uploads_dir()
                .to_string_lossy()
                .to_string(),
        })
    }
