...
use carrot_dap::DebugRequest;
use carrot_extension::{DebugTaskDefinition, KeyValueStoreDelegate, WorktreeDelegate};
...
pub use latest::{
    ...
    carrot::extension::lsp::{
        Completion, CompletionKind, CompletionLabelDetails, InsertTextFormat, Symbol, SymbolKind,
    },
    carrot::extension::slash_command::{SlashCommandArgumentCompletion, SlashCommandOutput},
};
...
impl Extension {
    pub async fn instantiate_async(
        ...
        let ext = latest::Extension::instantiate_async(store, component, latest::linker(executor))
            .await
    ...
    pub async fn call_language_server_initialization_options(
        ...
        self.0
            .call_language_server_initialization_options(store, &language_server_id.0, resource)
            .await
    }
    ...
    pub async fn call_language_server_workspace_configuration(
        ...
        self.0
            .call_language_server_workspace_configuration(store, &language_server_id.0, resource)
            .await
    }
