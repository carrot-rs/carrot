...
impl TerminalBuilder {
    ...
    pub fn subscribe(self, _cx: &inazuma::Context<Terminal>) -> Terminal {
        ...
        let mut terminal =
            Terminal::with_shell(24, 80, &cwd, crate::InputMode::Carrot, 10_000, shell_path)
...
/// Inserts environment variables identifying the terminal as running inside Carrot.
pub fn insert_carrot_terminal_env(
    env: &mut HashMap<String, String>,
    version: &impl std::fmt::Display,
) {
    env.insert("CARROT_TERM".to_string(), "true".to_string());
    env.insert("TERM_PROGRAM".to_string(), "carrot".to_string());
