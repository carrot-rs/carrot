...
mod tests {
    ...
    fn test_parsing_valid_remote_urls() {
        let valid_urls = vec![
            (
                "https://github.com/octocat/carrot.git",
                "https",
                "github.com",
                "/octocat/carrot.git",
            ),
            (
                "git@github.com:octocat/carrot.git",
                "ssh",
                "github.com",
                "/octocat/carrot.git",
            ),
            (
                "org-000000@github.com:octocat/carrot.git",
                "ssh",
                "github.com",
                "/octocat/carrot.git",
            ),
            (
                "ssh://git@github.com/octocat/carrot.git",
                "ssh",
                "github.com",
                "/octocat/carrot.git",
            ),
            (
                "file:///path/to/local/carrot",
                "file",
                "",
                "/path/to/local/carrot",
            ),
        ];
