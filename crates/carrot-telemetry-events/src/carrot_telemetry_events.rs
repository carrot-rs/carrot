//! See [Telemetry in Carrot](https://carrot.dev/docs/telemetry) for additional information.
...
pub struct EventRequestBody {
    /// Identifier unique to each system Carrot is installed on
    pub system_id: Option<String>,
    /// Identifier unique to each Carrot installation (differs for stable, preview, dev)
    pub installation_id: Option<String>,
    /// Identifier unique to each logged in Carrot user (randomly generated on first sign in)
    /// Identifier unique to each Carrot session (differs for each time you open Carrot)
    pub session_id: Option<String>,
    pub metrics_id: Option<String>,
    /// True for Carrot staff, otherwise false
    #[serde(skip_serializing_if = "Option::is_none")]
    pub is_staff: Option<bool>,
    /// Carrot version number
    pub app_version: String,
    pub os_name: String,
    pub os_version: Option<String>,
    pub architecture: String,
    /// Carrot release channel (stable, preview, dev)
