...
use carrot_workspace::{AppState, OpenVisible, Workspace};
use chrono::{Datelike, Local, NaiveTime, Timelike};
use inazuma::{App, AppContext as _, Context, Window, actions};
pub use inazuma_settings_framework::HourFormat;
...
impl inazuma_settings_framework::Settings for JournalSettings {
