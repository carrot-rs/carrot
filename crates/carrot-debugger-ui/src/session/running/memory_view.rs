...
use carrot_project::debugger::{MemoryCell, dap_command::DataBreakpointContext, session::Session};
...
impl Focusable for MemoryView {
    fn focus_handle(&self, _: &carrot_ui::App) -> FocusHandle {
...
impl ScrollableHandle for ViewStateHandle {
    fn max_offset(&self) -> inazuma::Point<Pixels> {
    ...
    fn viewport(&self) -> inazuma::Bounds<Pixels> {
...
fn render_single_memory_view_line(
    memory: &[MemoryCell],
    ix: u64,
    weak: inazuma::WeakEntity<MemoryView>,
    cx: &mut App,
) -> AnyElement {
        ...
        v_flex()
                        ...
                        h_flex()
                            ...
                            .child(
                                div()
                                    ...
                                    .child(Icon::new(icon).size(carrot_ui::IconSize::XSmall))
            ...
            .child(
                v_flex()
                    ...
                    .custom_scrollbars(
                        carrot_ui::Scrollbars::new(carrot_ui::ScrollAxes::Both)
                            .tracked_scroll_handle(&self.view_state_handle)
                            .with_track_along(
                                carrot_ui::ScrollAxes::Both,
