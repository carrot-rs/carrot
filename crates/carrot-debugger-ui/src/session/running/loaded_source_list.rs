use carrot_project::debugger::session::{Session, SessionEvent};
use carrot_ui::prelude::*;
use inazuma::{AnyElement, Empty, Entity, FocusHandle, Focusable, ListState, Subscription, list};
...
impl LoadedSourceList {
    pub fn new(session: Entity<Session>, cx: &mut Context<Self>) -> Self {
        ...
        let list = ListState::new(0, inazuma::ListAlignment::Top, px(1000.));
