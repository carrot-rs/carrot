...
use carrot_dap::requests::StackTrace;
...
async fn test_handle_output_event(executor: BackgroundExecutor, cx: &mut TestAppContext) {
    ...
    client
        .fake_event(carrot_dap::messages::Events::Output(
            carrot_dap::OutputEvent {
                category: None,
    ...
    client
        .fake_event(carrot_dap::messages::Events::Output(
            carrot_dap::OutputEvent {
                category: Some(carrot_dap::OutputEventCategory::Stdout),
    ...
    client
        .fake_event(carrot_dap::messages::Events::Output(
            carrot_dap::OutputEvent {
                category: Some(carrot_dap::OutputEventCategory::Console),
...
async fn test_escape_code_processing(executor: BackgroundExecutor, cx: &mut TestAppContext) {
    ...
    client
        ...
        .await;
    client
        .fake_event(carrot_dap::messages::Events::Output(carrot_dap::OutputEvent {
            category: None,
...
//             carrot_dap::test_config(carrot_dap::DebugRequestType::Launch, None, None),
//             cx,
//         )
//     });
...
//     client
//         .fake_event(carrot_dap::messages::Events::Stopped(carrot_dap::StoppedEvent {
//             reason: carrot_dap::StoppedEventReason::Pause,
//             description: None,
//             thread_id: Some(1),
//             preserve_focus_hint: None,
...
//             line: None,
//             column: None,
//             group: Some(carrot_dap::OutputEventGroup::Start),
//             location_reference: None,
//         }))
//         .await;
...
//             line: None,
//             column: None,
//             group: Some(carrot_dap::OutputEventGroup::End),
//             location_reference: None,
//         }))
//         .await;
...
//             line: None,
//             column: None,
//             group: Some(carrot_dap::OutputEventGroup::StartCollapsed),
//             location_reference: None,
//         }))
//         .await;
...
//     let task = project.update(cx, |project, cx| {
//         project.start_debug_session(carrot_dap::test_config(None), cx)
//     });
...
//                 4 => Ok(carrot_dap::VariablesResponse {
//                     variables: (*scope2_variables).clone(),
//                 }),
//                 3 => Ok(carrot_dap::VariablesResponse {
//                     variables: (*nested_variables).clone(),
//                 }),
//                 2 => Ok(carrot_dap::VariablesResponse {
...
//                 assert_eq!(Some(carrot_dap::EvaluateArgumentsContext::Variables), args.context);
