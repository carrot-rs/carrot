...
use carrot_dap::{Scope, StackFrame, Variable, requests::Variables};
use carrot_editor::{Editor, EditorMode, MultiBuffer};
use carrot_language::{
...
async fn test_rust_inline_values(executor: BackgroundExecutor, cx: &mut TestAppContext) {
    ...
    fn stack_frame_for_line(line: u64) -> carrot_dap::StackFrame {
        StackFrame {
            id: 1,
...
"#
    ...
    client.on_request::<carrot_dap::requests::StackTrace, _>(move |_, _| {
    ...
    client.on_request::<carrot_dap::requests::Evaluate, _>(move |_, args| {
    ...
    client.on_request::<Variables, _>({
        ...
        move |_, _| {
            Ok(carrot_dap::VariablesResponse {
...
"#
    ...
    client.on_request::<carrot_dap::requests::StackTrace, _>(move |_, args| {
    ...
    client.on_request::<Variables, _>(move |_, args| match args.variables_reference {
        1 => Ok(carrot_dap::VariablesResponse {
            variables: vec![
                Variable {
        ...
        _ => Ok(carrot_dap::VariablesResponse { variables: vec![] }),
    });
...
fn python_lang() -> Language {
    let debug_variables_query = include_str!("../../../carrot-grammars/src/python/debugger.scm");
    Language::new(
        LanguageConfig {
            name: "Python".into(),
...
fn go_lang() -> Arc<Language> {
    let debug_variables_query = include_str!("../../../carrot-grammars/src/go/debugger.scm");
    Arc::new(
        Language::new(
            LanguageConfig {
                name: "Go".into(),
...
async fn test_inline_values_util(
    ...
    client.on_request::<carrot_dap::requests::Threads, _>(|_, _| {
        Ok(carrot_dap::ThreadsResponse {
            threads: vec![carrot_dap::Thread {
                id: 1,
                name: "main".into(),
    ...
    client.on_request::<Variables, _>({
        ...
        move |_, args| {
            ...
            Ok(carrot_dap::VariablesResponse { variables })
        }
    });
...
fn javascript_lang() -> Arc<Language> {
    let debug_variables_query =
        include_str!("../../../carrot-grammars/src/javascript/debugger.scm");
    Arc::new(
        Language::new(
            LanguageConfig {
...
fn typescript_lang() -> Arc<Language> {
    let debug_variables_query =
        include_str!("../../../carrot-grammars/src/typescript/debugger.scm");
    Arc::new(
        Language::new(
            LanguageConfig {
...
fn tsx_lang() -> Arc<Language> {
    let debug_variables_query = include_str!("../../../carrot-grammars/src/tsx/debugger.scm");
    Arc::new(
        Language::new(
            LanguageConfig {
                name: "TSX".into(),
