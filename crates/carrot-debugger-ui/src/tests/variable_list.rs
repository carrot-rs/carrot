...
use inazuma_menu::{SelectFirst, SelectNext, SelectPrevious};
...
async fn test_fetch_variables_for_multiple_scopes(
    ...
    let scopes = vec![
        Scope {
            name: "Scope 1".into(),
            presentation_hint: Some(carrot_dap::ScopePresentationHint::Locals),
            variables_reference: 2,
            named_variables: None,
            indexed_variables: None,
            expensive: false,
    ...
    running_state.update(cx, |running_state, cx| {
        ...
        running_state
            ...
            .update(cx, |variable_list, _| {
                ...
                // scope 2
                let empty_vec: Vec<carrot_dap::Variable> = vec![];
