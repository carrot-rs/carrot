...
async fn test_module_list(executor: BackgroundExecutor, cx: &mut TestAppContext) {
    ...
    let modules = vec![
        carrot_dap::Module {
            id: carrot_dap::ModuleId::Number(1),
        ...
        carrot_dap::Module {
            id: carrot_dap::ModuleId::Number(2),
    ...
    client
        .fake_event(carrot_dap::messages::Events::Stopped(StoppedEvent {
    ...
    let new_module = carrot_dap::Module {
        id: carrot_dap::ModuleId::Number(3),
    ...
    client
        .fake_event(carrot_dap::messages::Events::Module(
            carrot_dap::ModuleEvent {
                reason: carrot_dap::ModuleEventReason::New,
    ...
    let changed_module = carrot_dap::Module {
        id: carrot_dap::ModuleId::Number(2),
    ...
    client
        .fake_event(carrot_dap::messages::Events::Module(
            carrot_dap::ModuleEvent {
                reason: carrot_dap::ModuleEventReason::Changed,
    ...
    client
        .fake_event(carrot_dap::messages::Events::Module(
            carrot_dap::ModuleEvent {
                reason: carrot_dap::ModuleEventReason::Removed,
                module: changed_module.clone(),
            },
        ))
        .await;
