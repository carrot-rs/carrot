//! # UI – Carrot UI Primitives & Components
//!
//! This crate provides a set of UI primitives and components that are used to build all of the elements in Carrot's UI.
//!
//! ## Related Crates:
//!
