...
use inazuma::Transformation;
use inazuma::{App, IntoElement, Rems, RenderOnce, Size, Styled, Window, svg};
                ...
                .children(vec![
                    example_group_with_title(
                        ...
                        vec![
                            single_example(
                                "Default",
                                Vector::square(VectorName::CarrotLogo, size).into_any_element(),
                            ),
                            single_example(
                                "Custom Size",
                                h_flex()
                    ...
                    example_group_with_title(
                        ...
                        vec![
                            single_example(
                                "Accent Color",
                                Vector::square(VectorName::CarrotLogo, size)
                                    .color(Color::Accent)
                                    .into_any_element(),
                            ),
                            single_example(
                    ...
                    example_group_with_title(
                        ...
                        vec![single_example(
                            "Carrot X Copilot",
                            Vector::square(VectorName::CarrotXCopilot, rems_from_px(100.))
                                .into_any_element(),
                        )],
                    ),
                ])
...
mod tests {
    ...
    fn vector_path() {
        assert_eq!(
            VectorName::CarrotLogo.path().as_ref(),
            "images/carrot_logo.svg"
        );
    }
}
