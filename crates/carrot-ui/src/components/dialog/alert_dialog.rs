...
///
/// ```ignore
/// use inazuma_component::{AlertDialog, alert::AlertVariant};
///
...
///
/// ```ignore
/// use inazuma_component::{AlertDialog, DialogHeader, DialogTitle, DialogDescription, DialogFooter};
///
/// AlertDialog::new(cx)
...
impl AlertDialog {
    ...
    where
        F: Fn(crate::DialogContent, &mut Window, &mut App) -> crate::DialogContent + 'static,
    {
