...
use inazuma::{
    ...
    FocusHandle, InteractiveElement, IntoElement, KeyBinding, MouseButton, Oklch, ParentElement,
...
pub(crate) fn overlay_color(overlay: bool, cx: &App) -> Oklch {
    ...
    Oklch {
        ...
        c: 0.0,
        h: 0.0,
        a: if cx.theme().is_dark() { 0.6 } else { 0.4 },
    }
}
...
impl RenderOnce for Dialog {
    fn render(mut self, window: &mut Window, cx: &mut App) -> impl IntoElement {
        ...
        let window_paddings = crate::utils::window_border::window_paddings(window);
        ...
        let animation = Animation::new(*ANIMATION_DURATION).with_easing(inazuma::ease_in_out);
