...
/// Pending dialog queue — carrot-ui pushes, carrot-shell's AppShell drains.
///
/// This decouples dialog opening from AppShell: carrot-ui components can queue
/// dialogs without knowing about AppShell (which lives in carrot-shell).
