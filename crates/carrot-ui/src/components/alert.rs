...
use inazuma::{
    App, ClickEvent, ElementId, Empty, InteractiveElement, IntoElement, Oklch, ParentElement as _,
...
impl AlertVariant {
    fn fg(&self, cx: &App) -> Oklch {
        match self {
            ...
            Self::Error => cx.theme().status().error.color,
        }
    }
    ...
    fn bg(&self, cx: &App) -> Oklch {
        match self {
            ...
            Self::Info => cx
                ...
                .info
                .color
                .mix_oklab(transparent_white(), 0.04),
            Self::Success => cx
                .theme()
                .status()
                .success
    ...
    fn border_color(&self, cx: &App) -> Oklch {
        match self {
            ...
            Self::Info => cx
                ...
                .info
                .color
                .mix_oklab(transparent_white(), 0.3),
            Self::Success => cx
                .theme()
                .status()
                .success
...
impl RenderOnce for Alert {
    fn render(self, _: &mut Window, cx: &mut App) -> impl IntoElement {
        ...
        let (radius, padding_x, padding_y, gap) = match self.size {
            Size::XSmall => (cx.theme().colors().radius, px(12.), px(6.), px(6.)),
            Size::Small => (cx.theme().colors().radius, px(12.), px(8.), px(6.)),
            Size::Large => (cx.theme().colors().radius_lg(), px(20.), px(14.), px(12.)),
            _ => (cx.theme().colors().radius, px(16.), px(10.), px(12.)),
        };
