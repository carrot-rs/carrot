...
use inazuma::{
    Animation, AnimationExt as _, App, IntoElement, Oklch, ParentElement, RenderOnce, Window, div,
    ease_in_out, prelude::FluentBuilder as _,
};
...
impl Spinner {
    ...
    pub fn new() -> Self {
        Self {
            ...
            icon: Icon::new(IconName::LoadCircle),
            color: None,
        }
    }
    ...
    ///
    /// Default is [`IconName::LoadCircle`].
    ///
            ...
            .child(
                self.icon
                    ...
                    .with_animation(
                        ...
                        |this, delta| this.rotate(inazuma::Radians(delta * std::f32::consts::TAU)),
                    ),
            )
            .into_element()
    }
