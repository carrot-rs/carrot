use crate::{
    ActiveTheme, Button, ButtonVariants, Collapsible, Icon, IconName, ScrollableElement, Side,
    Sizable, StyledExt, h_flex, v_flex,
};
use inazuma::{
...
impl SidebarToggleButton {
    ...
    pub fn new() -> Self {
        Self {
            btn: Button::with_id("collapse").ghost().small(),
            collapsed: false,
            side: Side::Left,
            on_click: None,
        }
