...
use inazuma::{
    App, Bounds, Element, ElementId, ElementInputHandler, Entity, GlobalElementId, Half, Hitbox,
    IntoElement, LayoutId, MouseButton, MouseMoveEvent, Oklch, Path, Pixels, Point, ShapedLine,
    SharedString, Size, Style, TextAlign, TextRun, UnderlineStyle, Window, fill, px, relative,
    size,
};
use ropey::Rope;
...
use crate::{ActiveTheme as _, input::RopeExt as _};
...
impl Element for TextElement {
    ...
    fn paint(
        ...
        if focused {
            Self::paint_inline_completion_suffix(
                prepaint,
                cursor_row_y,
                text_align,
                line_height,
