...
use inazuma::{
    AnyElement, App, AppContext, Entity, FocusHandle, IntoElement, Subscription, Window,
};

use crate::input::{Input, InputEvent, InputState};
use crate::{ERASED_EDITOR_FACTORY, ErasedEditor, ErasedEditorEvent};
...
/// Register the `InputState`-based editor factory on the carrot-ui ERASED_EDITOR_FACTORY.
