...
use crate::{
    ActiveTheme, Button, ButtonVariants, Color, Disableable, ElementExt, IconName, Label,
    LabelCommon, Selectable, Sizable,
    actions::SelectUp,
    h_flex,
    input::{
                ...
                h_flex()
                        ...
                        div()
                            ...
                            .child(
                                Input::new(&self.search_input)
                                    ...
                                    .suffix(
                                        Button::with_id("case-insensitive")
                    ...
                    .child(
                        Label::new(self.matcher.label())
                            .when(!has_matches, |this| LabelCommon::color(this, Color::Muted)),
                    )
                    .child(div().w_7())
                    .child(
