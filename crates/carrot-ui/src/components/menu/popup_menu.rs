...
use inazuma::{
    ...
    ScrollHandle, SharedString, Subscription, WeakEntity, Window, prelude::FluentBuilder,
};
use std::rc::Rc;

use crate::utils::actions::Confirm;
...
pub fn init(cx: &mut App) {
    cx.bind_keys([
        ...
        KeyBinding::new("up", crate::utils::actions::SelectUp, Some(CONTEXT)),
        KeyBinding::new("down", crate::utils::actions::SelectDown, Some(CONTEXT)),
        KeyBinding::new("left", crate::utils::actions::SelectLeft, Some(CONTEXT)),
        KeyBinding::new("right", crate::utils::actions::SelectRight, Some(CONTEXT)),
    ]);
}
