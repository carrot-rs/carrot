use crate::Side;
use crate::utils::actions::{Cancel, Confirm, SelectDown, SelectLeft, SelectRight, SelectUp};
use inazuma::{
...
impl PopupMenu {
    ...
    pub(super) fn dismiss(&mut self, _: &Cancel, window: &mut Window, cx: &mut Context<Self>) {
