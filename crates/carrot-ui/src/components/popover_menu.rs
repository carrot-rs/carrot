...
impl<T: Clickable> Clickable for inazuma::AnimationElement<T>
where
    T: Clickable + 'static,
{
    fn on_click(
    ...
    fn cursor_style(self, cursor_style: inazuma::CursorStyle) -> Self {
        self.map_element(|e| e.cursor_style(cursor_style))
    }
}

impl<T: Toggleable> Toggleable for inazuma::AnimationElement<T>
where
    T: Toggleable + 'static,
{
        ...
        self.child_builder = Some(Box::new(move |menu, builder| {
            ...
            t.toggle_state(open)
                .when_some(builder, |el, builder| {
                    ...
                    .when(!open, |t: T| {
                        ButtonCommon::button_tooltip(t, move |window, cx| {
                            tooltip_builder(window, cx)
                        })
                    })
                })
                .into_any_element()
