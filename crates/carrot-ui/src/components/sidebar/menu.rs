...
use crate::{
    ActiveTheme as _, Button, ButtonVariants as _, Collapsible, ContextMenuExt, Icon, IconName,
    PopupMenu, Sizable as _, StyledExt, h_flex, v_flex,
};
use inazuma::{
            ...
            .child(
                h_flex()
                    ...
                    .when(is_hoverable, |this| {
                        this.hover(|this| {
                            this.bg(cx.theme().colors().accent.opacity(0.8))
