use inazuma::{AnyElement, SharedUri, prelude::*};
            ...
            single_example(
                ...
                container()
                    .child(
                        ...
                        .child(Label::new("carrot").color(Color::Muted)),
                    )
                    .into_any_element(),
            ),
            single_example(
                ...
                container()
                    .child(
                        ...
                        .child(Label::new(
                            "a_very_long_username_that_might_overflow is sharing a project in Carrot:",
                        ))
                        .child(
                            Label::new("carrot-cloud, carrot, edit-prediction-bench, carrot.dev")
                                .color(Color::Muted),
                        ),
                    )
                    .into_any_element(),
