use inazuma::{AnyElement, ParentElement, RenderOnce, StyleRefinement};
use smallvec::SmallVec;

use crate::{Disableable, ListItem, Selectable, StyledExt};
...
impl RenderOnce for ListSeparatorItem {
    fn render(self, _: &mut inazuma::Window, _: &mut inazuma::App) -> impl inazuma::IntoElement {
