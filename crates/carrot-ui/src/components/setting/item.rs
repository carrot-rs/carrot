...
use super::fields::{BoolField, DropdownField, NumberField, SettingFieldRender, StringField};
use crate::{
    ActiveTheme as _, AnySettingField, AxisExt, ElementField, Label, LabelCommon as _,
    RenderOptions, StyledExt as _, Text, v_flex,
};
                ...
                SettingItem::Item {
                    ...
                    .child(
                        v_flex()
                            ...
                            .gap_1()
                            .child(Label::new(title.clone()).size(crate::LabelSize::Small))
