use crate::{
    GroupBoxVariant, Icon, IconName, Input, InputState, SettingGroup, SettingPage, Sidebar,
    SidebarMenu, SidebarMenuItem, Sizable, Size, StyledExt, h_resizable, resizable_panel,
};
use carrot_i18n::t;
use inazuma::{
        ...
        Sidebar::new("settings-sidebar")
            ...
            .header(
                div()
                    ...
                    .child(Input::new(&search_input).prefix(Icon::new(IconName::MagnifyingGlass))),
            )
            .child(
