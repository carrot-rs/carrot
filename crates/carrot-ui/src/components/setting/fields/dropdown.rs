...
use crate::{AnySettingField, AxisExt, Button, PopupMenuItem, RenderOptions, Sizable, StyledExt};
    ...
    T: Into<SharedString> + From<SharedString> + Clone + 'static,
{
    fn render(
        ...
        Button::with_id("btn")
            ...
            .refine_style(style)
            .dropdown_menu_with_anchor(Corner::TopRight, move |menu: crate::PopupMenu, _, _| {
