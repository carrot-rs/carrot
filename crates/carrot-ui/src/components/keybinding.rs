...
use inazuma_settings_framework::KeybindSource;
...
impl RenderOnce for KeyBinding {
    fn render(self, window: &mut Window, cx: &mut App) -> impl IntoElement {
        ...
        .unwrap_or_else(|| inazuma::Empty.into_any_element())
    }
}
...
impl Component for KeyBinding {
    ...
    //                                 inazuma::KeyBinding::new("ctrl-s", inazuma::NoAction, None),
    //                                 cx,
    //                             )
    //                             .into_any_element(),
    //                         ),
    ...
    //                             "Mac Style",
    //                             KeyBinding::new_from_gpui(
    //                                 inazuma::KeyBinding::new("cmd-s", inazuma::NoAction, None),
    //                                 cx,
    //                             )
    ...
    //                         "Vim Mode Enabled",
    //                         KeyBinding::new_from_gpui(
    //                             inazuma::KeyBinding::new("dd", inazuma::NoAction, None),
    //                             cx,
    //                         )
    //                         .vim_mode(true)
    //                         .into_any_element(),
    ...
    //                             "Multiple Keys",
    //                             KeyBinding::new_from_gpui(
    //                                 inazuma::KeyBinding::new("ctrl-k ctrl-b", inazuma::NoAction, None),
    //                                 cx,
    //                             )
    //                             .into_any_element(),
    //                         ),
    ...
    //                             "With Shift",
    //                             KeyBinding::new_from_gpui(
    //                                 inazuma::KeyBinding::new("shift-cmd-p", inazuma::NoAction, None),
    //                                 cx,
    //                             )
    //                             .into_any_element(),
    //                         ),
