...
use crate::prelude::*;
use carrot_theme::Appearance;
use inazuma::{AnyElement, App, BoxShadow, FontStyle, IntoElement, Oklch, Window, point};
...
///
/// ```no_run
/// use inazuma::{App, Oklch, KeybindingKeystroke, Keystroke};
/// use carrot_ui::prelude::*;
/// use carrot_ui::{KeyBinding, KeybindingHint};
...
impl KeybindingHint {
    ...
    /// # }
    /// ```
    pub fn new(keybinding: KeyBinding, background_color: Oklch) -> Self {
        Self {
            prefix: None,
            suffix: None,
            keybinding,
