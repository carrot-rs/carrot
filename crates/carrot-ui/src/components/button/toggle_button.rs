...
use inazuma::{AnyView, ClickEvent, relative};
...
fn register_toggle_button_group() {
    inazuma_component_registry::register_component::<ToggleButtonGroup<ToggleButtonSimple>>();
}

inazuma_component_registry::__private::inventory::submit! {
    inazuma_component_registry::ComponentFn::new(register_toggle_button_group)
}
