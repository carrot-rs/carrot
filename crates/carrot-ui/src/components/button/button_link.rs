use inazuma::{IntoElement, Window, prelude::*};

use crate::{ButtonLike, prelude::*};

/// A button that takes an underline to look like a regular web link.
/// It also contains an arrow icon to communicate the link takes you out of Carrot.
///
/// # Usage Example
///
/// ```
/// use carrot_ui::ButtonLink;
///
            ...
            v_flex()
                ...
                .child(
                    example_group(vec![single_example(
                        "Simple",
                        ButtonLink::new("carrot.dev", "https://carrot.dev").into_any_element(),
                    )])
                    .vertical(),
                )
                .into_any_element(),
