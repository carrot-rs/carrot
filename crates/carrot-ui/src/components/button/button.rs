...
use carrot_ui_macros::RegisterComponent;
use inazuma::{
        ...
        base.child(
            h_flex()
                ...
                .when_some(self.icon, |this, icon| {
                    let icon = icon.loading_icon(self.loading_icon).loading(self.loading);
    ...
    fn render(mut self, window: &mut Window, cx: &mut App) -> impl IntoElement {
        ...
        match dropdown_menu {
            Some(builder) => {
                ...
                let popover_id = SharedString::from(format!("button-dropdown:{:?}", button_id));
                let menu_state = window
                    .use_keyed_state(popover_id.clone(), cx, |_, _| ButtonMenuState::default());
                ...
                .children(vec![
                    example_group_with_title(
                        ...
                        vec![
                            ...
                            single_example(
                                "Ghost",
                                Button::new("ghost", "Ghost").ghost().into_any_element(),
                            ),
                            single_example(
                                "Link",
                    ...
                    example_group_with_title(
                        ...
                        vec![
                            single_example(
                                "Info",
                                Button::new("info", "Info").info().into_any_element(),
                            ),
                            single_example(
                                "Warning",
