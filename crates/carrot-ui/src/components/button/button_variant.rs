...
// ---------------------------------------------------------------------------
// TintColor — backwards compat for the original Carrot API
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// ButtonVariant — Carrot-style resolution (ButtonLikeStyles)
// ---------------------------------------------------------------------------
...
impl ButtonVariant {
    ...
    pub fn enabled(self, elevation: Option<ElevationIndex>, cx: &mut App) -> ButtonLikeStyles {
        match self {
            ...
            | ButtonVariant::Success => tint_for_variant(&self, cx).unwrap().button_like_style(cx),
