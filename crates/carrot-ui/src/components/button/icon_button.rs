...
impl IconButton {
    ...
    /// Anchor the tooltip relative to the button (e.g.
    /// `TooltipPlacement::BelowElement` for header controls).
    pub fn tooltip_placement(mut self, placement: inazuma::TooltipPlacement) -> Self {
        self.base = self.base.tooltip_placement(placement);
        self
    }
}
...
impl Clickable for IconButton {
    ...
    fn cursor_style(mut self, cursor_style: inazuma::CursorStyle) -> Self {
