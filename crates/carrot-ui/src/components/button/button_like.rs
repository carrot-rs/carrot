...
use inazuma::{
    ...
    MouseClickEvent, MouseDownEvent, MouseUpEvent, Oklch, StyleRefinement, TooltipPlacement,
    relative,
};
...
impl ButtonLike {
    ...
    /// Place the tooltip relative to the button element (e.g.
    /// `TooltipPlacement::BelowElement`). Default behaviour attaches the
    /// tooltip to the mouse cursor position.
...
impl RenderOnce for ButtonLike {
    fn render(self, _: &mut Window, cx: &mut App) -> impl IntoElement {
        ...
        self.base
            ...
            .when_some(self.tooltip_placement, |this, placement| {
                this.tooltip_placement(placement)
            })
