...
use inazuma::{
    ...
    MouseButton, MouseDownEvent, Oklch, ParentElement as _, Pixels, Point, Render, RenderOnce,
...
pub enum SliderScale {
    ...
    ///
    /// ```
    /// use inazuma_component::slider::{SliderState, SliderScale};
    ///
...
impl Slider {
    ...
    fn render_thumb(
        ...
        div()
            ...
            .when(cx.theme().is_dark(), |this| this.shadow_md())
            .size_4()
            .p(px(1.))
            .child(
                div()
...
impl RenderOnce for Slider {
    fn render(self, window: &mut Window, cx: &mut inazuma::App) -> impl IntoElement {
        ...
        let bar_color = self
            ...
            .unwrap_or(cx.theme().colors().element_background.into());
                        ...
                        div()
                            ...
                            .child(
                                div()
                                    ...
                                    .bg(bar_color)
                                    .when(!cx.theme().colors().radius.is_zero(), |this| {
                                        this.rounded_full()
                                    }),
                            )
                            .when(is_range, |this| {
