...
use crate::{
    Disableable as _, ListItem, ScrollableElement, Selectable as _, StyledExt,
...
impl TreeState {
    ...
    pub fn scroll_to_item(&mut self, ix: usize, strategy: inazuma::ScrollStrategy) {
    ...
    fn on_action_up(&mut self, _: &SelectUp, _: &mut Window, cx: &mut Context<Self>) {
        ...
        self.scroll_handle
            .scroll_to_item(selected_ix, inazuma::ScrollStrategy::Top);
        cx.notify();
    }
    ...
    fn on_action_down(&mut self, _: &SelectDown, _: &mut Window, cx: &mut Context<Self>) {
        ...
        self.selected_ix = Some(selected_ix);
        self.scroll_handle
            .scroll_to_item(selected_ix, inazuma::ScrollStrategy::Bottom);
        cx.notify();
    }
...
mod tests {
    ...
    #[inazuma::test]
    fn test_tree_entry(cx: &mut inazuma::TestAppContext) {
        use super::TreeItem;
