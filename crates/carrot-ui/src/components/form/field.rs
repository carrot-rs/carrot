...
pub struct FieldProps {
    ...
    pub label_width: Option<Pixels>,
    pub label_text_size: Option<Rems>,
}
...
impl Field {
    ...
    pub fn props(mut self, ix: usize, props: FieldProps) -> Self {
        self.id = ix.into();
        self.props = props;
        self
    }
                                    ...
                                    this.child(
                                        h_flex()
                                            ...
                                            .when(self.required, |this| {
                                                this.child(
                                                    div()
                                                        .text_color(cx.theme().status().error.color)
                                                        .child("*"),
                                                )
                                            }),
                                    )
