...
use inazuma::{IntoElement, Oklch, Point, svg};
...
pub struct IconDecoration {
    ...
    color: Oklch,
    knockout_color: Oklch,
    knockout_hover_color: Oklch,
    size: Pixels,
...
impl IconDecoration {
    ...
    pub fn new(kind: IconDecorationKind, knockout_color: Oklch, cx: &App) -> Self {
    ...
    /// on.
    pub fn knockout_color(mut self, color: Oklch) -> Self {
        self.knockout_color = color;
        self
    }

    /// Sets the color of the decoration that is used on hover.
    pub fn knockout_hover_color(mut self, color: Oklch) -> Self {
