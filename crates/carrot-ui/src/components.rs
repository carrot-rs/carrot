// ── Existing carrot-ui components ─────────────────────────────────────────────
mod ai;
// app_shell moved to carrot-shell crate
mod avatar;
mod banner;
mod button;
mod callout;
...
// ── Re-exports: existing carrot-ui ───────────────────────────────────────────
pub use ai::*;
// AppShell re-exported from carrot-shell crate
pub use avatar::*;
pub use banner::*;
pub use button::*;
pub use callout::*;
...
pub use pagination::*;
pub use plot::{
    AXIS_GAP, AxisText, Grid, IntoPlot, Plot, PlotAxis, PlotLabel, StrokeStyle, origin_point,
    polygon,
};
pub use radio::*;
pub use rating::*;
