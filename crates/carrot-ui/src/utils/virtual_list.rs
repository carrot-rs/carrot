...
//! https://github.com/carrot-rs/carrot/blob/0ae1603610ab6b265bdfbee7b8dbc23c5ab06edc/crates/gpui/src/elements/uniform_list.rs
//!
...
impl VirtualList {
    ...
    fn scroll_to_deferred_item(
        ...
        match scroll_to_item.strategy {
            ...
            _ => {
                // Ref: https://github.com/carrot-rs/carrot/blob/0d145289e0867a8d5d63e5e1397a5ca69c9d49c3/crates/gpui/src/elements/div.rs#L3026
                if self.axis.is_vertical() {
    ...
    /// Ref from: https://github.com/carrot-rs/carrot/blob/83f9f9d9e3f5914392cab9a09e3472711a1d7b38/crates/gpui/src/elements/uniform_list.rs#L660
    fn measure_item(
        &self,
...
impl Element for VirtualList {
    ...
    fn request_layout(
        ...
        inspector_id: Option<&inazuma::InspectorElementId>,
        window: &mut Window,
        cx: &mut App,
