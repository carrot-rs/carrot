// From:
// https://github.com/carrot-rs/carrot/blob/56daba28d40301ee4c05546fadb691d070b7b2b6/crates/gpui/examples/window_shadow.rs
use inazuma::{
                        ...
                        Decorations::Client { tiling } => div
                            ...
                            .when(!tiling.is_tiled(), |div| {
                                div.shadow(vec![inazuma::BoxShadow {
                                    color: inazuma::Oklch::black().opacity(0.3),
