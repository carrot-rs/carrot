...
impl RenderOnce for Headline {
    fn render(self, _window: &mut Window, cx: &mut App) -> impl IntoElement {
        let ui_font = carrot_theme::theme_settings(cx).ui_font(cx).clone();
