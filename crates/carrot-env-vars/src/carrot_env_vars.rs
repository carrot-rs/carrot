...
/// Whether Carrot is running in stateless mode.
/// When true, Carrot will use in-memory databases instead of persistent storage.
pub static CARROT_STATELESS: LazyLock<bool> = bool_env_var!("CARROT_STATELESS");
