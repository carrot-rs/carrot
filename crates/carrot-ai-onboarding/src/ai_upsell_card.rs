...
use carrot_ui::{CommonAnimationExt, Divider, Vector, VectorName, prelude::*};
    ...
    fn render(self, _window: &mut Window, cx: &mut App) -> impl IntoElement {
        ...
        let gradient_bg = div()
            ...
            .bg(inazuma::linear_gradient(
                180.,
                inazuma::linear_color_stop(cx.theme().colors().elevated_surface.opacity(0.8), 0.),
                inazuma::linear_color_stop(cx.theme().colors().elevated_surface.opacity(0.), 0.8),
            ));
        ...
        match self.sign_in_status {
            SignInStatus::SignedIn => match self.user_plan {
                None | Some(Plan::CarrotFree) => card
                    .child(Label::new("Try Carrot AI").size(LabelSize::Large))
                    .map(|this| {
                                    ...
                                    .child(
                                        Button::new("pro", "Get Started")
                                            ...
                                            .on_click(move |_, _window, cx| {
                                                ...
                                                cx.open_url(
                                                    &carrot_urls::upgrade_to_carrot_pro_url(cx),
                                                )
                                            }),
                                    ),
                            )
                ...
                Some(Plan::CarrotProTrial) => card
                    .child(pro_trial_stamp)
                    .child(Label::new("You're in the Carrot Pro Trial").size(LabelSize::Large))
                    .child(
                ...
                Some(Plan::CarrotPro) => card
                    .child(certified_user_stamp)
                    .child(Label::new("You're in the Carrot Pro plan").size(LabelSize::Large))
                    .child(
                    ...
                    .child(PlanDefinitions.pro_plan()),
                Some(Plan::CarrotBusiness) => card
                    .child(certified_user_stamp)
                    .child(Label::new("You're in the Carrot Business plan").size(LabelSize::Large))
                    .child(
                        Label::new("Here's what you get:")
                            .color(Color::Muted)
                            .mb_2(),
                ...
                Some(Plan::CarrotStudent) => card
                    .child(certified_user_stamp)
                    .child(Label::new("You're in the Carrot Student plan").size(LabelSize::Large))
                    .child(
                        Label::new("Here's what you get:")
                            .color(Color::Muted)
                            .mb_2(),
...
impl Component for AiUpsellCard {
    ...
    fn description() -> Option<&'static str> {
        Some("A card presenting the Carrot AI product during user's first-open onboarding flow.")
    }
                    ...
                    vec![
                        single_example(
                            ...
                            AiUpsellCard {
                                ...
                                sign_in: Arc::new(|_, _| {}),
                                account_too_young: false,
                                user_plan: Some(Plan::CarrotFree),
                                tab_index: Some(1),
                            }
                            .into_any_element(),
                        ),
                        ...
                        single_example(
                            ...
                            AiUpsellCard {
                                ...
                                sign_in: Arc::new(|_, _| {}),
                                account_too_young: false,
                                user_plan: Some(Plan::CarrotProTrial),
                                tab_index: Some(1),
                            }
                            .into_any_element(),
                        ),
                        ...
                        single_example(
                            ...
                            AiUpsellCard {
                                ...
                                sign_in: Arc::new(|_, _| {}),
                                account_too_young: false,
                                user_plan: Some(Plan::CarrotBusiness),
                                tab_index: Some(1),
                            }
                            .into_any_element(),
                        ),
                        single_example(
                            ...
                            AiUpsellCard {
                                ...
                                sign_in: Arc::new(|_, _| {}),
                                account_too_young: false,
                                user_plan: Some(Plan::CarrotStudent),
                                tab_index: Some(1),
                            }
                            .into_any_element(),
                        ),
