use carrot_actions;
use carrot_language_model::{IconOrSvg, LanguageModelRegistry, ZED_CLOUD_PROVIDER_ID};
use carrot_ui::{Divider, List, ListBulletItem, prelude::*};
    ...
    fn render(&mut self, _window: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        div()
            ...
            .shadow(vec![inazuma::BoxShadow {
                color: inazuma::black().opacity(0.15),
            ...
            .child(
                Button::new("configure-providers", "Configure Providers")
                    ...
                    .on_click(move |_, window, cx| {
                        window
                            .dispatch_action(carrot_actions::agent::OpenSettings.boxed_clone(), cx);
                    }),
            )
    }
}
