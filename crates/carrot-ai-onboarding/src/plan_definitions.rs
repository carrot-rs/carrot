use carrot_ui::{List, ListBulletItem, prelude::*};
use inazuma::{IntoElement, ParentElement};

/// Centralized definitions for Carrot AI plans
pub struct PlanDefinitions;

impl PlanDefinitions {
    pub const AI_DESCRIPTION: &'static str = "Carrot offers a complete agentic experience, with robust editing and reviewing features to collaborate with AI.";
