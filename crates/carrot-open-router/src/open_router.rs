...
pub use inazuma_settings_framework::DataCollection;
pub use inazuma_settings_framework::ModelMode;
pub use inazuma_settings_framework::OpenRouterAvailableModel as AvailableModel;
pub use inazuma_settings_framework::OpenRouterProvider as Provider;
...
pub async fn stream_completion(
    ...
    let request_builder = HttpRequest::builder()
        ...
        .header("HTTP-Referer", "https://carrot.dev")
        .header("X-Title", "Carrot Editor");
