...
pub struct DebuggerSettings {
    ...
    ///
    /// Default: Bottom
    pub dock: inazuma_settings_framework::DockPosition,
}
...
fn dap_granularity_from_settings(
    granularity: inazuma_settings_framework::SteppingGranularity,
) -> dap_types::SteppingGranularity {
    match granularity {
        inazuma_settings_framework::SteppingGranularity::Instruction => {
            dap_types::SteppingGranularity::Instruction
        }
        inazuma_settings_framework::SteppingGranularity::Line => {
            dap_types::SteppingGranularity::Line
        }
        inazuma_settings_framework::SteppingGranularity::Statement => {
            dap_types::SteppingGranularity::Statement
        }
    }
}
