...
use carrot_cloud_api_types::ExtensionMetadata;
use carrot_extension_host::ExtensionStore;
use carrot_fs::Fs;
use carrot_ui::{HighlightedLabel, ListItem, ListItemSpacing, prelude::*};
use carrot_workspace::ModalView;
use inazuma::{App, DismissEvent, Entity, EventEmitter, Focusable, Task, WeakEntity};
...
impl PickerDelegate for ExtensionVersionSelectorDelegate {
    ...
    fn confirm(&mut self, _secondary: bool, window: &mut Window, cx: &mut Context<Picker<Self>>) {
        ...
        if !carrot_extension_host::is_version_compatible(extension_version) {
            return;
        }
    ...
    fn render_match(
        ...
        let is_version_compatible = carrot_extension_host::is_version_compatible(extension_version);
