...
use inazuma::{AppContext, Focusable as _, TestAppContext, TestDispatcher};
...
fn editor_input_with_1000_cursors(bencher: &mut Bencher<'_>, cx: &TestAppContext) {
    ...
    let editor = cx.update(|window, cx| {
        let editor = cx.new(|cx| {
            ...
            editor.set_style(carrot_editor::EditorStyle::default(), window, cx);
...
pub fn benches() {
    ...
    let cx = inazuma::TestAppContext::build(dispatcher, None);
    cx.update(|cx| {
