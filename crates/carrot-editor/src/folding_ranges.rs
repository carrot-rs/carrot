...
impl Editor {
    ...
    pub fn document_folding_ranges_enabled(&self, cx: &carrot_ui::App) -> bool {
...
#[cfg(test)]
mod tests {
    use carrot_lsp::FoldingRange;
    use carrot_multi_buffer::MultiBufferRow;
    use futures::StreamExt as _;
    use inazuma::TestAppContext;
    use inazuma_settings_framework::DocumentFoldingRanges;
    ...
    async fn test_lsp_folding_ranges_populates_creases(cx: &mut TestAppContext) {
        ...
        let mut cx = EditorLspTestContext::new_rust(
            carrot_lsp::ServerCapabilities {
                folding_range_provider: Some(carrot_lsp::FoldingRangeProviderCapability::Simple(
                    true,
                )),
        ...
        let mut folding_request = cx
            .set_request_handler::<carrot_lsp::request::FoldingRangeRequest, _, _>(
