...
use carrot_multi_buffer::{MultiBufferOffset, ToPoint};
...
impl inazuma::Global for TestBlockContent {}
...
pub fn editor_content_with_blocks_and_size(
    ...
    cx.draw(inazuma::Point::default(), draw_size, |_, _| {
