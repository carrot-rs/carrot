...
use carrot_language::Language;
use carrot_lsp::LanguageServerId;
use carrot_lsp::LanguageServerName;
use carrot_multi_buffer::Anchor;
use carrot_project::LanguageServerToQuery;
use carrot_project::LocationLink;
use carrot_project::Project;
use carrot_project::TaskSourceKind;
use carrot_project::lsp_store::lsp_ext_command::GetLspRunnables;
...
pub fn lsp_tasks(
    ...
    for_position: Option<inazuma_text::Anchor>,
    cx: &mut App,
    ...
    cx.spawn(async move |cx| {
        ...
        .race({
            // `carrot_lsp::DEFAULT_LSP_REQUEST_TIMEOUT` is larger than we want for the modal to open fast
