...
use carrot_actions::agent::AddSelectionToThread;
use carrot_actions::preview::{
    markdown::OpenPreview as OpenMarkdownPreview, svg::OpenPreview as OpenSvgPreview,
};
use carrot_project::DisableAiSettings;
use carrot_workspace::OpenInTerminal;
use inazuma::prelude::FluentBuilder;
use inazuma::{Context, DismissEvent, Entity, Focusable as _, Pixels, Point, Subscription, Window};
...
pub enum MenuPosition {
    ...
    PinnedToEditor {
        source: carrot_multi_buffer::Anchor,
        offset: Point<Pixels>,
    },
}
...
pub struct MouseContextMenu {
    ...
    pub(crate) context_menu: Entity<carrot_ui::ContextMenu>,
...
impl MouseContextMenu {
    pub(crate) fn pinned_to_editor(
        ...
        context_menu: Entity<carrot_ui::ContextMenu>,
        window: &mut Window,
...
pub fn deploy_context_menu(
    ...
    let source_anchor = display_map.display_point_to_anchor(point, inazuma_text::Bias::Right);
    let context_menu = if let Some(custom) = editor.custom_context_menu.take() {
        ...
        carrot_ui::ContextMenu::build(window, cx, |menu, _window, _cx| {
            let builder = menu
    ...
    editor.mouse_context_menu = match position {
        ...
        None => {
            ...
            let menu_position = MenuPosition::PinnedToEditor {
                ...
                offset: inazuma::point(character_size.em_width, character_size.line_height),
            };
            Some(MouseContextMenu::new(
                editor,
                menu_position,
