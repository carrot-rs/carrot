...
use carrot_ui::ShowScrollbar;
use carrot_ui::{h_flex, prelude::*, v_flex};
use inazuma::{
    AbsoluteLength, AnyElement, App, AvailableSpace, Bounds, Context, DragMoveEvent, Element,
    Entity, GlobalElementId, InspectorElementId, IntoElement, LayoutId, Length, Oklch,
...
impl Element for SplitBufferHeadersElement {
    ...
    fn request_layout(
        ...
        let mut style = inazuma::Style::default();
