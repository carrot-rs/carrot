...
use carrot_project::lsp_store::lsp_ext_command::SwitchSourceHeaderResult;
use carrot_rpc::proto;
use carrot_workspace::{OpenOptions, OpenVisible};
use inazuma::{App, Context, Entity, Window};
use inazuma_util::paths::{PathStyle, UrlExt as _};
use url::Url;
...
use carrot_project::lsp_store::clangd_ext::CLANGD_SERVER_NAME;
            ...
            project
                .update(cx, |project, cx| {
                    project.request_lsp(
                        ...
                        carrot_project::lsp_store::lsp_ext_command::SwitchSourceHeader,
                        cx,
                    )
                })
                .await
