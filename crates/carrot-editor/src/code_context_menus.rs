...
use carrot_language::CodeLabel;
use carrot_language::{Buffer, LanguageName, LanguageRegistry};
use carrot_lsp::CompletionItemTag;
use carrot_markdown::{Markdown, MarkdownElement};
use carrot_multi_buffer::{Anchor, ExcerptId};
use carrot_project::lsp_store::CompletionDocumentation;
use carrot_project::{CodeAction, Completion, TaskSourceKind};
use carrot_project::{CompletionDisplayOptions, CompletionSource};
use carrot_task::DebugScenario;
use carrot_task::TaskContext;
use inazuma::{
...
use inazuma_collections::{HashSet, VecDeque};
use inazuma_settings_framework::{CompletionDetailAlignment, Settings, SnippetSortOrder};
...
pub struct CompletionsMenu {
    ...
    match_candidates: Arc<[(Option<inazuma_text::Anchor>, Vec<StringMatchCandidate>)]>,
...
impl CompletionsMenu {
    ...
    pub fn resolve_visible_completions(
        ...
        // jank on navigation.
        let entry_indices = inazuma_util::expanded_and_wrapped_usize_range(
            entry_range,
    ...
    fn start_markdown_parse_for_nearby_entries(&self, cx: &mut Context<Editor>) {
        ...
        let entry_indices = inazuma_util::wrapped_usize_outward_from(
            self.selected_item,
    ...
    fn render(
        ...
        Popover::new("completion-menu-popover")
            .child(div().child(list).custom_scrollbars(
...
impl CodeActionsMenu {
    ...
    fn render(
        ...
        Popover::new("code-action-popover")
            .child(list)
            .into_any_element()
    }
