...
impl RenderOnce for ThemePreviewTile {
    fn render(self, _window: &mut carrot_ui::Window, _cx: &mut carrot_ui::App) -> impl IntoElement {
        match self.style {
