...
use carrot_ui::{IconButtonShape, Tooltip, prelude::*};
use carrot_workspace::item::{ItemBufferKind, ItemEvent, ItemHandle};
use carrot_workspace::{ToolbarItemEvent, ToolbarItemLocation, ToolbarItemView};
use inazuma::{App, EntityId, EventEmitter, Subscription};
                    ...
                    .child(
                        Button::new("open_docs", "Learn More")
                            ...
                            .on_click(move |_event, _, cx| {
                                cx.open_url("https://carrot.dev/docs/multibuffers")
                            }),
                    ),
            )
            .child(
