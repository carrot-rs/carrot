use super::*;
use carrot_editor as editor;
use carrot_editor::MultiBufferOffset;
use carrot_project as project;
use carrot_project::{FakeFs, ProjectPath};
use carrot_theme as theme;
use carrot_theme_settings as theme_settings;
use carrot_workspace as workspace;
use carrot_workspace::{
    AppState, ItemHandle, Pane, PaneRole, Workspace,
    item::{Item, ProjectItem},
    register_project_item,
};
use inazuma::{Empty, Entity, TestAppContext, VisualTestContext};
use inazuma_collections::HashSet;
use inazuma_menu as menu;
use inazuma_menu::Cancel;
use inazuma_settings_framework as settings;
use inazuma_settings_framework::{ProjectPanelAutoOpenSettings, SettingsStore};
...
#[inazuma::test]
async fn test_visible_list(cx: &mut inazuma::TestAppContext) {
    init_test(cx);
...
#[inazuma::test]
async fn test_opening_file(cx: &mut inazuma::TestAppContext) {
...
#[inazuma::test]
async fn test_exclusions_in_visible_list(cx: &mut inazuma::TestAppContext) {
    init_test(cx);
    cx.update(|cx| {
...
#[inazuma::test]
async fn test_auto_collapse_dir_paths(cx: &mut inazuma::TestAppContext) {
    init_test(cx);
...
async fn test_editing_files(cx: &mut inazuma::TestAppContext) {
    init_test(cx);
...
async fn test_adding_directories_via_file(cx: &mut inazuma::TestAppContext) {
    init_test(cx);
...
#[inazuma::test]
async fn test_adding_directory_via_file(cx: &mut inazuma::TestAppContext) {
    init_test(cx);
...
#[inazuma::test]
async fn test_copy_paste(cx: &mut inazuma::TestAppContext) {
    init_test(cx);
...
#[inazuma::test]
async fn test_cut_paste(cx: &mut inazuma::TestAppContext) {
    init_test(cx);
...
#[inazuma::test]
async fn test_cut_paste_between_different_worktrees(cx: &mut inazuma::TestAppContext) {
    init_test(cx);
...
#[inazuma::test]
async fn test_copy_paste_between_different_worktrees(cx: &mut inazuma::TestAppContext) {
    init_test(cx);
...
#[inazuma::test]
async fn test_copy_paste_directory(cx: &mut inazuma::TestAppContext) {
    init_test(cx);
...
#[inazuma::test]
async fn test_copy_paste_directory_with_sibling_file(cx: &mut inazuma::TestAppContext) {
    init_test(cx);
    ...
    cx.simulate_modifiers_change(inazuma::Modifiers {
        control: true,
        ..Default::default()
    });
...
#[inazuma::test]
async fn test_copy_paste_nested_and_root_entries(cx: &mut inazuma::TestAppContext) {
    init_test(cx);
...
#[inazuma::test]
async fn test_undo_rename(cx: &mut inazuma::TestAppContext) {
    init_test(cx);
...
#[inazuma::test]
async fn test_undo_create_file(cx: &mut inazuma::TestAppContext) {
    init_test(cx);
...
#[inazuma::test]
async fn test_undo_create_directory(cx: &mut inazuma::TestAppContext) {
    init_test(cx);
...
#[inazuma::test]
async fn test_undo_cut_paste(cx: &mut inazuma::TestAppContext) {
    init_test(cx);
...
#[inazuma::test]
async fn test_undo_drag_single_entry(cx: &mut inazuma::TestAppContext) {
    init_test(cx);
...
#[inazuma::test]
async fn test_undo_drag_multiple_entries(cx: &mut inazuma::TestAppContext) {
    init_test(cx);
...
#[inazuma::test]
async fn test_multiple_sequential_undos(cx: &mut inazuma::TestAppContext) {
    init_test(cx);
...
#[inazuma::test]
async fn test_undo_with_empty_stack(cx: &mut inazuma::TestAppContext) {
    init_test(cx);
...
#[inazuma::test]
async fn test_undo_batch(cx: &mut inazuma::TestAppContext) {
    init_test(cx);
...
#[inazuma::test]
async fn test_paste_external_paths(cx: &mut inazuma::TestAppContext) {
    init_test(cx);
...
#[inazuma::test]
async fn test_copy_and_cut_write_to_system_clipboard(cx: &mut inazuma::TestAppContext) {
    init_test(cx);
...
#[inazuma::test]
async fn test_remove_opened_file(cx: &mut inazuma::TestAppContext) {
    init_test_with_editor(cx);
...
#[inazuma::test]
async fn test_auto_open_new_file_when_enabled(cx: &mut inazuma::TestAppContext) {
    init_test_with_editor(cx);
    set_auto_open_settings(
        cx,
        ProjectPanelAutoOpenSettings {
...
#[inazuma::test]
async fn test_auto_open_new_file_when_disabled(cx: &mut inazuma::TestAppContext) {
    init_test_with_editor(cx);
    set_auto_open_settings(
        cx,
        ProjectPanelAutoOpenSettings {
...
#[inazuma::test]
async fn test_auto_open_on_paste_when_enabled(cx: &mut inazuma::TestAppContext) {
    init_test_with_editor(cx);
    set_auto_open_settings(
        cx,
        ProjectPanelAutoOpenSettings {
...
#[inazuma::test]
async fn test_auto_open_on_paste_when_disabled(cx: &mut inazuma::TestAppContext) {
    init_test_with_editor(cx);
    set_auto_open_settings(
        cx,
        ProjectPanelAutoOpenSettings {
...
#[inazuma::test]
async fn test_auto_open_on_drop_when_enabled(cx: &mut inazuma::TestAppContext) {
    init_test_with_editor(cx);
    set_auto_open_settings(
        cx,
        ProjectPanelAutoOpenSettings {
...
#[inazuma::test]
async fn test_auto_open_on_drop_when_disabled(cx: &mut inazuma::TestAppContext) {
    init_test_with_editor(cx);
    set_auto_open_settings(
        cx,
        ProjectPanelAutoOpenSettings {
...
#[inazuma::test]
async fn test_create_duplicate_items(cx: &mut inazuma::TestAppContext) {
    init_test_with_editor(cx);
...
async fn test_create_duplicate_items_and_check_history(cx: &mut inazuma::TestAppContext) {
    init_test_with_editor(cx);
...
#[inazuma::test]
#[cfg_attr(target_os = "windows", ignore)]
async fn test_rename_item_and_check_history(cx: &mut inazuma::TestAppContext) {
    init_test_with_editor(cx);
...
#[inazuma::test]
async fn test_select_git_entry(cx: &mut inazuma::TestAppContext) {
    init_test_with_editor(cx);
...
#[inazuma::test]
async fn test_select_directory(cx: &mut inazuma::TestAppContext) {
    init_test_with_editor(cx);
...
#[inazuma::test]
async fn test_select_first_last(cx: &mut inazuma::TestAppContext) {
    init_test_with_editor(cx);
...
#[inazuma::test]
async fn test_dir_toggle_collapse(cx: &mut inazuma::TestAppContext) {
    init_test_with_editor(cx);
...
#[inazuma::test]
async fn test_collapse_all_entries(cx: &mut inazuma::TestAppContext) {
    init_test_with_editor(cx);
...
#[inazuma::test]
async fn test_collapse_all_entries_multiple_worktrees(cx: &mut inazuma::TestAppContext) {
    init_test_with_editor(cx);
...
#[inazuma::test]
async fn test_collapse_all_entries_with_collapsed_root(cx: &mut inazuma::TestAppContext) {
    init_test_with_editor(cx);
...
#[inazuma::test]
async fn test_collapse_all_entries_with_invisible_worktree(cx: &mut inazuma::TestAppContext) {
    init_test_with_editor(cx);
...
#[inazuma::test]
async fn test_new_file_move(cx: &mut inazuma::TestAppContext) {
    init_test(cx);
...
// limitation of the Windows. Since Carrot will have the root open, it will hold an open handle
...
#[inazuma::test]
#[cfg_attr(target_os = "windows", ignore)]
async fn test_rename_root_of_worktree(cx: &mut inazuma::TestAppContext) {
    init_test_with_editor(cx);
...
#[inazuma::test]
async fn test_rename_with_hide_root(cx: &mut inazuma::TestAppContext) {
    init_test_with_editor(cx);
...
#[inazuma::test]
async fn test_multiple_marked_entries(cx: &mut inazuma::TestAppContext) {
    init_test_with_editor(cx);
    let fs = FakeFs::new(cx.executor());
    fs.insert_tree(
        "/project_root",
    ...
    let modifiers_with_shift = inazuma::Modifiers {
        shift: true,
        ..Default::default()
    };
    cx.run_until_parked();
...
#[inazuma::test]
async fn test_dragged_selection_resolve_entry(cx: &mut inazuma::TestAppContext) {
    init_test(cx);
...
#[inazuma::test]
async fn test_drag_marked_entries_in_folded_directories(cx: &mut inazuma::TestAppContext) {
    init_test(cx);
...
#[inazuma::test]
async fn test_drag_entries_between_different_worktrees(cx: &mut inazuma::TestAppContext) {
    init_test(cx);
...
#[inazuma::test]
async fn test_drag_multiple_entries(cx: &mut inazuma::TestAppContext) {
    init_test(cx);
...
#[inazuma::test]
async fn test_autoreveal_and_gitignored_files(cx: &mut inazuma::TestAppContext) {
    init_test_with_editor(cx);
    cx.update(|cx| {
        cx.update_global::<SettingsStore, _>(|store, cx| {
            store.update_user_settings(cx, |settings| {
...
#[inazuma::test]
async fn test_gitignored_and_always_included(cx: &mut inazuma::TestAppContext) {
    init_test_with_editor(cx);
    cx.update(|cx| {
        cx.update_global::<SettingsStore, _>(|store, cx| {
            store.update_user_settings(cx, |settings| {
...
#[inazuma::test]
async fn test_explicit_reveal(cx: &mut inazuma::TestAppContext) {
    init_test_with_editor(cx);
    cx.update(|cx| {
        cx.update_global::<SettingsStore, _>(|store, cx| {
            store.update_user_settings(cx, |settings| {
...
#[inazuma::test]
async fn test_creating_excluded_entries(cx: &mut inazuma::TestAppContext) {
    init_test(cx);
    cx.update(|cx| {
        cx.update_global::<SettingsStore, _>(|store, cx| {
            store.update_user_settings(cx, |settings| {
...
#[inazuma::test]
async fn test_selection_restored_when_creation_cancelled(cx: &mut inazuma::TestAppContext) {
    init_test_with_editor(cx);
...
#[inazuma::test]
async fn test_basic_file_deletion_scenarios(cx: &mut inazuma::TestAppContext) {
    init_test_with_editor(cx);
...
#[inazuma::test]
async fn test_deletion_gitignored(cx: &mut inazuma::TestAppContext) {
    init_test_with_editor(cx);
...
#[inazuma::test]
async fn test_nested_deletion_gitignore(cx: &mut inazuma::TestAppContext) {
    init_test_with_editor(cx);
...
#[inazuma::test]
async fn test_complex_selection_scenarios(cx: &mut inazuma::TestAppContext) {
    init_test_with_editor(cx);
...
#[inazuma::test]
async fn test_delete_all_files_and_directories(cx: &mut inazuma::TestAppContext) {
    init_test_with_editor(cx);
...
#[inazuma::test]
async fn test_nested_selection_deletion(cx: &mut inazuma::TestAppContext) {
    init_test_with_editor(cx);
...
#[inazuma::test]
async fn test_multiple_worktrees_deletion(cx: &mut inazuma::TestAppContext) {
    init_test_with_editor(cx);
...
#[inazuma::test]
async fn test_selection_vs_marked_entries_priority(cx: &mut inazuma::TestAppContext) {
    init_test_with_editor(cx);
...
#[inazuma::test]
async fn test_selection_fallback_to_next_highest_worktree(cx: &mut inazuma::TestAppContext) {
    init_test_with_editor(cx);
...
#[inazuma::test]
async fn test_expand_all_for_entry(cx: &mut inazuma::TestAppContext) {
    init_test_with_editor(cx);
...
#[inazuma::test]
async fn test_collapse_all_for_entry(cx: &mut inazuma::TestAppContext) {
    init_test(cx);
...
#[inazuma::test]
async fn test_collapse_selected_entry_and_children_action(cx: &mut inazuma::TestAppContext) {
    init_test(cx);
...
#[inazuma::test]
async fn test_collapse_root_single_worktree(cx: &mut inazuma::TestAppContext) {
    init_test(cx);
...
#[inazuma::test]
async fn test_collapse_root_multi_worktree(cx: &mut inazuma::TestAppContext) {
    init_test(cx);
...
#[inazuma::test]
async fn test_collapse_non_root_multi_worktree(cx: &mut inazuma::TestAppContext) {
    init_test(cx);
...
#[inazuma::test]
async fn test_collapse_all_for_root_single_worktree(cx: &mut inazuma::TestAppContext) {
    init_test(cx);
...
#[inazuma::test]
async fn test_collapse_all_for_root_multi_worktree(cx: &mut inazuma::TestAppContext) {
    init_test(cx);
...
#[inazuma::test]
async fn test_collapse_all_for_root_noop_on_non_root(cx: &mut inazuma::TestAppContext) {
    init_test(cx);
...
#[inazuma::test]
async fn test_create_entries_without_selection(cx: &mut inazuma::TestAppContext) {
    init_test(cx);
...
#[inazuma::test]
async fn test_create_entries_without_selection_hide_root(cx: &mut inazuma::TestAppContext) {
    init_test(cx);
...
#[cfg(windows)]
#[inazuma::test]
async fn test_create_entry_with_trailing_dot_windows(cx: &mut inazuma::TestAppContext) {
    init_test(cx);
...
#[inazuma::test]
async fn test_highlight_entry_for_external_drag(cx: &mut inazuma::TestAppContext) {
    init_test(cx);
...
#[inazuma::test]
async fn test_highlight_entry_for_selection_drag(cx: &mut inazuma::TestAppContext) {
    init_test(cx);
...
#[inazuma::test]
async fn test_highlight_entry_for_selection_drag_cross_worktree(cx: &mut inazuma::TestAppContext) {
    init_test(cx);
...
#[inazuma::test]
async fn test_should_highlight_background_for_selection_drag(cx: &mut inazuma::TestAppContext) {
    init_test(cx);
...
#[inazuma::test]
async fn test_hide_root(cx: &mut inazuma::TestAppContext) {
    init_test(cx);
...
#[inazuma::test]
async fn test_compare_selected_files(cx: &mut inazuma::TestAppContext) {
    init_test_with_editor(cx);
...
#[inazuma::test]
async fn test_compare_files_context_menu(cx: &mut inazuma::TestAppContext) {
    init_test_with_editor(cx);
...
#[inazuma::test]
async fn test_hide_hidden_entries(cx: &mut inazuma::TestAppContext) {
    init_test(cx);
...
#[inazuma::test]
async fn test_sort_mode_default_fallback(cx: &mut inazuma::TestAppContext) {
    init_test(cx);
...
#[inazuma::test]
async fn test_sort_mode_directories_first(cx: &mut inazuma::TestAppContext) {
    init_test(cx);
...
#[inazuma::test]
async fn test_sort_mode_mixed(cx: &mut inazuma::TestAppContext) {
    init_test(cx);
...
#[inazuma::test]
async fn test_sort_mode_files_first(cx: &mut inazuma::TestAppContext) {
    init_test(cx);
...
#[inazuma::test]
async fn test_sort_mode_toggle(cx: &mut inazuma::TestAppContext) {
    init_test(cx);
...
async fn test_preserve_temporary_unfolded_active_index_on_blur_from_context_menu(
    ...
    panel.update_in(cx, |panel, window, cx| {
        panel.deploy_context_menu(
            inazuma::point(inazuma::px(1.), inazuma::px(1.)),
            child_entry_id,
            window,
            cx,
        );
    ...
    panel.update_in(cx, |panel, window, cx| {
        panel.deploy_context_menu(
            inazuma::point(inazuma::px(2.), inazuma::px(2.)),
            subdir_entry_id,
            window,
            cx,
        );
...
impl Item for TestProjectItemView {
    ...
    fn pane_role(&self, _: &App) -> PaneRole {
        PaneRole::Editor
    }
}
