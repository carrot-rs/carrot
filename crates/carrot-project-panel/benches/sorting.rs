use carrot_project::{Entry, EntryKind, GitEntry, ProjectEntryId};
use carrot_project_panel::par_sort_worktree_entries_with_mode;
use criterion::{Criterion, criterion_group, criterion_main};
use inazuma_settings_framework::ProjectPanelSortMode;
