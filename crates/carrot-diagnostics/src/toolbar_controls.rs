...
use carrot_actions::buffer_search;
use carrot_language::DiagnosticEntry;
use carrot_ui::{Tooltip, prelude::*};
use carrot_workspace::{ToolbarItemEvent, ToolbarItemLocation, ToolbarItemView, item::ItemHandle};
use inazuma::{Context, EventEmitter, ParentElement, Render, Window};
use inazuma_text::{Anchor, BufferId};
...
impl Render for ToolbarControls {
    fn render(&mut self, _: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        h_flex()
            ...
            .child({
                IconButton::new("inline_assist", IconName::CarrotAssistant)
                    .icon_size(IconSize::Small)
                    .tooltip(Tooltip::for_action_title(
                        "Inline Assist",
