...
use carrot_language::{DiagnosticSourceKind, Rope};
...
async fn test_diagnostics(cx: &mut TestAppContext) {
    ...
    let uri = carrot_lsp::Uri::from_file_path(path!("/test/main.rs")).unwrap();

    // Create some diagnostics
    lsp_store.update(cx, |lsp_store, cx| {
        lsp_store.update_diagnostics(language_server_id, carrot_lsp::PublishDiagnosticsParams {
            uri: uri.clone(),
            diagnostics: vec![carrot_lsp::Diagnostic{
                range: carrot_lsp::Range::new(carrot_lsp::Position::new(7, 6),carrot_lsp::Position::new(7, 7)),
                ...
                related_information: Some(vec![carrot_lsp::DiagnosticRelatedInformation {
                    location: carrot_lsp::Location::new(uri.clone(), carrot_lsp::Range::new(carrot_lsp::Position::new(2,8),carrot_lsp::Position::new(2,9))),
                ...
                carrot_lsp::DiagnosticRelatedInformation {
                    location: carrot_lsp::Location::new(uri.clone(), carrot_lsp::Range::new(carrot_lsp::Position::new(4,6),carrot_lsp::Position::new(4,7))),
            ...
            carrot_lsp::Diagnostic{
                range: carrot_lsp::Range::new(carrot_lsp::Position::new(8, 6),carrot_lsp::Position::new(8, 7)),
                severity:Some(carrot_lsp::DiagnosticSeverity::ERROR),
                message: "use of moved value\nvalue used here after move".to_string(),
                related_information: Some(vec![carrot_lsp::DiagnosticRelatedInformation {
                    location: carrot_lsp::Location::new(uri.clone(), carrot_lsp::Range::new(carrot_lsp::Position::new(1,8),carrot_lsp::Position::new(1,9))),
                    message: "move occurs because `x` has type `Vec<char>`, which does not implement the `Copy` trait".to_string()
                },
                carrot_lsp::DiagnosticRelatedInformation {
                    location: carrot_lsp::Location::new(uri.clone(), carrot_lsp::Range::new(carrot_lsp::Position::new(3,6),carrot_lsp::Position::new(3,7))),
                    message: "value moved here".to_string()
                },
                ]),
                ..Default::default()
        ...
        lsp_store
            .update_diagnostics(
                ...
                carrot_lsp::PublishDiagnosticsParams {
                    uri: carrot_lsp::Uri::from_file_path(path!("/test/consts.rs")).unwrap(),
                    diagnostics: vec![carrot_lsp::Diagnostic {
                        range: carrot_lsp::Range::new(
                            carrot_lsp::Position::new(0, 15),
                            carrot_lsp::Position::new(0, 15),
                        ),
                        severity: Some(carrot_lsp::DiagnosticSeverity::ERROR),
    ...
    lsp_store.update(cx, |lsp_store, cx| {
        ...
        lsp_store
            .update_diagnostics(
                server_id_1,
                carrot_lsp::PublishDiagnosticsParams {
                    uri: carrot_lsp::Uri::from_file_path(path!("/test/main.js")).unwrap(),
                    diagnostics: vec![carrot_lsp::Diagnostic {
                        range: carrot_lsp::Range::new(
                            carrot_lsp::Position::new(4, 0),
                            carrot_lsp::Position::new(4, 4),
                        ),
                        severity: Some(carrot_lsp::DiagnosticSeverity::WARNING),
                        message: "no method `tset`".to_string(),
                        related_information: Some(vec![carrot_lsp::DiagnosticRelatedInformation {
                            location: carrot_lsp::Location::new(
                                carrot_lsp::Uri::from_file_path(path!("/test/main.js")).unwrap(),
                                carrot_lsp::Range::new(
                                    carrot_lsp::Position::new(0, 9),
                                    carrot_lsp::Position::new(0, 13),
                                ),
                            ),
    ...
    lsp_store.update(cx, |lsp_store, cx| {
        ...
        lsp_store
            .update_diagnostics(
                ...
                carrot_lsp::PublishDiagnosticsParams {
                    ...
                    diagnostics: vec![carrot_lsp::Diagnostic {
                        range: carrot_lsp::Range::new(
                            carrot_lsp::Position::new(2, 0),
                            carrot_lsp::Position::new(2, 1),
                        ),
                        severity: Some(carrot_lsp::DiagnosticSeverity::WARNING),
        ...
        lsp_store
            .update_diagnostics(
                server_id_2,
                carrot_lsp::PublishDiagnosticsParams {
                    uri: carrot_lsp::Uri::from_file_path(path!("/test/main.rs")).unwrap(),
                    diagnostics: vec![],
                    version: None,
                },
                None,
...
async fn test_random_diagnostics_blocks(cx: &mut TestAppContext, mut rng: StdRng) {
    ...
    let mut current_diagnostics: HashMap<(PathBuf, LanguageServerId), Vec<carrot_lsp::Diagnostic>> =
        Default::default();
                ...
                lsp_store.update(cx, |lsp_store, cx| {
                    ...
                    lsp_store
                        .update_diagnostics(
                            server_id,
                            carrot_lsp::PublishDiagnosticsParams {
                                uri: carrot_lsp::Uri::from_file_path(&path).unwrap_or_else(|_| {
                                    carrot_lsp::Uri::from_str("file:///test/fallback.rs").unwrap()
                                }),
        ...
        lsp_store.update(cx, |lsp_store, cx| {
            lsp_store
                .update_diagnostics(
                    LanguageServerId(0),
                    carrot_lsp::PublishDiagnosticsParams {
                        uri: carrot_lsp::Uri::from_file_path(path!("/root/file")).unwrap(),
                        version: None,
                        diagnostics: vec![carrot_lsp::Diagnostic {
                            range: carrot_lsp::Range::new(
                                carrot_lsp::Position::new(0, 11),
                ...
                .update_diagnostics(
                    ...
                    carrot_lsp::PublishDiagnosticsParams {
                        ...
                        diagnostics: vec![
                            ...
                            carrot_lsp::Diagnostic {
                                range: carrot_lsp::Range::new(
                                    carrot_lsp::Position::new(0, 25),
                                    carrot_lsp::Position::new(0, 28),
                                ),
                                severity: Some(carrot_lsp::DiagnosticSeverity::ERROR),
                                ..Default::default()
                            },
...
async fn test_diagnostics_with_links(cx: &mut TestAppContext) {
        ...
        lsp_store.update(cx, |lsp_store, cx| {
            lsp_store.update_diagnostics(
                ...
                carrot_lsp::PublishDiagnosticsParams {
                    ...
                    version: None,
                    diagnostics: vec![carrot_lsp::Diagnostic {
                        range: carrot_lsp::Range::new(carrot_lsp::Position::new(0, 8), carrot_lsp::Position::new(0, 12)),
                        severity: Some(carrot_lsp::DiagnosticSeverity::ERROR),
    ...
    cx.run_until_parked();
    cx.update_editor(|editor, window, cx| {
        carrot_editor::hover_popover::hover(editor, &Default::default(), window, cx)
    });
    cx.run_until_parked();
...
#[inazuma::test]
async fn test_hover_diagnostic_and_info_popovers(cx: &mut inazuma::TestAppContext) {
    init_test(cx);

    let mut cx = EditorLspTestContext::new_rust(
        carrot_lsp::ServerCapabilities {
    ...
    cx.update(|_, cx| {
        lsp_store.update(cx, |lsp_store, cx| {
            lsp_store.update_diagnostics(
                LanguageServerId(0),
                carrot_lsp::PublishDiagnosticsParams {
                    uri: carrot_lsp::Uri::from_file_path(path!("/root/dir/file.rs")).unwrap(),
                    version: None,
                    diagnostics: vec![carrot_lsp::Diagnostic {
                        range,
                        severity: Some(carrot_lsp::DiagnosticSeverity::ERROR),
    ...
    cx.update_editor(|editor, window, cx| {
        carrot_editor::hover_popover::hover(editor, &Hover, window, cx)
    });
    ...
    let range = cx.lsp_range(indoc! {"
            fn «test»() { println!(); }
        "});
    cx.set_request_handler::<carrot_lsp::request::HoverRequest, _, _>(move |_, _, _| async move {
        Ok(Some(carrot_lsp::Hover {
            contents: carrot_lsp::HoverContents::Markup(carrot_lsp::MarkupContent {
                kind: carrot_lsp::MarkupKind::Markdown,
...
async fn test_diagnostics_with_code(cx: &mut TestAppContext) {
    ...
    let cx = &mut VisualTestContext::from_window(window.into(), cx);
    let workspace = window.root(cx).unwrap();
    let uri = carrot_lsp::Uri::from_file_path(path!("/root/main.js")).unwrap();
            ...
            .update_diagnostics(
                ...
                carrot_lsp::PublishDiagnosticsParams {
                    ...
                    diagnostics: vec![
                        carrot_lsp::Diagnostic {
                            range: carrot_lsp::Range::new(
                                carrot_lsp::Position::new(1, 4),
                                carrot_lsp::Position::new(1, 14),
                            ),
                            severity: Some(carrot_lsp::DiagnosticSeverity::WARNING),
                            code: Some(carrot_lsp::NumberOrString::String(
                        ...
                        carrot_lsp::Diagnostic {
                            range: carrot_lsp::Range::new(
                                carrot_lsp::Position::new(2, 4),
                                carrot_lsp::Position::new(2, 14),
                            ),
                            severity: Some(carrot_lsp::DiagnosticSeverity::WARNING),
                            code: Some(carrot_lsp::NumberOrString::String(
                                "no-unused-vars".to_string(),
                ...
                .update_diagnostics(
                    ...
                    carrot_lsp::PublishDiagnosticsParams {
                        ...
                        diagnostics: vec![
                            ...
                            carrot_lsp::Diagnostic {
                                range: carrot_lsp::Range::new(
                                    carrot_lsp::Position::new(0, 14),
                                    carrot_lsp::Position::new(0, 18),
                                ),
                                severity: Some(carrot_lsp::DiagnosticSeverity::INFORMATION),
                                ..Default::default()
                            },
                            carrot_lsp::Diagnostic {
                                range: carrot_lsp::Range::new(
                                    carrot_lsp::Position::new(0, 19),
                                    carrot_lsp::Position::new(0, 23),
                                ),
                                severity: Some(carrot_lsp::DiagnosticSeverity::HINT),
                                ..Default::default()
                            },
                        ],
                    },
...
async fn test_buffer_diagnostics(cx: &mut TestAppContext) {
    ...
    let window = cx.add_window(|window, cx| Workspace::test_new(project.clone(), window, cx));
    let cx = &mut VisualTestContext::from_window(window.into(), cx);
    let project_path = carrot_project::ProjectPath {
    ...
    lsp_store.update(cx, |lsp_store, cx| {
        lsp_store.update_diagnostics(language_server_id, carrot_lsp::PublishDiagnosticsParams {
            ...
            diagnostics: vec![
                carrot_lsp::Diagnostic{
                    range: carrot_lsp::Range::new(carrot_lsp::Position::new(5, 6), carrot_lsp::Position::new(5, 7)),
                    severity: Some(carrot_lsp::DiagnosticSeverity::WARNING),
                    message: "use of moved value\nvalue used here after move".to_string(),
                ...
                carrot_lsp::Diagnostic{
                    range: carrot_lsp::Range::new(carrot_lsp::Position::new(6, 6), carrot_lsp::Position::new(6, 7)),
                    severity: Some(carrot_lsp::DiagnosticSeverity::ERROR),
                    message: "use of moved value\nvalue used here after move".to_string(),
                    related_information: Some(vec![
                        carrot_lsp::DiagnosticRelatedInformation {
        ...
        lsp_store.update_diagnostics(language_server_id, carrot_lsp::PublishDiagnosticsParams {
            uri: carrot_lsp::Uri::from_file_path(path!("/test/other.rs")).unwrap(),
            diagnostics: vec![
                carrot_lsp::Diagnostic{
                    range: carrot_lsp::Range::new(carrot_lsp::Position::new(1, 8), carrot_lsp::Position::new(1, 14)),
                    severity: Some(carrot_lsp::DiagnosticSeverity::WARNING),
                    message: "unused variable: `unused`".to_string(),
                    ..Default::default()
                },
                carrot_lsp::Diagnostic{
                    range: carrot_lsp::Range::new(carrot_lsp::Position::new(2, 4), carrot_lsp::Position::new(2, 22)),
                    severity: Some(carrot_lsp::DiagnosticSeverity::ERROR),
        ...
        lsp_store
            .update_diagnostics(
                ...
                carrot_lsp::PublishDiagnosticsParams {
                    ...
                    diagnostics: vec![carrot_lsp::Diagnostic {
                        range: carrot_lsp::Range::new(
                            carrot_lsp::Position::new(5, 6),
                            carrot_lsp::Position::new(5, 7),
                        ),
                        severity: Some(carrot_lsp::DiagnosticSeverity::WARNING),
                        message: "use of moved value\nvalue used here after move".to_string(),
        ...
        lsp_store
            .update_diagnostics(
                ...
                carrot_lsp::PublishDiagnosticsParams {
                    ...
                    diagnostics: vec![carrot_lsp::Diagnostic {
                        range: carrot_lsp::Range::new(
                            carrot_lsp::Position::new(6, 6),
                            carrot_lsp::Position::new(6, 7),
                        ),
                        severity: Some(carrot_lsp::DiagnosticSeverity::WARNING),
                        message: "use of moved value\nvalue used here after move".to_string(),
                        related_information: None,
...
fn randomly_update_diagnostics_for_path(
    fs: &FakeFs,
    path: &Path,
    diagnostics: &mut Vec<carrot_lsp::Diagnostic>,
    next_id: &mut usize,
    rng: &mut impl Rng,
) {
...
fn random_lsp_diagnostic(
    ...
    let range = carrot_lsp::Range::new(
        carrot_lsp::Position::new(start_point.row, start_point.column),
        carrot_lsp::Position::new(end_point.row, end_point.column),
    );
    ...
    let related_information = if rng.random_bool(0.3) {
        ...
        for i in 0..info_count {
            ...
            let info_range = carrot_lsp::Range::new(
                carrot_lsp::Position::new(info_start_point.row, info_start_point.column),
                carrot_lsp::Position::new(info_end_point.row, info_end_point.column),
            );

            related_info.push(carrot_lsp::DiagnosticRelatedInformation {
                location: carrot_lsp::Location::new(
                    carrot_lsp::Uri::from_file_path(path).unwrap(),
                    info_range,
                ),
