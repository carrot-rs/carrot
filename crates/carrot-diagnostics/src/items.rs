...
use carrot_editor::{Editor, MultiBufferOffset};
use carrot_language::Diagnostic;
use carrot_project::project_settings::{GoToDiagnosticSeverityFilter, ProjectSettings};
use carrot_ui::{Button, ButtonLike, Color, Icon, IconName, Label, Tooltip, h_flex, prelude::*};
use carrot_workspace::{StatusItemView, ToolbarItemEvent, Workspace, item::ItemHandle};
use inazuma::{
...
pub struct DiagnosticIndicator {
    summary: carrot_project::DiagnosticSummary,
...
impl DiagnosticIndicator {
    pub fn new(workspace: &Workspace, cx: &mut Context<Self>) -> Self {
        ...
        cx.subscribe(project, |this, project, event, cx| match event {
            ...
            | carrot_project::Event::LanguageServerRemoved(_) => {
