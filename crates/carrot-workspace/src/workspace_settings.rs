...
pub struct WorkspaceSettings {
    ...
    pub bottom_dock_layout: inazuma_settings_framework::BottomDockLayout,
    pub pane_split_direction_horizontal: inazuma_settings_framework::PaneSplitDirectionHorizontal,
    pub pane_split_direction_vertical: inazuma_settings_framework::PaneSplitDirectionVertical,
    pub centered_layout: inazuma_settings_framework::CenteredLayoutSettings,
    pub confirm_quit: bool,
    pub show_call_status_icon: bool,
    pub autosave: AutosaveSetting,
    pub restore_on_startup: inazuma_settings_framework::RestoreOnStartupBehavior,
    ...
    pub when_closing_with_no_tabs: inazuma_settings_framework::CloseWindowWhenNoItems,
    pub on_last_window_closed: inazuma_settings_framework::OnLastWindowClosed,
    pub text_rendering_mode: inazuma_settings_framework::TextRenderingMode,
    pub resize_all_panels_in_dock: Vec<DockPosition>,
    pub close_on_file_delete: bool,
    pub close_panel_on_toggle: bool,
    pub use_system_window_tabs: bool,
    pub zoomed_padding: bool,
    pub window_decorations: inazuma_settings_framework::WindowDecorations,
}
...
/// Visibility toggles for the pane toolbar items. Mirrors the granular
/// control the status bar already has.
#[derive(Deserialize, RegisterSetting, Copy, Clone, Debug, PartialEq, Eq)]
...
impl Settings for ToolbarSettings {
    fn from_settings(content: &inazuma_settings_framework::SettingsContent) -> Self {
        let toolbar = content.editor.toolbar.as_ref().cloned().unwrap_or_default();
        ToolbarSettings {
            ...
            code_actions: toolbar.code_actions.unwrap_or(false),
        }
    }
}
