use crate::{
    ...
    item::{Item, ItemEvent, PaneRole},
    persistence::WorkspaceDb,
};
use carrot_actions::{Extensions, OpenOnboarding, OpenSettings, agent, command_palette};
use carrot_git::Clone as GitClone;
use carrot_project::DisableAiSettings;
use carrot_ui::{ButtonLike, Divider, DividerColor, KeyBinding, Vector, VectorName, prelude::*};
...
actions!(
    carrot,
    [
        /// Show the Carrot welcome screen
        ShowWelcome
    ]
);
...
impl crate::SerializableItem for WelcomePage {
    ...
    fn deserialize(
        ...
        workspace: inazuma::WeakEntity<Workspace>,
        workspace_id: crate::WorkspaceId,
...
mod persistence {
    ...
    carrot_db::static_connection!(WelcomePagesDb, [WorkspaceDb]);
