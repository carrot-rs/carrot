...
use carrot_ui::{CopyButton, Tooltip, prelude::*};
        ...
        self.show_notification(NotificationId::unique::<PortalError>(), cx, |cx| {
            cx.new(|cx| {
                ErrorMessagePrompt::new(err.to_string(), cx).with_link_button(
                    "See docs",
                    "https://carrot.dev/docs/linux#i-cant-open-any-files",
                )
            })
        });
    }
...
pub struct LanguageServerPrompt {
    ...
    request: Option<carrot_project::LanguageServerPromptRequest>,
...
impl LanguageServerPrompt {
    pub fn new(request: carrot_project::LanguageServerPromptRequest, cx: &mut App) -> Self {
                        ...
                        h_flex()
                            ...
                            .child(
                                h_flex()
                                    ...
                                    .child(
                                        carrot_ui::IconButton::new(
                                            "close",
                                            carrot_ui::IconName::Close,
                                        )
                                ...
                                IconButton::new(close_id, close_icon)
                                    .tooltip(move |_window, cx| {
                                        if suppress {
                                            ...
                                            Tooltip::for_action("Close", &inazuma_menu::Cancel, cx)
                                        }
                                    })
                                    .on_click({
...
pub mod simple_message_notification {
    ...
    use carrot_ui::{WithScrollbar, prelude::*};
    use inazuma::{
...
mod tests {
    ...
    use carrot_project::{LanguageServerPromptRequest, Project};
