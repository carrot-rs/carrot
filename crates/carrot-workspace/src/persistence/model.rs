...
use inazuma::{AsyncWindowContext, Entity, WeakEntity, WindowId};
use inazuma_collections::IndexSet;

use carrot_language::{Toolchain, ToolchainScope};
use carrot_project::{Project, debugger::breakpoint_store::SourceBreakpoint};
...
/// A single session tab. Each session owns its own pane tree and
/// optional name/color.
#[derive(Debug, PartialEq, Clone)]
pub struct SerializedSession {
    pub name: Option<String>,
    pub color: Option<String>,
    pub pane_group: SerializedPaneGroup,
}
