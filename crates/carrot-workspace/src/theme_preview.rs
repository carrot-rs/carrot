...
use carrot_theme::all_theme_colors;
use carrot_ui::{
...
use inazuma::{
    AnyElement, App, Entity, EventEmitter, FocusHandle, Focusable, Oklch, Task, actions, hsla,
};
use strum::IntoEnumIterator;

use crate::{Item, PaneRole, Workspace};
...
impl ThemePreview {
    ...
    fn render_text(
        ...
        let label_with_contrast = |label: &str, fg: Oklch| {
