...
impl From<inazuma_settings_framework::WslConnection> for WslConnectionOptions {
    fn from(val: inazuma_settings_framework::WslConnection) -> Self {
...
fn wsl_command_impl(
    ...
    let mut command = inazuma_util::command::new_command("wsl.exe");
