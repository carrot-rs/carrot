...
impl ConnectionIdentifier {
    ...
    // The total length of:
    //   /home/{username}/.local/share/carrot/server_state/{name}/stdout.sock
...
impl RemoteClient {
    ...
    #[cfg(any(test, feature = "test-support"))]
    pub fn fake_server(
        client_cx: &mut inazuma::TestAppContext,
        server_cx: &mut inazuma::TestAppContext,
...
#[derive(Debug, Clone, PartialEq, Eq, inazuma::Action)]
