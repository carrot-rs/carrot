...
impl EditPredictionDelegate for CarrotEditPredictionDelegate {
    fn name() -> &'static str {
        "carrot-predict"
    }

    fn display_name() -> &'static str {
        "Carrot's Edit Predictions"
    }
    ...
    fn usage(&self, cx: &App) -> Option<carrot_client::EditPredictionUsage> {
        ...
        self.store.update(cx, |store, cx| {
            ...
            let prediction = match prediction {
                ...
                BufferEditPrediction::Jump { prediction } => {
                    return Some(carrot_edit_prediction_types::EditPrediction::Jump {
            ...
            Some(carrot_edit_prediction_types::EditPrediction::Local {
                id: Some(prediction.id.to_string().into()),
