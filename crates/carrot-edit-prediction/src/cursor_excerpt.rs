use carrot_language::{BufferSnapshot, Point, ToPoint as _};
use inazuma_text::OffsetRangeExt as _;
use std::ops::Range;
...
mod tests {
    use super::*;
    use carrot_language::{Buffer, rust_lang};
    use carrot_zeta_prompt::compute_editable_and_context_ranges;
    use inazuma::{App, AppContext as _};
    use inazuma_util::test::{TextRangeMarker, marked_text_ranges_by};
    use indoc::indoc;
    ...
    fn test_editable_and_context_ranges(cx: &mut App) {
        ...
        for test_case in test_cases {
            ...
            cx.new(|cx: &mut inazuma::Context<Buffer>| {
