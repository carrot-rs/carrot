...
use carrot_fs::Fs;
use carrot_project::Worktree;
use carrot_worktree::ChildEntriesOptions;
use futures::StreamExt as _;
use inazuma::{App, AppContext as _, Entity, Subscription, Task};
use inazuma_util::{ResultExt as _, maybe, rel_path::RelPath};
    ...
    pub fn new(worktree: &Entity<Worktree>, cx: &mut App) -> Self {
        ...
        let _worktree_subscription =
            cx.subscribe(worktree, move |_worktree, event, _cx| match event {
                carrot_worktree::Event::UpdatedEntries(updated_entries) => {
