...
use carrot_theme::{ActiveTheme, Appearance, GlobalTheme, ThemeMeta, ThemeRegistry};
use inazuma::{
...
pub struct ThemeSelector {
    ...
    original_theme: Arc<carrot_theme::Theme>,
...
impl ThemeSelector {
    ...
    pub fn new(fs: Arc<dyn carrot_fs::Fs>, cx: &mut Context<Self>) -> Self {
    ...
    pub fn confirm(&mut self, cx: &mut Context<Self>) {
        if let Some(meta) = self.selected_theme() {
            ...
            // Use Dark as system appearance default — Carrot doesn't track system appearance yet.
            ...
            inazuma_settings_framework::update_settings_file(
                ...
                cx,
                move |settings, _cx| {
                    carrot_theme_settings::set_theme(
                        settings,
                        theme_name,
                        theme_appearance,
                        system_appearance,
