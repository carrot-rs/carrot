...
async fn test_matching_paths_with_colon(cx: &mut TestAppContext) {
    ...
    cx.dispatch_action(carrot_editor::actions::Backspace);
...
async fn test_history_items_uniqueness_for_multiple_worktree(cx: &mut TestAppContext) {
    ...
    cx.dispatch_action(carrot_workspace::CloseActiveItem { save_intent: None });
...
#[inazuma::test]
async fn test_query_history(cx: &mut inazuma::TestAppContext) {
    let app_state = init_test(cx);
...
#[inazuma::test]
async fn test_history_match_positions(cx: &mut inazuma::TestAppContext) {
    let app_state = init_test(cx);
...
#[inazuma::test]
async fn test_history_labels_do_not_include_worktree_root_name(cx: &mut inazuma::TestAppContext) {
    let app_state = init_test(cx);
...
#[inazuma::test]
async fn test_external_files_history(cx: &mut inazuma::TestAppContext) {
    let app_state = init_test(cx);
...
#[inazuma::test]
async fn test_toggle_panel_new_selections(cx: &mut inazuma::TestAppContext) {
    let app_state = init_test(cx);
...
#[inazuma::test]
async fn test_search_preserves_history_items(cx: &mut inazuma::TestAppContext) {
    let app_state = init_test(cx);
...
#[inazuma::test]
async fn test_search_sorts_history_items(cx: &mut inazuma::TestAppContext) {
    let app_state = init_test(cx);
...
#[inazuma::test]
async fn test_select_current_open_file_when_no_history(cx: &mut inazuma::TestAppContext) {
    let app_state = init_test(cx);
...
#[inazuma::test]
async fn test_history_items_vs_very_good_external_match(cx: &mut inazuma::TestAppContext) {
    let app_state = init_test(cx);
...
#[inazuma::test]
async fn test_nonexistent_history_items_not_shown(cx: &mut inazuma::TestAppContext) {
    let app_state = init_test(cx);
...
#[inazuma::test]
async fn test_search_results_refreshed_on_worktree_updates(cx: &mut inazuma::TestAppContext) {
    let app_state = init_test(cx);
...
#[inazuma::test]
async fn test_search_results_refreshed_on_standalone_file_creation(
    cx: &mut inazuma::TestAppContext,
) {
    let app_state = init_test(cx);
    ...
    let window = cx.add_window({
        ...
        |window, cx| Workspace::test_new(project, window, cx)
    });
...
#[inazuma::test]
async fn test_selected_match_stays_selected_after_matches_refreshed(
    cx: &mut inazuma::TestAppContext,
) {
    let app_state = init_test(cx);
...
#[inazuma::test]
async fn test_keeps_file_finder_open_after_modifier_keys_release(cx: &mut inazuma::TestAppContext) {
    let app_state = init_test(cx);
...
#[inazuma::test]
async fn test_opens_file_on_modifier_keys_release(cx: &mut inazuma::TestAppContext) {
    let app_state = init_test(cx);
...
#[inazuma::test]
async fn test_extending_modifiers_does_not_confirm_selection(cx: &mut inazuma::TestAppContext) {
    let app_state = init_test(cx);
...
#[inazuma::test]
async fn test_repeat_toggle_action(cx: &mut inazuma::TestAppContext) {
    let app_state = init_test(cx);
    app_state
        .fs
        .as_fake()
...
async fn test_clear_navigation_history(cx: &mut TestAppContext) {
    ...
    cx.dispatch_action(carrot_workspace::ClearNavigationHistory);
