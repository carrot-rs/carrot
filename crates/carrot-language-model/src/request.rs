...
impl From<Speed> for carrot_anthropic::Speed {
    fn from(speed: Speed) -> Self {
        match speed {
            Speed::Standard => carrot_anthropic::Speed::Standard,
            Speed::Fast => carrot_anthropic::Speed::Fast,
        }
    }
}
...
mod tests {
    ...
    async fn test_from_image_downscales_to_default_5mb_limit(cx: &mut TestAppContext) {
        ...
        let image = inazuma::Image::from_bytes(ImageFormat::Png, original_png);
        let lm_image = cx
