...
use inazuma_util::{debug_panic, schemars::add_new_subschema};
use log as _;
...
impl TcpArgumentsTemplate {
    ...
    pub fn from_proto(proto: carrot_proto::TcpHost) -> Result<Self> {
        Ok(Self {
...
impl DebugRequest {
    pub fn to_proto(&self) -> carrot_proto::DebugRequest {
        match self {
            DebugRequest::Launch(launch_request) => carrot_proto::DebugRequest {
                request: Some(carrot_proto::debug_request::Request::DebugLaunchRequest(
                    carrot_proto::DebugLaunchRequest {
            ...
            DebugRequest::Attach(attach_request) => carrot_proto::DebugRequest {
                request: Some(carrot_proto::debug_request::Request::DebugAttachRequest(
                    carrot_proto::DebugAttachRequest {
    ...
    pub fn from_proto(val: carrot_proto::DebugRequest) -> Result<DebugRequest> {
        let request = val.request.context("Missing debug request")?;
        match request {
            carrot_proto::debug_request::Request::DebugLaunchRequest(
                carrot_proto::DebugLaunchRequest {
                    program,
                    cwd,
                    args,
            ...
            carrot_proto::debug_request::Request::DebugAttachRequest(
                carrot_proto::DebugAttachRequest { process_id },
