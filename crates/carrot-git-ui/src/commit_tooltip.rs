...
use carrot_editor::hover_markdown_style;
use carrot_git::blame::BlameEntry;
use carrot_git::repository::CommitSummary;
use carrot_git::{GitRemote, commit::ParsedCommitMessage};
...
use carrot_ui::{Avatar, CopyButton, Divider, prelude::*, tooltip_container};
...
fn blame_entry_timestamp(
    ...
    format: carrot_time_format::TimestampFormat,
) -> String {
...
pub fn blame_entry_relative_timestamp(blame_entry: &BlameEntry) -> String {
    blame_entry_timestamp(blame_entry, carrot_time_format::TimestampFormat::Relative)
}
