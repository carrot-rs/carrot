...
impl carrot_editor::Addon for ConflictAddon {
...
fn update_conflict_highlighting(
    ...
    buffer: &carrot_editor::MultiBufferSnapshot,
    excerpt_id: carrot_editor::ExcerptId,
    cx: &mut Context<Editor>,
) -> Option<()> {
...
pub(crate) fn register_conflict_notification(
    ...
    cx.subscribe(&git_store, move |workspace, _git_store, event, cx| {
        ...
        if workspace.is_notification_suppressed(carrot_workspace::merge_conflict_notification_id())
        {
            return;
        }

        let paths = collect_conflicted_file_paths(project, cx);
        let notification_id = carrot_workspace::merge_conflict_notification_id();
            ...
            workspace.show_notification(notification_id, cx, |cx| {
                cx.new(|cx| {
                    ...
                    MessageNotification::new(message, cx)
                        ...
                        .primary_icon(IconName::CarrotAssistant)
