...
use carrot_project::{Project, git_store::Repository};
use carrot_ui::{ListItem, ListItemSpacing, prelude::*};
use carrot_workspace::{ModalView, Workspace};
use inazuma::{App, DismissEvent, Entity, EventEmitter, FocusHandle, Focusable, Task, WeakEntity};
...
pub fn open(
    ...
    _: &carrot_actions::git::SelectRepo,
    window: &mut Window,
