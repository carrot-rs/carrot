...
use carrot_git::repository::Worktree as GitWorktree;
use carrot_project::project_settings::ProjectSettings;
use carrot_project::{
    git_store::Repository,
    trusted_worktrees::{PathTrust, TrustedWorktrees},
};
use carrot_remote::{RemoteConnectionOptions, remote_client::ConnectionIdentifier};
use carrot_remote_connection::{RemoteConnectionModal, connect};
use carrot_shell::AppShell;
use carrot_ui::{HighlightedLabel, KeyBinding, ListItem, ListItemSpacing, Tooltip, prelude::*};
...
use inazuma_picker::{Picker, PickerDelegate, PickerEditorPosition};
...
async fn open_remote_worktree(
    ...
    let new_project: Entity<carrot_project::Project> = cx.update(|_, cx| {
    ...
    carrot_workspace::open_remote_project_with_existing_connection(
        connection_options,
        new_project,
        paths,
        app_state,
