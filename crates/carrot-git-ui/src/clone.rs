...
use carrot_ui::{Color, IconName, SharedString};
use carrot_workspace::{self, Workspace};
use inazuma::{App, Context, WeakEntity, Window};
...
pub fn clone_and_open(
    ...
    let destination_prompt = cx.prompt_for_paths(inazuma::PathPromptOptions {
        files: false,
        directories: true,
        multiple: false,
