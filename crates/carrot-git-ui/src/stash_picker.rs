...
use carrot_git::stash::StashEntry;
use carrot_project::git_store::{Repository, RepositoryEvent};
use carrot_time_format;
...
mod tests {
    ...
    use super::*;
    use carrot_git::{Oid, stash::StashEntry};
    use carrot_project::{FakeFs, Project};
    use inazuma::{TestAppContext, VisualTestContext, rems};
