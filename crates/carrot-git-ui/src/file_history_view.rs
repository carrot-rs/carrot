...
use carrot_git::repository::{FileHistory, FileHistoryEntry, RepoPath};
use carrot_git::{GitHostingProviderRegistry, GitRemote, parse_git_remote_url};
use carrot_project::{
    Project, ProjectPath,
...
use carrot_ui::{Chip, Divider, ListItem, WithScrollbar, prelude::*};
use carrot_workspace::{
    Item, PaneRole, Workspace,
...
impl FileHistoryView {
    ...
    fn render_commit_entry(
        ...
        let relative_timestamp = carrot_time_format::format_localized_timestamp(
            commit_time,
...
impl Item for FileHistoryView {
    ...
    fn breadcrumbs(
        ...
        Vec<carrot_workspace::item::HighlightedText>,
        Option<inazuma::Font>,
    )> {
        None
    }
    ...
    fn pixel_position_of_cursor(&self, _: &App) -> Option<inazuma::Point<inazuma::Pixels>> {
        None
    }
