...
use carrot_editor::{BlameRenderer, Editor, hover_markdown_style};
use carrot_git::{blame::BlameEntry, commit::ParsedCommitMessage, repository::CommitSummary};
use carrot_markdown::{Markdown, MarkdownElement};
use carrot_project::{git_store::Repository, project_settings::ProjectSettings};
use carrot_theme_settings::ThemeSettings;
use carrot_ui::{ContextMenu, CopyButton, Divider, prelude::*, tooltip_container};
...
impl BlameRenderer for GitBlameRenderer {
    ...
    fn render_blame_entry(
        ...
        let name =
            inazuma_util::truncate_and_trailoff(author_name, GIT_BLAME_MAX_AUTHOR_CHARS_DISPLAYED);
    ...
    fn render_blame_entry_popover(
        ...
        let absolute_timestamp = carrot_time_format::format_localized_timestamp(
            commit_time,
...
fn blame_entry_relative_timestamp(blame_entry: &BlameEntry) -> String {
    match blame_entry.author_offset_date_time() {
        Ok(timestamp) => {
            ...
            carrot_time_format::format_localized_timestamp(
                timestamp,
