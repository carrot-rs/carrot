...
fn block(label: &'static str, color: impl Into<Oklch>, text_color: Rgba) -> Div {
    ...
    div()
        ...
        .bg(color)
        .border_1()
        .border_color(inazuma::white().opacity(0.3))
        .rounded_md()
        .text_xs()
    ...
    div()
        ...
        .child(
            div()
                ...
                .flex_row()
                .gap_2()
                .child(block("A", inazuma::red(), text).size_8())
                .child(block("B", inazuma::green(), text).size_8())
                .child(block("C", inazuma::blue(), text).size_8()),
        )
}
    ...
    div()
        ...
        .child(
            div()
                ...
                .flex_col()
                .gap_2()
                .child(block("A", inazuma::red(), text).h_6())
                .child(block("B", inazuma::green(), text).h_6())
                .child(block("C", inazuma::blue(), text).h_6()),
        )
}
            ...
            div()
                ...
                .child(
                    div()
                        ...
                        .bg(surface)
                        .rounded_sm()
                        .child(block("Start", inazuma::red(), text).px_2().py_1())
                        .child(block("End", inazuma::blue(), text).px_2().py_1()),
                )
                .child(
                    div()
                        .flex()
                        ...
                        .bg(surface)
                        .rounded_sm()
                        .child(block("Center", inazuma::green(), text).px_2().py_1()),
                )
                .child(
                    div()
                        .flex()
                        ...
                        .bg(surface)
                        .rounded_sm()
                        .child(block("End", inazuma::yellow(), text).px_2().py_1()),
                ),
        )
}
    ...
    div()
        ...
        .child(
            div()
                ...
                .gap_2()
                .child(
                    block("fixed", inazuma::red(), text)
                        .flex_none()
                        .w_16()
                        .h_8(),
                )
                .child(
                    block("flex_1 (grows)", inazuma::green(), text)
                        .flex_1()
                        .h_8(),
                )
                .child(
                    block("fixed", inazuma::blue(), text)
                        .flex_none()
                        .w_16()
                        .h_8(),
                ),
    ...
    div()
        ...
        .child(
            div()
                ...
                .grid_cols(3)
                .gap_1()
                .child(block("1", inazuma::red(), text).h_8())
                .child(block("2", inazuma::green(), text).h_8())
                .child(block("3", inazuma::blue(), text).h_8())
                .child(block("4", inazuma::yellow(), text).h_8())
                .child(block("5", inazuma::red(), text).h_8())
                .child(block("6", inazuma::green(), text).h_8()),
        )
}
    ...
    div()
        ...
        .child(
            div()
                ...
                .gap_1()
                .child(
                    block("Header (col_span_full)", inazuma::red(), text)
                        .col_span_full()
                        .h_6(),
                )
                .child(
                    block("Side", inazuma::green(), text)
                        .col_span(1)
                        .row_span(2)
                        .h_full(),
                )
                .child(
                    block("Content (col_span 3)", inazuma::blue(), text)
                        .col_span(3)
                        .row_span(2)
                        .h_full(),
                ),
