...
use inazuma::{
    App, Application, Bounds, ClickEvent, Context, Entity, Half, IntoElement, MouseButton,
    MouseMoveEvent, Oklch, Pixels, Point, Render, Window, WindowBounds, WindowOptions, div,
    prelude::*, px, rgb, size,
};
...
impl Render for DragData {
    fn render(&mut self, _window: &mut Window, _cx: &mut Context<Self>) -> impl IntoElement {
        let size = inazuma::size(px(80.), px(40.));
