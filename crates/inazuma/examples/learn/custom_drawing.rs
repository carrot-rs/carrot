...
use inazuma::{
    App, Application, Bounds, Context, MouseButton, MouseDownEvent, MouseMoveEvent, MouseUpEvent,
    Oklch, Path, PathBuilder, Pixels, Point, Render, Rgba, Window, WindowBounds, WindowOptions,
...
struct CustomDrawingExample {
    drawing_canvas: inazuma::Entity<DrawingCanvas>,
}
