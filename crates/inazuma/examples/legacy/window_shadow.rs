use inazuma::{
    App, Application, Bounds, Context, CursorStyle, Decorations, HitboxBehavior, MouseButton,
    Oklch, Pixels, Point, ResizeEdge, Size, Window, WindowBackgroundAppearance, WindowBounds,
...
// 3. We need to implement the techniques in here in Carrot
