...
use inazuma::{
    ...
    WindowOptions, actions, black, div, fill, opaque_grey, point, prelude::*, px, relative, rgb,
    rgba, size, white, yellow,
};
    ...
    fn prepaint(
        ...
        let (display_text, text_color) = if content.is_empty() {
            (
                ...
                inazuma::Oklch::black().opacity(0.2),
            )
        } else {
            (content, style.color)
        };
