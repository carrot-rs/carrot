...
//! that have the shape `fn method(self) -> Self`. This code was generated using Carrot Agent with Claude Opus 4.
...
fn try_expand_macro(macro_item: &syn::TraitItemMacro) -> Option<Vec<TraitItem>> {
    ...
    match macro_name.as_str() {
        "inazuma_macros::style_helpers" | "style_helpers" => {
