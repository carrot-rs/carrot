...
pub(crate) fn build_nix(
    ...
    let mut job = Job::default()
        ...
        .runs_on(runner)
        .add_env(("CARROT_CLIENT_CHECKSUM_SEED", vars::CARROT_CLIENT_CHECKSUM_SEED))
        .add_env(("CARROT_MINIDUMP_ENDPOINT", vars::CARROT_SENTRY_MINIDUMP_ENDPOINT))
        .add_env((
            "CARROT_CLOUD_PROVIDER_ADDITIONAL_MODELS_JSON",
            vars::CARROT_CLOUD_PROVIDER_ADDITIONAL_MODELS_JSON,
        ))
