...
Carrot's GPU-accelerated UI framework, forked from [GPUI](https://gpui.rs).
...
Currently, the best way to learn about these APIs is to read the Carrot source code or drop a question in the [Carrot Discord](https://carrot.dev/community-links). We're working on improving the documentation, creating more examples, and will be publishing more guides to Inazuma on our [blog](https://carrot.dev/blog).
