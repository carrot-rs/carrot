use crate::{
    ...
    FontWeight, GridPlacement, GridTemplate, JustifyContent, Length, Oklch, SharedString,
...
pub trait Styled: Sized {
    ...
    inazuma_macros::style_helpers!();
    inazuma_macros::visibility_style_methods!();
    inazuma_macros::margin_style_methods!();
    inazuma_macros::padding_style_methods!();
    inazuma_macros::position_style_methods!();
    inazuma_macros::overflow_style_methods!();
    inazuma_macros::cursor_style_methods!();
    inazuma_macros::border_style_methods!();
    inazuma_macros::box_shadow_style_methods!();
