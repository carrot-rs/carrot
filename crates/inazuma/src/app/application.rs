...
use crate::{
    AnyWindowHandle, App, AssetSource, BackgroundExecutor, ForegroundExecutor, Global, Platform,
    SharedString, SvgRenderer, TextSystem, WindowId,
};
...
impl Application {
    ...
    pub fn with_http_client(self, http_client: Arc<dyn carrot_http_client::HttpClient>) -> Self {
        let mut context_lock = self.0.borrow_mut();
