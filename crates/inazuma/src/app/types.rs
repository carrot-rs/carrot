...
use crate::{
    Action, AnyEntity, AnyView, App, ArenaBox, Bounds, CursorStyle, EntityId, Global, KeyContext,
    Keystroke, Pixels, Point, Window, WindowId,
};
...
pub struct AnyTooltip {
    ...
    pub check_visible_and_update:
        std::rc::Rc<dyn Fn(Bounds<Pixels>, &mut Window, &mut App) -> bool>,
}
...
impl HttpClient for NullHttpClient {
    fn send(
        &self,
        _req: carrot_http_client::Request<carrot_http_client::AsyncBody>,
    ...
    fn user_agent(&self) -> Option<&carrot_http_client::http::HeaderValue> {
        None
    }
