...
use super::{
    AppCell, Effect, GpuiMode, Handler, KeystrokeObserver, Listener, NewEntityListener,
    QuitHandler, QuitMode, ReleaseListener, SystemWindowTabController, WindowClosedHandler,
};
use crate::{
    ActionRegistry, AnyWindowHandle, Arena, AssetSource, BackgroundExecutor, EntityMap, FocusMap,
    ForegroundExecutor, Keymap, LayoutId, Platform, PlatformKeyboardLayout, PlatformKeyboardMapper,
    PromptBuilder, SubscriberSet, SvgRenderer, TextRenderingMode, TextSystem, Window, WindowId,
    WindowInvalidator, init_app_menus,
};
...
pub struct App {
    ...
    pub(super) http_client: Arc<dyn carrot_http_client::HttpClient>,
...
impl App {
    ...
    pub(crate) fn new_app(
        ...
        http_client: Arc<dyn carrot_http_client::HttpClient>,
    ) -> Rc<AppCell> {
