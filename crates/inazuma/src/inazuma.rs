...
extern crate inazuma_macros;
extern crate self as inazuma;

#[macro_use]
mod action;
/// Accessibility data model — role vocabulary + tree shape the
/// platform AccessKit adapter consumes.
...
/// Do not touch, here be dragons for use by inazuma_macros and such.
#[doc(hidden)]
pub mod private {
    pub use anyhow;
    pub use inventory;
