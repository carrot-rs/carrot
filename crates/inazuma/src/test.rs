...
//!
//! The output of the `inazuma::test` macro is understood by other rust test runners, so you can use it with `cargo test`
//! or `cargo-nextest`, or another runner of your choice.
//!
//! To make it possible to test collaborative user interfaces (like Carrot) you can ask for as many different contexts
//! as you need.
//!
//! ## Example
//!
...
/// Strategy injected into `#[inazuma::property_test]` tests to control the seed
...
/// `inazuma::property_test` macro and generally should not be used directly.
///
...
/// This is intended for use with the `inazuma::test` macro
