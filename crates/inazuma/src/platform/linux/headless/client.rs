...
impl LinuxClient for HeadlessClient {
    ...
    fn screen_capture_sources(
        ...
        anyhow::Result<Vec<Rc<dyn inazuma::ScreenCaptureSource>>>,
    > {
    ...
    fn write_to_primary(&self, _item: inazuma::ClipboardItem) {}

    fn write_to_clipboard(&self, _item: inazuma::ClipboardItem) {}
