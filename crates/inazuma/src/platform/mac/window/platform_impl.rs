    ...
    fn set_background_appearance(&self, background_appearance: WindowBackgroundAppearance) {
        ...
        unsafe {
            ...
            let background_color = if opaque {
                objc2_app_kit::NSColor::colorWithSRGBRed_green_blue_alpha(0.0, 0.0, 0.0, 1.0)
            } else {
                // Not using `+[NSColor clearColor]` to avoid broken shadow.
                objc2_app_kit::NSColor::colorWithSRGBRed_green_blue_alpha(0.0, 0.0, 0.0, 0.0001)
            };
            ...
            if use_legacy_blur {
                ...
                if background_appearance != WindowBackgroundAppearance::Blurred {
                    ...
                    if let Some(content_view) = &content_view {
                        ...
                        let blur_view: *mut AnyObject = msg_send![blur_view, initWithFrame: frame];
                        let blur_view_ref: &objc2_app_kit::NSView =
                            &*(blur_view as *const objc2_app_kit::NSView);
    ...
    fn tabbed_windows(&self) -> Option<Vec<SystemWindowTab>> {
        unsafe {
            ...
            for i in 0..windows.count() {
                ...
                let tabbed_ptr =
                    &*tabbed_window as *const objc2_app_kit::NSWindow as *const GPUIWindow;
            ...
            .spawn(async move {
                ...
                unsafe {
                    let action_str = defaults
                        ...
                        .map(|obj| {
                            let ns_string: &objc2_foundation::NSString = &*((&*obj
                                as *const AnyObject)
