        ...
        unsafe {
            ...
            let native_window: *mut AnyObject = match kind {
                WindowKind::Normal => {
                    ...
                    objc2::rc::Retained::into_raw(window.expect("failed to init GPUIWindow"))
                        as *mut AnyObject
                }
                WindowKind::PopUp => {
                    ...
                    objc2::rc::Retained::into_raw(window.expect("failed to init GPUIPanel"))
                        as *mut AnyObject
                }
            ...
            #[allow(deprecated)]
            let filenames_type: objc2::rc::Retained<objc2_foundation::NSString> =
                objc2_app_kit::NSFilenamesPboardType.to_owned();
            ...
            let native_view: *mut AnyObject = {
                ...
                objc2::rc::Retained::into_raw(view.expect("failed to init GPUIView"))
                    as *mut AnyObject
            };
            ...
            match kind {
                ...
                WindowKind::Dialog => {
                    if let Some(ref main_win) = main_window_opt {
                        ...
                        sheet_parent = Some(objc2::rc::Retained::as_ptr(&parent) as *mut AnyObject);
                    }
                }
            }
            ...
            if allows_automatic_window_tabbing {
                if let Some(ref main_win) = main_window_opt {
                    let main_window_ptr = objc2::rc::Retained::as_ptr(main_win) as *mut AnyObject;
                    if main_window_ptr != native_window {
                        ...
                        let should_add_as_tab = user_tabbing_preference
