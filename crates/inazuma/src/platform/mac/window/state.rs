...
pub(super) struct MacWindowState {
    ...
    pub(super) event_callback:
        Option<Box<dyn FnMut(PlatformInput) -> inazuma::DispatchEventResult>>,
    ...
    pub(super) fn move_traffic_light(&self) {
        if let Some(traffic_light_position) = self.traffic_light_position {
            if self.is_fullscreen() {
                ...
                // see https://github.com/carrot-rs/carrot/issues/4712
                return;
            }
            ...
            unsafe {
                ...
                let min_button = window.standardWindowButton(NSWindowButton::MiniaturizeButton);
...
pub(super) fn get_scale_factor(native_window: *mut AnyObject) -> f32 {
    ...
    // this method would return 0 (https://github.com/carrot-rs/carrot/issues/6412)
...
pub(super) unsafe fn display_id_for_screen_ref(screen: &NSScreen) -> CGDirectDisplayID {
    unsafe {
        ...
        let screen_number =
            objc2_foundation::NSDictionary::objectForKey(&device_description, &screen_number_key);
