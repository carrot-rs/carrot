...
impl Platform for MacPlatform {
    ...
    fn screen_capture_sources(
        ...
        super::super::screen_capture::get_sources()
    }
    ...
    fn register_url_scheme(&self, scheme: &str) -> Task<anyhow::Result<()>> {
        ...
        let app_urls = workspace.URLsForApplicationsWithBundleIdentifier(&bundle_id);
    ...
    fn reveal_path(&self, path: &Path) {
        ...
        self.0
            ...
            .spawn(async move {
                ...
                let workspace = NSWorkspace::sharedWorkspace();
                workspace.selectFile_inFileViewerRootedAtPath(Some(&full_path), &root_full_path);
            })
            .detach();
    }
        ...
        self.background_executor().spawn(async move {
            unsafe {
                ...
                CFMutableDictionary::set_value(
                    ...
                    kSecClassInternetPassword as *const _,
                );
                CFMutableDictionary::set_value(
                    Some(&query_attrs),
                    kSecAttrServer as *const _,
                    &*url as *const CFString as *const _,
                );
                ...
                CFMutableDictionary::set_value(
                    ...
                    &*username as *const CFString as *const _,
                );
                CFMutableDictionary::set_value(
                    Some(&attrs),
                    kSecValueData as *const _,
                    &*password as *const CFData as *const _,
                );
    ...
    fn read_credentials(&self, url: &str) -> Task<Result<Option<(String, Vec<u8>)>>> {
        ...
        self.background_executor().spawn(async move {
            let url = CFString::from_str(url.as_str());
            let cf_true = unsafe { kCFBooleanTrue }.expect("kCFBooleanTrue should be available");
            ...
            unsafe {
                ...
                CFMutableDictionary::set_value(
                    ...
                    cf_true as *const CFBoolean as *const _,
                );
                CFMutableDictionary::set_value(
                    Some(&attrs),
