...
pub(super) fn did_finish_launching(delegate: &GPUIApplicationDelegate) {
    unsafe {
        ...
        let name = NSString::from_str("NSTextInputContextKeyboardSelectionDidChangeNotification");
        ...
        let thermal_name: &NSNotificationName = NSProcessInfoThermalStateDidChangeNotification;
...
pub(super) fn open_urls_callback(delegate: &GPUIApplicationDelegate, urls: &NSArray<NSURL>) {
