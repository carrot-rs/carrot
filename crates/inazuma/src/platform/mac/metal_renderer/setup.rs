...
pub(crate) struct MetalRenderer {
    ...
    pub(super) paths_rasterization_pipeline_state:
    ...
    pub(super) monochrome_sprites_pipeline_state:
        Retained<ProtocolObject<dyn MTLRenderPipelineState>>,
    pub(super) polychrome_sprites_pipeline_state:
        Retained<ProtocolObject<dyn MTLRenderPipelineState>>,
...
impl MetalRenderer {
    ...
    fn create_device() -> Retained<ProtocolObject<dyn MTLDevice>> {
            ...
            .min_by_key(|d| (d.isRemovable(), !d.isLowPower()))
        {
            ...
            // For some reason `MTLCopyAllDevices()` can return an empty list, see https://github.com/carrot-rs/carrot/issues/37689
    ...
    pub(super) fn update_path_intermediate_textures(&mut self, size: Size<DevicePixels>) {
        ...
        // https://github.com/carrot-rs/carrot/issues/36229
        ...
        unsafe {
            ...
            if self.path_sample_count > 1 {
                ...
                self.path_intermediate_msaa_texture = Some(
                    self.device
                        .newTextureWithDescriptor(&msaa_descriptor)
