...
impl LineWrapper {
    ...
    pub(crate) fn is_word_char(c: char) -> bool {
        ...
        matches!(c, '-' | '_' | '.' | '\'' | '’' | '‘' | '$' | '%' | '@' | '#' | '^' | '~' | ',' | '=' | ':') ||
        // `⋯` character is special used in Carrot, to keep this at the end of the line.
        matches!(c, '⋯')
    }
...
mod tests {
    ...
    fn build_wrapper() -> LineWrapper {
        ...
        let id = cx.text_system().resolve_font(&font(".CarrotMono"));
    ...
    fn test_is_word_char() {
        ...
        assert_not_word("carrot-rs/carrot");
        assert_not_word("carrot-rs\\carrot");
        ...
        // Vietnamese (https://github.com/carrot-rs/carrot/issues/23245)
