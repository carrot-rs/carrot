...
impl From<Rgba> for Oklch {
    fn from(color: Rgba) -> Self {
        ...
        // Linear RGB → LMS (cbrt)
        let l_ =
            (0.412221469470763 * r_lin + 0.5363325372617348 * g_lin + 0.0514459932675022 * b_lin)
                .cbrt();
        let m_ =
            (0.2119034958178252 * r_lin + 0.6806995506452344 * g_lin + 0.1073969535369406 * b_lin)
                .cbrt();
        let s_ =
            (0.0883024591900564 * r_lin + 0.2817188391361215 * g_lin + 0.6299787016738222 * b_lin)
                .cbrt();
