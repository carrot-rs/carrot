...
use carrot_language::{BinaryStatus, BufferId, ServerHealth};
use carrot_lsp::{LanguageServerId, LanguageServerName, LanguageServerSelector};
use carrot_project::{
...
use inazuma::{Corner, Entity, Subscription, Task, WeakEntity, actions};
use inazuma_collections::HashSet;
use inazuma_settings_framework::{Settings as _, SettingsStore};

use carrot_workspace::{StatusItemView, Workspace};
use inazuma_util::{ResultExt, paths::PathExt, rel_path::RelPath};
                                ...
                                cx.spawn(async move |cx| {
                                    ...
                                    buffer.update(cx, |buffer, cx| {
                                        ...
                                        buffer.set_capability(
                                            carrot_language::Capability::ReadOnly,
                                            cx,
                                        );
                                    });
        ...
        div().child(
            PopoverMenu::new("lsp-tool")
                ...
                .trigger_with_tooltip(
                    IconButton::new("carrot-lsp-tool-button", IconName::BoltOutlined)
