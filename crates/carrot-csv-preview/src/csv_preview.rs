...
use carrot_ui::{SharedString, TableColumnWidths, TableInteractionState, prelude::*};
...
pub struct CsvPreviewView {
    ...
    pub(crate) list_state: inazuma::ListState,
...
impl CsvPreviewView {
    ...
    fn new(editor: &Entity<Editor>, cx: &mut Context<Workspace>) -> Entity<Self> {
        ...
        cx.new(|cx| {
            ...
            let mut view = CsvPreviewView {
                ...
                list_state: inazuma::ListState::new(
                    contents.rows.len(),
                    ListAlignment::Top,
                    px(1.),
                ),
    ...
    pub(crate) fn apply_filter_sort(&mut self) {
        ...
        self.list_state = inazuma::ListState::new(visible_rows, ListAlignment::Top, px(1.));
    }
