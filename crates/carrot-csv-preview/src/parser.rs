...
use carrot_ui::{SharedString, table_row::TableRow};
use inazuma::{AppContext, Context, Entity, Subscription, Task};
use inazuma_text::BufferSnapshot;
...
impl TableLikeContent {
    ...
    pub fn from_str(text: String) -> Self {
        use inazuma_text::{Buffer, BufferId, ReplicaId};
