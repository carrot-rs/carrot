...
use carrot_ui::{CopyButton, Tooltip, WithScrollbar, prelude::*};
use carrot_workspace::{
    Item, ItemHandle, PaneRole, ToolbarItemEvent, ToolbarItemLocation, ToolbarItemView, Workspace,
};
use inazuma::{
        ...
        v_flex()
            ...
            .child(
                h_flex()
                    ...
                    .child(
                        div()
                            .child(carrot_ui::Chip::new(message.message_type.to_string()))
                    ...
                    .children(
                        message
                            .request_id
                            .as_ref()
                            .map(|req_id| div().child(carrot_ui::Chip::new(req_id.to_string()))),
                    ),
            )
