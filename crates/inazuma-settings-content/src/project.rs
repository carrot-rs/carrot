...
pub struct LspSettings {
    ...
    /// this setting can be used to enable or disable them in Carrot.
    /// Default: true
...
#[with_fallible_options]
#[derive(Default, Deserialize, Serialize, Clone, PartialEq, Eq, JsonSchema, MergeFrom)]
...
pub struct GitSettings {
    ...
    /// `"../worktrees"` and a project at `~/code/carrot`, worktrees are
    /// created under `~/code/worktrees/carrot/`.
    ///
    ...
    /// - `".git/carrot-worktrees"` — `<project>/.git/carrot-worktrees/`
