...
impl<'de> Deserialize<'de> for EditPredictionProvider {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        Ok(match Content::deserialize(deserializer)? {
            ...
            Content::Carrot => EditPredictionProvider::Carrot,
...
impl EditPredictionProvider {
    pub fn is_carrot(&self) -> bool {
        match self {
            EditPredictionProvider::Carrot => true,
    ...
    pub fn display_name(&self) -> Option<&'static str> {
        match self {
            EditPredictionProvider::Carrot => Some("Carrot AI"),
...
pub struct LanguageSettingsContent {
    ...
    /// when you type '(', Carrot will automatically add a closing ')' at the correct position.
    ///
    /// Default: true
    pub use_autoclose: Option<bool>,
    /// Whether to automatically surround text with characters for you. For example,
    /// when you select text and type '(', Carrot will automatically surround text with ().
    ///
    /// Default: true
...
#[serde(rename_all = "snake_case")]
pub enum Formatter {
    /// Format files using Carrot's Prettier integration (if applicable),
    /// or falling back to formatting via language server.
    #[default]
    Auto,
    /// Do not format code.
    None,
    /// Format code using Carrot's Prettier integration.
    Prettier,
