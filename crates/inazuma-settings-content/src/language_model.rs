...
pub struct AllLanguageModelSettingsContent {
    ...
    #[serde(rename = "carrot.dev")]
    pub carrot_dot_dev: Option<CarrotDotDevSettingsContent>,
}
...
pub struct AnthropicAvailableModel {
    ...
    pub name: String,
    /// The model's name in Carrot's UI, such as in the model selector dropdown menu in the assistant panel.
...
#[with_fallible_options]
#[derive(Default, Clone, Debug, Serialize, Deserialize, PartialEq, JsonSchema, MergeFrom)]
pub struct CarrotDotDevSettingsContent {
    pub available_models: Option<Vec<CarrotDotDevAvailableModel>>,
}

#[with_fallible_options]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, JsonSchema, MergeFrom)]
pub struct CarrotDotDevAvailableModel {
    /// The provider of the language model.
    pub provider: CarrotDotDevAvailableProvider,
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, JsonSchema, MergeFrom)]
#[serde(rename_all = "lowercase")]
pub enum CarrotDotDevAvailableProvider {
    Anthropic,
    OpenAi,
    Google,
}
