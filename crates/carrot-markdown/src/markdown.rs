...
use carrot_language::LanguageName;
use futures::FutureExt as _;
use inazuma::EdgesRefinement;
use inazuma::HitboxBehavior;
use inazuma::UnderlineStyle;

use carrot_theme_settings::ThemeSettings;
use carrot_ui::Checkbox;
use carrot_ui::CopyButton;
...
use carrot_language::{CharClassifier, Language, LanguageRegistry, Rope};
use carrot_theme::SyntaxTheme;
use carrot_ui::{ScrollAxes, Scrollbars, WithScrollbar, prelude::*};
use inazuma::{
    AnyElement, App, BorderStyle, Bounds, ClipboardItem, CursorStyle, DispatchPhase, Edges, Entity,
    FocusHandle, Focusable, FontStyle, FontWeight, GlobalElementId, Hitbox, Image, ImageFormat,
    ImageSource, KeyContext, Length, MouseButton, MouseDownEvent, MouseEvent, MouseMoveEvent,
    MouseUpEvent, Oklch, Point, ScrollHandle, Stateful, StrikethroughStyle, StyleRefinement,
    StyledText, Task, TextLayout, TextRun, TextStyle, TextStyleRefinement, actions, img, point,
    quad,
};
...
pub struct MarkdownStyle {
    ...
    pub rule_color: Oklch,
    pub block_quote_border_color: Oklch,
    pub syntax: Arc<SyntaxTheme>,
    pub selection_background_color: Oklch,
...
impl Element for MarkdownElement {
    ...
    fn request_layout(
                        ...
                        MarkdownTag::Item => {
                            let bullet =
                                    ...
                                    parsed_markdown.events.get(index.saturating_add(1))
                                {
                                    ...
                                    let checkbox =
                                        Checkbox::new(ElementId::Name(source.to_string().into()))
        ...
        let layout_id = window.request_layout(inazuma::Style::default(), [child_layout_id], cx);
...
impl MarkdownElementBuilder {
    ...
    fn pop_root_block(
        &mut self,
        is_active: bool,
        active_gutter_color: Oklch,
        hovered_gutter_color: Oklch,
    ) {
        self.pop_div();
    ...
    fn replace_pending_checkbox(&mut self, source_range: &Range<usize>) {
        ...
        if trimmed == "[x]" || trimmed == "[X]" || trimmed == "[ ]" {
            ...
            let checkbox = Checkbox::new(ElementId::Name(
    ...
    fn render_source_anchor(&mut self, source_range: Range<usize>) -> AnyElement {
        ...
        text_style.color = Oklch::transparent_black();
        let text = "\u{200B}";
...
mod tests {
    ...
    use inazuma::{TestAppContext, size};
    use std::sync::Arc;
    ...
    fn ensure_theme_initialized(cx: &mut TestAppContext) {
        cx.update(|cx| {
            ...
            if !cx.has_global::<carrot_theme::GlobalTheme>() {
