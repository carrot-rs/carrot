...
use carrot_ui::{App, Window, div};
use inazuma::{Entity, KeyBinding, StyleRefinement, WindowOptions, rgb};
...
pub fn main() {
    ...
    inazuma::application().with_assets(Assets).run(|cx| {
        ...
        carrot_languages::init(language_registry.clone(), fs, node_runtime, cx);
    ...
    fn render(&mut self, _window: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        let markdown_style = MarkdownStyle {
            ...
            inline_code: inazuma::TextStyleRefinement {
                font_family: Some(".CarrotMono".into()),
