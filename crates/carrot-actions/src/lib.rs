...
// If the carrot binary doesn't use anything in this crate, it will be optimized away
...
/// Opens a carrot:// URL within the application.
#[derive(Clone, PartialEq, Deserialize, JsonSchema, Action)]
#[action(namespace = carrot)]
#[serde(deny_unknown_fields)]
pub struct OpenCarrotUrl {
    pub url: String,
}
...
#[action(namespace = carrot, no_json, no_register)]
...
actions!(
    ...
    [
        ...
        Quit,
        /// Shows information about Carrot.
        About,
...
pub mod session {
    ...
    actions!(
        ...
        [
            ...
            NewSession,
            /// Close the active pane, or the entire session if only one pane remains.
            CloseActiveSession,
            /// Activate the previous session tab.
            ActivatePreviousSession,
            /// Activate the next session tab.
            ActivateNextSession,
            /// Activate session tab 1.
            ActivateSession1,
            /// Activate session tab 2.
            ActivateSession2,
            /// Activate session tab 3.
            ActivateSession3,
            /// Activate session tab 4.
            ActivateSession4,
            /// Activate session tab 5.
            ActivateSession5,
            /// Activate session tab 6.
            ActivateSession6,
            /// Activate session tab 7.
            ActivateSession7,
            /// Activate session tab 8.
            ActivateSession8,
            /// Activate session tab 9.
            ActivateSession9,
            /// Start inline renaming the active session tab.
            RenameActiveSession,
        ]
    );
}
...
pub mod feedback {
    ...
    actions!(
        feedback,
        [
            /// Opens email client to send feedback to Carrot support.
            EmailCarrot,
...
pub mod buffer_search {
    ...
    #[serde(deny_unknown_fields)]
    pub struct Deploy {
        #[serde(default = "inazuma_util::serde::default_true")]
        pub focus: bool,
        #[serde(default)]
...
pub mod agent {
    use inazuma::{Action, SharedString, actions};
    use schemars::JsonSchema;
    use serde::Deserialize;
...
pub struct Rerun {
    ...
    /// If it is not, environment variables such as CARROT_COLUMN, CARROT_FILE are gonna be the same as in the last execution of a task
    /// If it is, these variables will be updated to reflect current state of editor at the time carrot_task::Rerun is executed.
    /// default: false
    #[serde(default)]
...
pub mod outline {
    ...
    use inazuma::{AnyView, App, Window, actions};
...
actions!(
    carrot_predict_onboarding,
    [
        /// Opens the Carrot Predict onboarding modal.
        OpenCarrotPredictOnboarding
    ]
);
actions!(
    git_onboarding,
