use carrot_lsp::{Uri, VersionedTextDocumentIdentifier};
...
impl carrot_lsp::request::Request for CheckStatus {
...
pub struct PromptUserDeviceFlow {
    ...
    pub command: carrot_lsp::Command,
}

impl carrot_lsp::request::Request for SignIn {
...
impl carrot_lsp::request::Request for SignOut {
...
impl carrot_lsp::notification::Notification for DidChangeStatus {
...
impl carrot_lsp::request::Request for SetEditorInfo {
...
impl carrot_lsp::request::Request for NotifyAccepted {
...
impl carrot_lsp::request::Request for NotifyRejected {
...
pub struct NextEditSuggestionsParams {
    ...
    pub(crate) position: carrot_lsp::Position,
}
...
pub struct NextEditSuggestion {
    ...
    pub range: carrot_lsp::Range,
    pub command: Option<carrot_lsp::Command>,
}
...
impl carrot_lsp::request::Request for NextEditSuggestions {
...
impl carrot_lsp::notification::Notification for DidFocus {
...
impl carrot_lsp::notification::Notification for DidShowInlineEdit {
...
impl carrot_lsp::request::Request for InlineCompletions {
...
impl carrot_lsp::notification::Notification for DidShowCompletion {
