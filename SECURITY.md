...
This policy covers:
- The Carrot terminal emulator (`carrot-app`)
- The Inazuma framework (`inazuma`)
- Shell integration hooks (`carrot-shell`)
- PTY handling and terminal emulation (`carrot-terminal`, `carrot-term`)
