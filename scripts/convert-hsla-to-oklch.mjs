 ...
 *
 * Converts Rust source files from an HSLA color system to Carrot's OKLCH system.
 * Uses culori for mathematically exact color conversion.
 *
 * Usage:
...
function hslToOklch(h_in, s, l, a) {
  // Source convention: h is 0–1 (fraction of 360°). culori expects degrees.
  const h_deg = h_in <= 1.0 ? h_in * 360 : h_in;
